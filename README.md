...
| <small>RX65N/BG96<br>TSIP</small> | <small>[✓](https://gitlab.saffti.jp/oss/import/github/renesas/iot-reference-rx/-/pipelines/6204)</small> | <small>[✓](https://gitlab.saffti.jp/oss/import/github/renesas/iot-reference-rx/-/pipelines/6204)</small> |
...
|----------|--------|------------|-------|---------|
| Nightly focused test matrix (schedule #5) | Active | 02:20 daily | `PIPELINE_PROFILE=nightly_matrix` | Runs the focused rows represented in the latest matrix, including software/TSIP TLS 1.2 and TLS 1.3 MQTT / OTA / Fleet Provisioning rows. |
