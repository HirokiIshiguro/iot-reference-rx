...
TLS 1.3 resumption と 0-RTT は列を先行追加していますが、AWS IoT Core は
[SessionTicket TLS extension をサポートしていません](https://docs.aws.amazon.com/iot/latest/developerguide/transport-security.html)。
