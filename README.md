...
で `test_rx72n_ether_tls13_0rtt` の PASS を確認しています。RX65N/BG96 software / TSIP は
初回 focused/API 確認済みですが、上記5回の `nightly_matrix` では該当 LANBENCH bridge が
生成されていないため、`✓` 昇格は保留します。
