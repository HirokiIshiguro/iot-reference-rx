...
#define SCI_CFG_CH6_EN_TXI_NESTED_INT    (1)
...
#define SCI_CFG_CH6_EN_RXI_NESTED_INT    (1)
...
#define SCI_CFG_CH6_EN_TEI_NESTED_INT    (1)
...
#define SCI_CFG_CH6_EN_ERI_NESTED_INT    (1)
...
#define SCI_CFG_CH6_RX_BUFSIZ   (32768)
