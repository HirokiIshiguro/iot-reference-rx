 ...
 */
#define WIFI_CFG_AT_CMD_TX_BUFFER_SIZE          (1024)

/* AT command receive buffer size
   Value must be in the range 1-8192
 */
#define WIFI_CFG_AT_CMD_RX_BUFFER_SIZE          (2048)
 ...
 */
#define WIFI_CFG_TCP_CREATABLE_SOCKETS          (4)

/* Socket Receive buffer size
   Value must be in the range 1-8192
 */
#define WIFI_CFG_TCP_SOCKET_RECEIVE_BUFFER_SIZE (8192)
