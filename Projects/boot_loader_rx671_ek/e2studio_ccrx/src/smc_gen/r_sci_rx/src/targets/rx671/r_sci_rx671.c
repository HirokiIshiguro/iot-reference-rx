...
***********************************************************************************************************************/
/**********************************************************************************************************************
* File Name    : r_sci_rx671.c
* Description  : Functions for using SCI on the RX671 device.
***********************************************************************************************************************
...
{
#if SCI_CFG_CH2_EN_TXI_NESTED_INT == 1
    /* set bit PSW.I = 1 to allow nested interrupt */
    R_BSP_SETPSW_I();
#endif
...
{
#if SCI_CFG_CH3_EN_TXI_NESTED_INT == 1
    /* set bit PSW.I = 1 to allow nested interrupt */
    R_BSP_SETPSW_I();
#endif
...
{
#if SCI_CFG_CH4_EN_TXI_NESTED_INT == 1
    /* set bit PSW.I = 1 to allow nested interrupt */
    R_BSP_SETPSW_I();
#endif
...
{
#if SCI_CFG_CH7_EN_TXI_NESTED_INT == 1
    /* set bit PSW.I = 1 to allow nested interrupt */
    R_BSP_SETPSW_I();
#endif
...
{
#if SCI_CFG_CH10_EN_TXI_NESTED_INT == 1
    /* set bit PSW.I = 1 to allow nested interrupt */
    R_BSP_SETPSW_I();
#endif
...
{
#if SCI_CFG_CH2_EN_TEI_NESTED_INT == 1
    /* set bit PSW.I = 1 to allow nested interrupt */
    R_BSP_SETPSW_I();
#endif
...
{
#if SCI_CFG_CH3_EN_TEI_NESTED_INT == 1
    /* set bit PSW.I = 1 to allow nested interrupt */
    R_BSP_SETPSW_I();
#endif
...
{
#if SCI_CFG_CH4_EN_TEI_NESTED_INT == 1
    /* set bit PSW.I = 1 to allow nested interrupt */
    R_BSP_SETPSW_I();
#endif
...
{
#if SCI_CFG_CH7_EN_TEI_NESTED_INT == 1
    /* set bit PSW.I = 1 to allow nested interrupt */
    R_BSP_SETPSW_I();
#endif
...
{
#if SCI_CFG_CH10_EN_TEI_NESTED_INT == 1
    /* set bit PSW.I = 1 to allow nested interrupt */
    R_BSP_SETPSW_I();
#endif
...
{
#if SCI_CFG_CH2_EN_RXI_NESTED_INT == 1
    /* set bit PSW.I = 1 to allow nested interrupt */
    R_BSP_SETPSW_I();
#endif
...
{
#if SCI_CFG_CH3_EN_RXI_NESTED_INT == 1
    /* set bit PSW.I = 1 to allow nested interrupt */
    R_BSP_SETPSW_I();
#endif
...
{
#if SCI_CFG_CH4_EN_RXI_NESTED_INT == 1
    /* set bit PSW.I = 1 to allow nested interrupt */
    R_BSP_SETPSW_I();
#endif
...
{
#if SCI_CFG_CH7_EN_RXI_NESTED_INT == 1
    /* set bit PSW.I = 1 to allow nested interrupt */
    R_BSP_SETPSW_I();
#endif
...
{
#if SCI_CFG_CH10_EN_RXI_NESTED_INT == 1
    /* set bit PSW.I = 1 to allow nested interrupt */
    R_BSP_SETPSW_I();
#endif
...
{
#if SCI_CFG_CH2_EN_ERI_NESTED_INT == 1
    /* set bit PSW.I = 1 to allow nested interrupt */
    R_BSP_SETPSW_I();
#endif
...
{
#if SCI_CFG_CH3_EN_ERI_NESTED_INT == 1
    /* set bit PSW.I = 1 to allow nested interrupt */
    R_BSP_SETPSW_I();
#endif
...
{
#if SCI_CFG_CH4_EN_ERI_NESTED_INT == 1
    /* set bit PSW.I = 1 to allow nested interrupt */
    R_BSP_SETPSW_I();
#endif
...
{
#if SCI_CFG_CH7_EN_ERI_NESTED_INT == 1
    /* set bit PSW.I = 1 to allow nested interrupt */
    R_BSP_SETPSW_I();
#endif
...
{
#if SCI_CFG_CH10_EN_ERI_NESTED_INT == 1
    /* set bit PSW.I = 1 to allow nested interrupt */
    R_BSP_SETPSW_I();
#endif
