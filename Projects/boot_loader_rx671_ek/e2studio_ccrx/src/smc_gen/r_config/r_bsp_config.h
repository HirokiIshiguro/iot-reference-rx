...
/* Configure clock source of clock output(CLKOUT) pin (CKOSEL).
   ...
   4 = PLL circuit
 */
#define BSP_CFG_CLKOUT_SOURCE           (4) /* Generated value. Do not edit this manually */
...
*/
#define BSP_CFG_CONFIGURATOR_VERSION                (2290) /* Generated value. Do not edit this manually */
...
*/
#define BSP_CFG_BOOTLOADER_PROJECT    (1)
