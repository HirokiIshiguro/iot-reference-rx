...
#define R_TSIP_SINST_WORD_SIZE      (280u)
#define R_TSIP_SINST2_WORD_SIZE     (16u)
#define R_TSIP_SHEAP_WORD_SIZE      (1632u)
#define R_TSIP_SINST_DATA_WORD_SIZE (140u)
...
/* TLS1.2 */
#define R_TSIP_TLS12_SERVER_RANDOM_WORD_SIZE                (32u)
#define R_TSIP_TLS12_SERVER_RANDOM_MAC_WORD_SIZE            (4u)
...
typedef enum
{
    TSIP_TLS_SIGNATURE_SCHEME_RSA_PKCS1_SHA256 = 0u,
    TSIP_TLS_SIGNATURE_SCHEME_ECDSA_SECP256R1_SHA256,
    TSIP_TLS_SIGNATURE_SCHEME_RSA_PSS_RSAE_SHA256,
} e_tsip_tls_signature_scheme_type_t;

/* TLS mode */
typedef enum
{
    TSIP_TLS_MODE_CLIENT = 0u,
    TSIP_TLS_MODE_SERVER,
} e_tsip_tls_mode_t;

/* TLS version */
typedef enum
{
    TSIP_TLS_VERSION_12 = 0u,
    TSIP_TLS_VERSION_13,
} e_tsip_tls_version_t;
...
typedef enum
{
    ...
    TSIP_KEY_INDEX_TYPE_TLS_CLIENT_AES128_FOR_CLIENT,
    TSIP_KEY_INDEX_TYPE_TLS_SERVER_AES128_FOR_CLIENT,
    TSIP_KEY_INDEX_TYPE_TLS_CLIENT_AES256_FOR_CLIENT,
    TSIP_KEY_INDEX_TYPE_TLS_SERVER_AES256_FOR_CLIENT,
    TSIP_KEY_INDEX_TYPE_TLS_CLIENT_HMAC_SHA1_FOR_CLIENT,
    TSIP_KEY_INDEX_TYPE_TLS_SERVER_HMAC_SHA1_FOR_CLIENT,
    TSIP_KEY_INDEX_TYPE_TLS_CLIENT_HMAC_SHA256_FOR_CLIENT,
    TSIP_KEY_INDEX_TYPE_TLS_SERVER_HMAC_SHA256_FOR_CLIENT,
    TSIP_KEY_INDEX_TYPE_TLS_CLIENT_AES128_FOR_SERVER,
    TSIP_KEY_INDEX_TYPE_TLS_SERVER_AES128_FOR_SERVER,
    TSIP_KEY_INDEX_TYPE_TLS_CLIENT_AES256_FOR_SERVER,
    TSIP_KEY_INDEX_TYPE_TLS_SERVER_AES256_FOR_SERVER,
    TSIP_KEY_INDEX_TYPE_TLS_CLIENT_HMAC_SHA1_FOR_SERVER,
    TSIP_KEY_INDEX_TYPE_TLS_SERVER_HMAC_SHA1_FOR_SERVER,
    TSIP_KEY_INDEX_TYPE_TLS_CLIENT_HMAC_SHA256_FOR_SERVER,
    TSIP_KEY_INDEX_TYPE_TLS_SERVER_HMAC_SHA256_FOR_SERVER,
#else
...
{
    uint32_t type;
    uint32_t value[R_TSIP_AES256_KEY_INDEX_WORD_SIZE];  /* AES128/AES256 are supported */
...
{
    uint32_t type;
    uint32_t value[R_TSIP_ARC4_KEY_INDEX_WORD_SIZE];    /* ARC4 is supported */
...
{
    uint32_t type;
    uint32_t value[R_TSIP_HMAC_KEY_INDEX_WORD_SIZE];    /* HMAC-SHA1/HMAC-SHA256 are supported */
    uint32_t tls13_mode;
...
/* TLS server random data structure */
typedef struct tsip_tls_sv_random
{
    uint8_t     random[R_TSIP_TLS12_SERVER_RANDOM_WORD_SIZE];
    uint32_t    mac[R_TSIP_TLS12_SERVER_RANDOM_MAC_WORD_SIZE];
} tsip_tls_sv_random_t;
