...
/***********************************************************************************************************************
* Function Name: R_TSIP_Rsa2048ModularExponentEncryptSub
*******************************************************************************************************************/ /**
...
* @note          None
*/
e_tsip_err_t R_TSIP_Rsa2048ModularExponentEncryptSub(uint32_t *InData_KeyIndex, uint32_t *InData_Text, uint32_t *OutData_Text)
{
    ...
    TSIP.REG_104H.WORD = 0x00008361u;
    ...
    TSIP.REG_100H.WORD = InData_KeyIndex[68];
    TSIP.REG_100H.WORD = InData_KeyIndex[69];
    TSIP.REG_100H.WORD = InData_KeyIndex[70];
    TSIP.REG_100H.WORD = InData_KeyIndex[71];
    ...
    TSIP.REG_100H.WORD = InData_KeyIndex[136];
    TSIP.REG_100H.WORD = InData_KeyIndex[137];
    TSIP.REG_100H.WORD = InData_KeyIndex[138];
    TSIP.REG_100H.WORD = InData_KeyIndex[139];
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX72M_RX72N_RX66N_func100(change_endian_long(0xc728688eu), change_endian_long(0x6f2d25ecu), change_endian_long(0xd7cb3899u), change_endian_long(0xa739bc28u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX72M_RX72N_RX66N_func102(change_endian_long(0xd9a882d9u), change_endian_long(0x97f0c452u), change_endian_long(0x047b54edu), change_endian_long(0x1fec02b8u));
    ...
    {
        RX72M_RX72N_RX66N_func100(change_endian_long(0xbc340dc8u), change_endian_long(0x6b0d0f87u), change_endian_long(0x1862cb3eu), change_endian_long(0x49d7ec0fu));
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0xbe2e1eadu), change_endian_long(0xad62bf2cu), change_endian_long(0x974df663u), change_endian_long(0x1bbf3fccu));
        TSIP.REG_2CH.WORD = 0x00000020u;
        TSIP.REG_04H.WORD = 0x00000303u;
        /* WAIT_LOOP */
        ...
        RX72M_RX72N_RX66N_func102(change_endian_long(0x617a1803u), change_endian_long(0x8502e270u), change_endian_long(0x1c5879a6u), change_endian_long(0xde2d89f2u));
        TSIP.REG_1BCH.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_p56.prc
 *********************************************************************************************************************/
