...
*******************************************************************************************************************/ /**
* @details       RX72M Update P-192/224/256 ECC Private Key
* @param[in]     InData_Cmd
* @param[in]     InData_IV
...
e_tsip_err_t R_TSIP_UpdateEccPrivateKeyIndexSub(uint32_t *InData_Cmd, uint32_t *InData_IV, uint32_t *InData_InstData, uint32_t *OutData_KeyIndex)
{
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0xd52b9899u), change_endian_long(0xcc4f9f91u), change_endian_long(0x1d00c6a3u), change_endian_long(0x26646d56u));
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0xddedf381u), change_endian_long(0xd5cb4b0au), change_endian_long(0xd8185eebu), change_endian_long(0xcb260206u));
    TSIP.REG_104H.WORD = 0x00000361u;
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0xbff89e1cu), change_endian_long(0xeda99353u), change_endian_long(0x0c9a0d5au), change_endian_long(0x6e556023u));
    TSIP.REG_104H.WORD = 0x00000361u;
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0xc8838ca8u), change_endian_long(0x624446e5u), change_endian_long(0xce18172fu), change_endian_long(0xdc92f15du));
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0x8c2ed961u), change_endian_long(0x9de2f086u), change_endian_long(0x97b87bbfu), change_endian_long(0x44e9e2d2u));
    TSIP.REG_104H.WORD = 0x00000052u;
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX72M_RX72N_RX66N_func100(change_endian_long(0xee95c97fu), change_endian_long(0xa9301ad3u), change_endian_long(0x632993a4u), change_endian_long(0x0b1954bfu));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX72M_RX72N_RX66N_func102(change_endian_long(0x16ec19c0u), change_endian_long(0xf6775ed7u), change_endian_long(0x236fef37u), change_endian_long(0x94bad341u));
    ...
    {
        RX72M_RX72N_RX66N_func100(change_endian_long(0x36289fd3u), change_endian_long(0xff712a1cu), change_endian_long(0xa679f938u), change_endian_long(0xec42622eu));
        TSIP.REG_E0H.WORD = 0x81040000u;
        ...
        RX72M_RX72N_RX66N_func102(change_endian_long(0x223c18c2u), change_endian_long(0x664b7718u), change_endian_long(0x71cc8843u), change_endian_long(0xa6973780u));
        TSIP.REG_1B4H.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_p1e_r1.prc
 *********************************************************************************************************************/
