...
/***********************************************************************************************************************
* Function Name: R_TSIP_Tls13SVGeneratePskBinderKeySub
*******************************************************************************************************************/ /**
* @details       RX72M TLS1.3 Resumption/0-RTT Binder Key Generation for Server
...
* @note          None
*/
e_tsip_err_t R_TSIP_Tls13SVGeneratePskBinderKeySub(uint32_t *InData_Handle, uint32_t *InData_PreSharedKeyIndex, uint32_t *OutData_BinderKeyIndex)
{
    ...
    {
        RX72M_RX72N_RX66N_func102(change_endian_long(0x852ccc35u), change_endian_long(0x31559899u), change_endian_long(0x9132c15du), change_endian_long(0x0f189f28u));
    ...
    else
    {
        ...
        RX72M_RX72N_RX66N_func070();
        RX72M_RX72N_RX66N_func100(change_endian_long(0xa0d12f4eu), change_endian_long(0xc1473ba4u), change_endian_long(0xf76a19d4u), change_endian_long(0xc06e4db0u));
        TSIP.REG_C4H.WORD = 0x400c0b0cu;
        /* WAIT_LOOP */
        while (1u != TSIP.REG_104H.BIT.B31)
        {
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0x6bc3a7dfu), change_endian_long(0xa701d5a3u), change_endian_long(0x710cf8dbu), change_endian_long(0x5511109au));
        TSIP.REG_E0H.WORD = 0x81040280u;
        ...
        RX72M_RX72N_RX66N_func102(change_endian_long(0xe896024bu), change_endian_long(0xcea58feau), change_endian_long(0x3cdd806au), change_endian_long(0xbe0a9ab9u));
        TSIP.REG_1BCH.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_pbe.prc
 *********************************************************************************************************************/
