...
/***********************************************************************************************************************
* Function Name: R_TSIP_GenerateTdesKeyIndexSub
*******************************************************************************************************************/ /**
* @details       RX72M Install TDES Key
...
* @note          None
*/
e_tsip_err_t R_TSIP_GenerateTdesKeyIndexSub(uint32_t *InData_SharedKeyIndex, uint32_t *InData_SessionKey, uint32_t *InData_IV, uint32_t *InData_InstData, uint32_t *OutData_KeyIndex)
{
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0x8bbcb503u), change_endian_long(0xb80c3109u), change_endian_long(0xecc8922cu), change_endian_long(0x23eb18d2u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX72M_RX72N_RX66N_func102(change_endian_long(0xda95d891u), change_endian_long(0x407b2d7fu), change_endian_long(0x9fa737a0u), change_endian_long(0xefe1fb45u));
    ...
    {
        RX72M_RX72N_RX66N_func100(change_endian_long(0x9ec68881u), change_endian_long(0x458187f1u), change_endian_long(0x68bc9ef6u), change_endian_long(0x1615541eu));
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0x4f66f7bfu), change_endian_long(0x08cd23ddu), change_endian_long(0x70656789u), change_endian_long(0xf50af3d7u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0x0dad17a6u), change_endian_long(0x34c5426au), change_endian_long(0x40637075u), change_endian_long(0xb7045ab1u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0x6b5a81b7u), change_endian_long(0x7613a938u), change_endian_long(0x1707378eu), change_endian_long(0x64a4bf26u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0xa0d1367du), change_endian_long(0xdc25c305u), change_endian_long(0xf8b83f08u), change_endian_long(0xe4838427u));
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0xabc721adu), change_endian_long(0xcf9951cbu), change_endian_long(0x5f674c4fu), change_endian_long(0x9fc21695u));
        TSIP.REG_104H.WORD = 0x00000052u;
        ...
        TSIP.REG_1CH.WORD = 0x00001800u;
        RX72M_RX72N_RX66N_func100(change_endian_long(0x6e35043au), change_endian_long(0x29191408u), change_endian_long(0x7ccc3b98u), change_endian_long(0x9b85c34au));
        TSIP.REG_1CH.WORD = 0x00400000u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            RX72M_RX72N_RX66N_func102(change_endian_long(0x402cf9e4u), change_endian_long(0xcf3b0493u), change_endian_long(0xc5bc4902u), change_endian_long(0x5d0bf22du));
            TSIP.REG_1BCH.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
        ...
        {
            RX72M_RX72N_RX66N_func100(change_endian_long(0xee1236f9u), change_endian_long(0xf0669840u), change_endian_long(0xd57f4d68u), change_endian_long(0xbae81e78u));
            TSIP.REG_E0H.WORD = 0x81040000u;
            ...
            RX72M_RX72N_RX66N_func102(change_endian_long(0x532d9165u), change_endian_long(0x66d6d3a9u), change_endian_long(0xb88e83f1u), change_endian_long(0xece4343du));
            TSIP.REG_1BCH.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_p14.prc
 *********************************************************************************************************************/
