...
#include "iodefine/r_tsip_rx72m_rx72n_rx66n_iodefine.h"
...
/*
 * SAFFTI extension: optional hook for REG_00H.B25 procedure-busy waits.
 * If the setting is absent or disabled, the generated driver keeps the
 * original empty polling behavior.
 */
...
e_tsip_err_t R_TSIP_Sha1HmacInitSub(uint32_t *InData_KeyType, uint32_t *InData_Cmd, uint32_t *InData_KeyIndex);
...
e_tsip_err_t R_TSIP_TlsSVGenerateMasterSecretSub(uint32_t *InData_Sel_CipherSuite, uint32_t *InData_PreMasterSecret,
        uint32_t *InData_ClientRandom, uint32_t *InData_ServerRandom, uint32_t *InData_MAC,
        uint32_t *OutData_MasterSecret);
e_tsip_err_t R_TSIP_TlsSVGenerateExtendedMasterSecretSub(uint32_t *InData_Sel_CipherSuite,
        uint32_t *InData_PreMasterSecret, uint32_t *InData_MsgHash, uint32_t *OutData_ExMasterSecret);
e_tsip_err_t R_TSIP_TlsSVGenerateSessionKeySub(uint32_t *InData_Sel_CipherSuite, uint32_t *InData_MasterSecret,
        uint32_t *InData_ClientRandom, uint32_t *InData_ServerRandom, uint32_t *InData_MAC,
        uint32_t *InData_NonceExplicit, uint32_t *OutData_ClientMACKeyOperationCode,
        uint32_t *OutData_ServerMACKeyOperationCode, uint32_t *OutData_ClientEncKeyOperationCode,
        uint32_t *OutData_ServerEncKeyOperationCode, uint32_t* OutData_ClientIV, uint32_t* OutData_ServerIV);
...
e_tsip_err_t R_TSIP_Tls13GenerateResumptionMasterSecretSub(uint32_t *InData_Cmd, uint32_t *InData_Handle,
        uint32_t *InData_Master_SecretKeyIndex, uint32_t *InData_MsgHash, uint32_t *OutData_RMaster_SecretKeyIndex);
e_tsip_err_t R_TSIP_Tls13GeneratePreSharedKeySub(uint32_t *InData_Cmd, uint32_t *InData_Handle,
        uint32_t *InData_RMaster_SecretKeyIndex, uint32_t *InData_TicketNonceLen, uint32_t *InData_TicketNonce,
        uint32_t *OutData_PreSharedKeyIndex);
e_tsip_err_t R_TSIP_Tls13GeneratePskBinderKeySub(uint32_t *InData_Handle, uint32_t *InData_PreSharedKeyIndex,
        uint32_t *OutData_BinderKeyIndex);
e_tsip_err_t R_TSIP_Tls13Generate0RttApplicationWriteKeySub(uint32_t *InData_Handle, uint32_t *InData_PreSharedKeyIndex,
        uint32_t *InData_MsgHash, uint32_t *OutData_ClientWriteKeyIndex);
e_tsip_err_t R_TSIP_Tls13GenerateResumptionHandshakeSecretSub(uint32_t *InData_Handle,
...
e_tsip_err_t R_TSIP_Tls13SVGenerateServerHandshakeTrafficKeySub(uint32_t *InData_Cmd,
        uint32_t *InData_Handshake_SecretKeyIndex, uint32_t *InData_MsgHash, uint32_t *OutData_ServerWriteKeyIndex,
        uint32_t *OutData_ServerFinishedKeyIndex);
e_tsip_err_t R_TSIP_Tls13SVClientHandshakeVerificationSub(uint32_t *InData_Cmd, uint32_t *InData_ClientFinishedKeyIndex,
        uint32_t *InData_MsgHash, uint32_t *InData_ClientFinished);
e_tsip_err_t R_TSIP_Tls13SVGenerateClientHandshakeTrafficKeySub(uint32_t *InData_Cmd,
        uint32_t *InData_Handshake_SecretKeyIndex, uint32_t *InData_MsgHash, uint32_t *OutData_ClientWriteKeyIndex,
        uint32_t *OutData_ClientFinishedKeyIndex);
e_tsip_err_t R_TSIP_Tls13SVGenerateMasterSecretSub(uint32_t *InData_Cmd, uint32_t *InData_Handshake_SecretKeyIndex,
        uint32_t *OutData_Handle, uint32_t *OutData_Master_SecretKeyIndex);
e_tsip_err_t R_TSIP_Tls13SVGenerateApplicationTrafficKeySub(uint32_t *InData_Cmd, uint32_t *InData_Handle,
        uint32_t *InData_Master_SecretKeyIndex, uint32_t *InData_MsgHash,
        uint32_t *OutData_ServerApplicationSecretKeyIndex, uint32_t *OutData_ClientApplicationSecretKeyIndex,
        uint32_t *OutData_ServerWriteKeyIndex, uint32_t *OutData_ClientWriteKeyIndex);
e_tsip_err_t R_TSIP_Tls13SVUpdateApplicationTrafficKeySub(uint32_t *InData_Cmd, uint32_t *InData_UpdateKeyType,
        uint32_t *InData_Handle, uint32_t *InData_ApplicationSecretKeyIndex,
        uint32_t *OutData_ApplicationSecretKeyIndex, uint32_t *OutData_ApplicationWriteKeyIndex);
e_tsip_err_t R_TSIP_Tls13SVGenerateResumptionMasterSecretSub(uint32_t *InData_Cmd, uint32_t *InData_Handle,
        uint32_t *InData_Master_SecretKeyIndex, uint32_t *InData_MsgHash, uint32_t *OutData_RMaster_SecretKeyIndex);
e_tsip_err_t R_TSIP_Tls13SVGeneratePreSharedKeySub(uint32_t *InData_Cmd, uint32_t *InData_Handle,
        uint32_t *InData_RMaster_SecretKeyIndex, uint32_t *InData_TicketNonceLen, uint32_t *InData_TicketNonce,
        uint32_t *OutData_PreSharedKeyIndex);
e_tsip_err_t R_TSIP_Tls13SVGeneratePskBinderKeySub(uint32_t *InData_Handle, uint32_t *InData_PreSharedKeyIndex,
        uint32_t *OutData_BinderKeyIndex);
e_tsip_err_t R_TSIP_Tls13SVGenerate0RttApplicationWriteKeySub(uint32_t *InData_Handle,
        uint32_t *InData_PreSharedKeyIndex, uint32_t *InData_MsgHash, uint32_t *OutData_ClientWriteKeyIndex);
e_tsip_err_t R_TSIP_Tls13SVGenerateResumptionHandshakeSecretSub(uint32_t *InData_Handle,
        uint32_t *InData_SharedSecretKeyIndexType, uint32_t *InData_PreSharedKeyIndex,
        uint32_t *InData_SharedSecretKeyIndex, uint32_t *OutData_Handshake_SecretKeyIndex);
...
void RX72M_RX72N_RX66N_func053(uint32_t ARG1);
void RX72M_RX72N_RX66N_func054(uint32_t ARG1, uint32_t ARG2);
void RX72M_RX72N_RX66N_func060(void);
void RX72M_RX72N_RX66N_func061(void);
void RX72M_RX72N_RX66N_func070(void);
void RX72M_RX72N_RX66N_func071(void);
void RX72M_RX72N_RX66N_func072(void);
void RX72M_RX72N_RX66N_func073(uint32_t *ARG1);
void RX72M_RX72N_RX66N_func074(void);
void RX72M_RX72N_RX66N_func075(void);
void RX72M_RX72N_RX66N_func080(void);
void RX72M_RX72N_RX66N_func100(uint32_t ARG1, uint32_t ARG2, uint32_t ARG3, uint32_t ARG4);
void RX72M_RX72N_RX66N_func101(uint32_t ARG1, uint32_t ARG2, uint32_t ARG3, uint32_t ARG4);
void RX72M_RX72N_RX66N_func102(uint32_t ARG1, uint32_t ARG2, uint32_t ARG3, uint32_t ARG4);
void RX72M_RX72N_RX66N_func103(void);
void RX72M_RX72N_RX66N_func200(void);
void RX72M_RX72N_RX66N_func202(void);
void RX72M_RX72N_RX66N_func205(void);
void RX72M_RX72N_RX66N_func206(void);
void RX72M_RX72N_RX66N_func207(void);
...
void RX72M_RX72N_RX66N_func310(void);
void RX72M_RX72N_RX66N_func311(void);
void RX72M_RX72N_RX66N_func312(uint32_t ARG1);
void RX72M_RX72N_RX66N_func313(uint32_t ARG1);
void RX72M_RX72N_RX66N_func314(uint32_t ARG1);
void RX72M_RX72N_RX66N_func315(uint32_t ARG1);
void RX72M_RX72N_RX66N_func316(void);
void RX72M_RX72N_RX66N_func317(void);
void RX72M_RX72N_RX66N_func318(void);
void RX72M_RX72N_RX66N_func319(uint32_t ARG1);
void RX72M_RX72N_RX66N_func320(uint32_t ARG1);
void RX72M_RX72N_RX66N_func321(uint32_t ARG1);
void RX72M_RX72N_RX66N_func322(uint32_t ARG1);
void RX72M_RX72N_RX66N_func323(void);
