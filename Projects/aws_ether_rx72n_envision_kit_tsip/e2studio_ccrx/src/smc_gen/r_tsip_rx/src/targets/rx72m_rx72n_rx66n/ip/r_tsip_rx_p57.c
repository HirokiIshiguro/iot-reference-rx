...
*******************************************************************************************************************/ /**
* @details       RX72M RSA2048 Decryption with Private Key
...
e_tsip_err_t R_TSIP_Rsa2048ModularExponentDecryptSub(uint32_t *InData_KeyIndex, uint32_t *InData_Text, uint32_t *OutData_Text)
{
    ...
    {
        RX72M_RX72N_RX66N_func102(change_endian_long(0xb6d13ac4u), change_endian_long(0x055cdd01u), change_endian_long(0x130bd060u), change_endian_long(0x1527b2c7u));
    ...
    {
        RX72M_RX72N_RX66N_func100(change_endian_long(0xf6809eebu), change_endian_long(0x3cb57a8du), change_endian_long(0x1b8337c7u), change_endian_long(0xf3e6b745u));
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0x2aa3ceb8u), change_endian_long(0x81e2078fu), change_endian_long(0x9736225cu), change_endian_long(0x77b529f7u));
        ...
        RX72M_RX72N_RX66N_func102(change_endian_long(0xff82690fu), change_endian_long(0x00729155u), change_endian_long(0xc274be6cu), change_endian_long(0x3ba6c608u));
        TSIP.REG_1BCH.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_p57_r1.prc
 *********************************************************************************************************************/
