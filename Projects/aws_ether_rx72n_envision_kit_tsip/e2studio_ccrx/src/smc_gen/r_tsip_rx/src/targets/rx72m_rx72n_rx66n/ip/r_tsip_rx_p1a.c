...
*******************************************************************************************************************/ /**
* @details       RX72M Install ARC4 Key
...
e_tsip_err_t R_TSIP_GenerateArc4KeyIndexSub(uint32_t *InData_SharedKeyIndex, uint32_t *InData_SessionKey, uint32_t *InData_IV, uint32_t *InData_InstData, uint32_t *OutData_KeyIndex)
{
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0x8c017f26u), change_endian_long(0xceff4e4bu), change_endian_long(0x4fec4b7du), change_endian_long(0x0e0687f6u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX72M_RX72N_RX66N_func102(change_endian_long(0x990a0ff6u), change_endian_long(0xe4ee2c41u), change_endian_long(0x325da9b0u), change_endian_long(0xdaf620a8u));
    ...
    {
        RX72M_RX72N_RX66N_func100(change_endian_long(0xc753d315u), change_endian_long(0xc15829abu), change_endian_long(0x69bb6b0fu), change_endian_long(0xca8a1432u));
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0xcd3ff79cu), change_endian_long(0x226d814eu), change_endian_long(0xe2174a7cu), change_endian_long(0x79335dddu));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0xa8ca0d64u), change_endian_long(0xea45c042u), change_endian_long(0x5ade8c1au), change_endian_long(0xd38eb625u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0xb36c8d89u), change_endian_long(0xaeb864d6u), change_endian_long(0x46c8c723u), change_endian_long(0xf515a667u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0x4cde76c6u), change_endian_long(0x49dd8160u), change_endian_long(0x33a95d3cu), change_endian_long(0x963618cfu));
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0x31ec924eu), change_endian_long(0x76255cffu), change_endian_long(0x7fc5c1d8u), change_endian_long(0xe9ab98b9u));
        TSIP.REG_104H.WORD = 0x00000052u;
        ...
        TSIP.REG_1CH.WORD = 0x00001800u;
        RX72M_RX72N_RX66N_func100(change_endian_long(0x82153829u), change_endian_long(0xda0ba4bau), change_endian_long(0xd75d6386u), change_endian_long(0xfaba11eau));
        TSIP.REG_1CH.WORD = 0x00400000u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            RX72M_RX72N_RX66N_func102(change_endian_long(0x605a67b4u), change_endian_long(0x47399b36u), change_endian_long(0x87994cc0u), change_endian_long(0x0f3ba82bu));
            TSIP.REG_1BCH.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
        ...
        {
            RX72M_RX72N_RX66N_func100(change_endian_long(0xe5d2c55fu), change_endian_long(0x2e7a565bu), change_endian_long(0xe9d36bd2u), change_endian_long(0x1cadb746u));
            TSIP.REG_E0H.WORD = 0x81040000u;
            ...
            RX72M_RX72N_RX66N_func102(change_endian_long(0x3b23ca03u), change_endian_long(0x8ae10aa1u), change_endian_long(0x68e04cf8u), change_endian_long(0xea3e282bu));
            TSIP.REG_1BCH.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_p1a.prc
 *********************************************************************************************************************/
