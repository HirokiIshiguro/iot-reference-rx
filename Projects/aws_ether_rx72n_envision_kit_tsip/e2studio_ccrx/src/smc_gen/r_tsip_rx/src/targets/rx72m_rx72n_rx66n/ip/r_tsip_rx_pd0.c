...
*******************************************************************************************************************/ /**
* @details       RX72M TLS1.3 Resumption MasterSecret Generation
* @param[in]     InData_Cmd
...
e_tsip_err_t R_TSIP_Tls13GenerateResumptionMasterSecretSub(uint32_t *InData_Cmd, uint32_t *InData_Handle, uint32_t *InData_Master_SecretKeyIndex, uint32_t *InData_MsgHash, uint32_t *OutData_RMaster_SecretKeyIndex)
{
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX72M_RX72N_RX66N_func100(change_endian_long(0xc17364f7u), change_endian_long(0xe1c4f29bu), change_endian_long(0xbd7e836bu), change_endian_long(0x1422b07bu));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX72M_RX72N_RX66N_func102(change_endian_long(0x66993dbeu), change_endian_long(0xbe0b7964u), change_endian_long(0x2d76f5ceu), change_endian_long(0xb685ff22u));
    ...
    else
    {
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0xb2983efcu), change_endian_long(0x34f22d71u), change_endian_long(0x2395e47fu), change_endian_long(0x8a221037u));
        TSIP.REG_C4H.WORD = 0x400c0b0cu;
        /* WAIT_LOOP */
        while (1u != TSIP.REG_104H.BIT.B31)
        {
        ...
        RX72M_RX72N_RX66N_func102(change_endian_long(0x413f3ab6u), change_endian_long(0xe6391481u), change_endian_long(0xa26b8a3cu), change_endian_long(0x6bae999fu));
        TSIP.REG_1BCH.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_pd0_r1.prc
 *********************************************************************************************************************/
