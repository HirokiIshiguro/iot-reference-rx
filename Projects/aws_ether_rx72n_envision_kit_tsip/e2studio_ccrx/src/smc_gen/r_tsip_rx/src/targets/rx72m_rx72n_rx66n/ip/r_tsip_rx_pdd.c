...
*******************************************************************************************************************/ /**
* @details       RX72M TLS1.3 Resumption/0-RTT Handshake Secret Generation
...
e_tsip_err_t R_TSIP_Tls13GenerateResumptionHandshakeSecretSub(uint32_t *InData_Handle, uint32_t *InData_SharedSecretKeyIndexType, uint32_t *InData_PreSharedKeyIndex, uint32_t *InData_SharedSecretKeyIndex, uint32_t *OutData_Handshake_SecretKeyIndex)
{
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0x65ade8d1u), change_endian_long(0x4b22ef4fu), change_endian_long(0x86b2e0bfu), change_endian_long(0xf4778bd2u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX72M_RX72N_RX66N_func102(change_endian_long(0xa2a017c3u), change_endian_long(0xe7268f5fu), change_endian_long(0x39451dbfu), change_endian_long(0x477d1df9u));
    ...
    else
    {
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0x00be2b70u), change_endian_long(0xe7b3611du), change_endian_long(0x644c8576u), change_endian_long(0x83c71177u));
        TSIP.REG_1CH.WORD = 0x00400000u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            RX72M_RX72N_RX66N_func102(change_endian_long(0x087ba9e2u), change_endian_long(0xc14583a2u), change_endian_long(0xf140409bu), change_endian_long(0xad057dc4u));
            TSIP.REG_1BCH.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
        ...
        else
        {
            ...
            TSIP.REG_1CH.WORD = 0x00001800u;
            RX72M_RX72N_RX66N_func100(change_endian_long(0x5ad2610cu), change_endian_long(0x9537b17bu), change_endian_long(0x8f518aabu), change_endian_long(0xc3b23013u));
            TSIP.REG_1CH.WORD = 0x00400000u;
            TSIP.REG_1D0H.WORD = 0x00000000u;
            if (1u == (TSIP.REG_1CH.BIT.B22))
            {
                RX72M_RX72N_RX66N_func102(change_endian_long(0xf58b1c92u), change_endian_long(0x34dea9c1u), change_endian_long(0xcf21322cu), change_endian_long(0x1dae383bu));
                TSIP.REG_1BCH.WORD = 0x00000040u;
                /* WAIT_LOOP */
                while (0u != TSIP.REG_18H.BIT.B12)
                {
            ...
            else
            {
                ...
                TSIP.REG_1CH.WORD = 0x00001800u;
                RX72M_RX72N_RX66N_func100(change_endian_long(0xfbc4284au), change_endian_long(0x8c4cd4a8u), change_endian_long(0xdb141d11u), change_endian_long(0x4a923c7au));
                TSIP.REG_1CH.WORD = 0x00400000u;
                TSIP.REG_1D0H.WORD = 0x00000000u;
                if (1u == (TSIP.REG_1CH.BIT.B22))
                {
                    RX72M_RX72N_RX66N_func102(change_endian_long(0xc5b5deeau), change_endian_long(0xdf85e211u), change_endian_long(0xe8f4bb63u), change_endian_long(0xa9b860b0u));
                    TSIP.REG_1BCH.WORD = 0x00000040u;
                    /* WAIT_LOOP */
                    while (0u != TSIP.REG_18H.BIT.B12)
                    {
                ...
                else
                {
                    ...
                    TSIP.REG_28H.WORD = 0x008f0001u;
                    RX72M_RX72N_RX66N_func070();
                    RX72M_RX72N_RX66N_func100(change_endian_long(0x10baf736u), change_endian_long(0xf594ca32u), change_endian_long(0xa1acebcfu), change_endian_long(0xf96cf046u));
                    ...
                    RX72M_RX72N_RX66N_func100(change_endian_long(0x66d41e2bu), change_endian_long(0xd9df6423u), change_endian_long(0x8bcf961bu), change_endian_long(0x8572f11eu));
                    TSIP.REG_E0H.WORD = 0x81040280u;
                    ...
                    RX72M_RX72N_RX66N_func102(change_endian_long(0x7c6d5087u), change_endian_long(0x190d8a04u), change_endian_long(0x4cfe9adau), change_endian_long(0x59324b01u));
                    TSIP.REG_1BCH.WORD = 0x00000040u;
                    /* WAIT_LOOP */
                    while (0u != TSIP.REG_18H.BIT.B12)
                    {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_pdd_r1.prc
 *********************************************************************************************************************/
