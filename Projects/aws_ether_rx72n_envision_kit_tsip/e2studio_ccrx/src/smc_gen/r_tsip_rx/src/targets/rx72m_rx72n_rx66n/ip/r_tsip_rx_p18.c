...
/***********************************************************************************************************************
* Function Name: R_TSIP_GenerateTdesRandomKeyIndexSub
*******************************************************************************************************************/ /**
* @details       RX72M Generate key for TDES
...
e_tsip_err_t R_TSIP_GenerateTdesRandomKeyIndexSub(uint32_t *OutData_KeyIndex)
{
    ...
    TSIP.REG_84H.WORD = 0x00001801u;
    TSIP.REG_108H.WORD = 0x00000000u;
    RX72M_RX72N_RX66N_func100(change_endian_long(0xce4bcf16u), change_endian_long(0x8da2c3bfu), change_endian_long(0x28c41c21u), change_endian_long(0x0b1044deu));
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0xcd9e542cu), change_endian_long(0x657c3c86u), change_endian_long(0x9482bbfau), change_endian_long(0xe3a7e1ebu));
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0xb17be797u), change_endian_long(0xb8670391u), change_endian_long(0xb87d0d9cu), change_endian_long(0xa76b5666u));
    RX72M_RX72N_RX66N_func103();
    TSIP.REG_104H.WORD = 0x00000052u;
    TSIP.REG_C4H.WORD = 0x01000c84u;
    /* WAIT_LOOP */
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX72M_RX72N_RX66N_func100(change_endian_long(0x93471862u), change_endian_long(0x89e722bfu), change_endian_long(0x82c7ff45u), change_endian_long(0x7a05edbbu));
    RX72M_RX72N_RX66N_func103();
    TSIP.REG_104H.WORD = 0x00000052u;
    TSIP.REG_C4H.WORD = 0x01000c84u;
    /* WAIT_LOOP */
    ...
    TSIP.REG_E0H.WORD = 0x81060000u;
    TSIP.REG_00H.WORD = 0x0000181bu;
    /* WAIT_LOOP */
    while (0u != TSIP.REG_00H.BIT.B25)
    {
        TSIP_PRV_WAIT_LOOP_HOOK();
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX72M_RX72N_RX66N_func100(change_endian_long(0xb093920cu), change_endian_long(0x843b5eaau), change_endian_long(0x00899645u), change_endian_long(0x6fcc066cu));
    ...
    RX72M_RX72N_RX66N_func102(change_endian_long(0x51f3ee40u), change_endian_long(0x247247dcu), change_endian_long(0xb81daacau), change_endian_long(0xc966e6acu));
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_p18.prc
 *********************************************************************************************************************/
