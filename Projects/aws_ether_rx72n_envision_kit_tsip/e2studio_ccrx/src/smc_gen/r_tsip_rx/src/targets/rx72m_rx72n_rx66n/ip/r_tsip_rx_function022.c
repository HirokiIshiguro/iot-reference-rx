...
/***********************************************************************************************************************
* Function Name: RX72M_RX72N_RX66N_func022
*******************************************************************************************************************/ /**
* @details       RX72M func022
* @note          None
*/
void RX72M_RX72N_RX66N_func022(void)
{
    ...
    TSIP.REG_ECH.WORD = 0xe4adf76fu;
    TSIP.REG_ECH.WORD = 0x00030040u;
    TSIP.REG_ECH.WORD = 0x0000b7c0u;
    TSIP.REG_ECH.WORD = 0xb5fe26dfu;
    TSIP.REG_ECH.WORD = 0x00050040u;
    TSIP.REG_ECH.WORD = 0x0000b7c0u;
    TSIP.REG_ECH.WORD = 0x5996c09cu;
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_func022.prc
 *********************************************************************************************************************/
