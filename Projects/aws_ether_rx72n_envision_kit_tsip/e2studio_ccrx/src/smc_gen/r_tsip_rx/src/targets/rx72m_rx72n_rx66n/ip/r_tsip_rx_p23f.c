...
e_tsip_err_t R_TSIP_GenerateFirmwareMacFinalSub(uint32_t *InData_UpProgram, uint32_t *InData_UpMAC, uint32_t *OutData_Program, uint32_t *OutData_MAC, uint32_t MAX_CNT)
{
    ...
    (void)KEY_ADR;
    (void)OFS_ADR;
    RX72M_RX72N_RX66N_func100(change_endian_long(0x0959bfd5u), change_endian_long(0x98cf2f3fu), change_endian_long(0xa32b6039u), change_endian_long(0xcd59da03u));
    ...
    RX72M_RX72N_RX66N_func202();//DisableINTEGRATE_WRRDYBandINTEGRATE_RDRDYBinthisfunction.
    RX72M_RX72N_RX66N_func100(change_endian_long(0xc2a05881u), change_endian_long(0x64d35850u), change_endian_long(0x56b9474fu), change_endian_long(0x4edd0fafu));
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX72M_RX72N_RX66N_func100(change_endian_long(0x45050ef7u), change_endian_long(0xeacccc11u), change_endian_long(0xdba8479bu), change_endian_long(0xf534d0ccu));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX72M_RX72N_RX66N_func102(change_endian_long(0x22de09b8u), change_endian_long(0x7585ff9cu), change_endian_long(0xc0db0afeu), change_endian_long(0x6aeb7cddu));
    ...
    {
        RX72M_RX72N_RX66N_func100(change_endian_long(0xa53990d0u), change_endian_long(0x92f7f126u), change_endian_long(0xc1894234u), change_endian_long(0xf9ab4da8u));
        TSIP.REG_104H.WORD = 0x00000052u;
        ...
        RX72M_RX72N_RX66N_func102(change_endian_long(0xbb79f5efu), change_endian_long(0xddef728au), change_endian_long(0xa5a7ec72u), change_endian_long(0xddb3c7e0u));
        TSIP.REG_1BCH.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_p23f.prc
 *********************************************************************************************************************/
