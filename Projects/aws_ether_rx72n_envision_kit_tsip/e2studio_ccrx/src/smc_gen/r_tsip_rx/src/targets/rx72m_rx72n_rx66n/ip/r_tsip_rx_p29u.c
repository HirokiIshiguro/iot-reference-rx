...
/***********************************************************************************************************************
* Function Name: R_TSIP_Aes128GcmEncryptUpdateSub
*******************************************************************************************************************/ /**
* @details       RX72M AES-128 Encryption with GCM Mode Update
...
void R_TSIP_Aes128GcmEncryptUpdateSub(uint32_t *InData_Text, uint32_t *OutData_Text, uint32_t MAX_CNT)
{
    ...
    (void)KEY_ADR;
    (void)OFS_ADR;
    RX72M_RX72N_RX66N_func100(change_endian_long(0xecf44296u), change_endian_long(0x892cb1f3u), change_endian_long(0x24e1d096u), change_endian_long(0x2be1cbc4u));
    ...
    RX72M_RX72N_RX66N_func101(change_endian_long(0x99f1d755u), change_endian_long(0x18349fefu), change_endian_long(0xad376423u), change_endian_long(0x0de58146u));
}
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_p29u_r1.prc
 *********************************************************************************************************************/
