...
/***********************************************************************************************************************
* Function Name: R_TSIP_Tls13SVGenerateHandshakeSecretSub
*******************************************************************************************************************/ /**
* @details       RX72M TLS1.3 Handshake Secret Generation for Server
...
* @note          None
*/
e_tsip_err_t R_TSIP_Tls13SVGenerateHandshakeSecretSub(uint32_t *InData_SharedSecretKeyIndex, uint32_t *OutData_Handshake_SecretKeyIndex)
{
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX72M_RX72N_RX66N_func100(change_endian_long(0x9a66385cu), change_endian_long(0x386320e5u), change_endian_long(0x475b9447u), change_endian_long(0xee6e667fu));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX72M_RX72N_RX66N_func102(change_endian_long(0x14fc08d7u), change_endian_long(0x3e8084feu), change_endian_long(0x21be8d8bu), change_endian_long(0xc86204fau));
    ...
    {
        TSIP.REG_104H.WORD = 0x00000758u;
        ...
        TSIP.REG_100H.WORD = change_endian_long(0x6f2615a1u);
        /* WAIT_LOOP */
        while (1u != TSIP.REG_104H.BIT.B31)
        {
            /* waiting */
        }
        TSIP.REG_100H.WORD = change_endian_long(0x08c702c5u);
        /* WAIT_LOOP */
        while (1u != TSIP.REG_104H.BIT.B31)
        {
            /* waiting */
        }
        TSIP.REG_100H.WORD = change_endian_long(0x678f54fcu);
        /* WAIT_LOOP */
        while (1u != TSIP.REG_104H.BIT.B31)
        {
            /* waiting */
        }
        TSIP.REG_100H.WORD = change_endian_long(0x9dbab697u);
        /* WAIT_LOOP */
        while (1u != TSIP.REG_104H.BIT.B31)
        {
            /* waiting */
        }
        TSIP.REG_100H.WORD = change_endian_long(0x16c07618u);
        /* WAIT_LOOP */
        while (1u != TSIP.REG_104H.BIT.B31)
        {
            /* waiting */
        }
        TSIP.REG_100H.WORD = change_endian_long(0x9c48250cu);
        /* WAIT_LOOP */
        while (1u != TSIP.REG_104H.BIT.B31)
        {
            /* waiting */
        }
        TSIP.REG_100H.WORD = change_endian_long(0xebeac357u);
        /* WAIT_LOOP */
        while (1u != TSIP.REG_104H.BIT.B31)
        {
            /* waiting */
        }
        TSIP.REG_100H.WORD = change_endian_long(0x6c3611bau);
        TSIP.REG_28H.WORD = 0x00870001u;
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0x185698ceu), change_endian_long(0x8ed87ab7u), change_endian_long(0xaa2fe0a9u), change_endian_long(0xba7059adu));
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0x0c20b669u), change_endian_long(0x10708adeu), change_endian_long(0x5458a730u), change_endian_long(0x998a7f5cu));
        TSIP.REG_E0H.WORD = 0x81040280u;
        ...
        RX72M_RX72N_RX66N_func102(change_endian_long(0x11553b6fu), change_endian_long(0x207a0c1fu), change_endian_long(0x15c99767u), change_endian_long(0x073fbf8au));
        TSIP.REG_1BCH.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_p39.prc
 *********************************************************************************************************************/
