...
*******************************************************************************************************************/ /**
* @details       RX72M TLS Random Number Generation for Server
...
e_tsip_err_t R_TSIP_TlsSVGenerateServerRandomSub(uint32_t *InData_Type, uint32_t *InData_Time, uint32_t *OutData_Text, uint32_t *OutData_MAC)
{
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0xd03922f0u), change_endian_long(0xd895b2f4u), change_endian_long(0x13fa407cu), change_endian_long(0x5cc242e5u));
    ...
    TSIP.REG_E0H.WORD = 0x00000080u;
    TSIP.REG_1CH.WORD = 0x00260000u;
    RX72M_RX72N_RX66N_func100(change_endian_long(0x588ed9c5u), change_endian_long(0xe25558aeu), change_endian_long(0x9e4dd9a6u), change_endian_long(0xc23dbc26u));
    ...
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        ...
        TSIP.REG_E0H.WORD = 0x00000080u;
        TSIP.REG_1CH.WORD = 0x00260000u;
        RX72M_RX72N_RX66N_func100(change_endian_long(0x96dbde60u), change_endian_long(0xb11d532eu), change_endian_long(0xafd89daau), change_endian_long(0x9c3e8b1fu));
        TSIP.REG_1CH.WORD = 0x00400000u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            ...
            RX72M_RX72N_RX66N_func101(change_endian_long(0x1e0f069fu), change_endian_long(0x76efefc7u), change_endian_long(0xaa1df25eu), change_endian_long(0xa1aa8b19u));
        }
        RX72M_RX72N_RX66N_func101(change_endian_long(0x4224c922u), change_endian_long(0xb2163691u), change_endian_long(0x8edfc2c1u), change_endian_long(0x112c94cbu));
    }
    RX72M_RX72N_RX66N_func100(change_endian_long(0x82292e8bu), change_endian_long(0x74955132u), change_endian_long(0xad7d2b8au), change_endian_long(0x2cfdb645u));
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0x50a3206eu), change_endian_long(0xe18b0a77u), change_endian_long(0x2c3d268cu), change_endian_long(0x83f82837u));
    TSIP.REG_104H.WORD = 0x00000052u;
    ...
    RX72M_RX72N_RX66N_func102(change_endian_long(0x7b70f9c1u), change_endian_long(0x528c49c7u), change_endian_long(0x3098ef5eu), change_endian_long(0x587e1ec9u));
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_pd8.prc
 *********************************************************************************************************************/
