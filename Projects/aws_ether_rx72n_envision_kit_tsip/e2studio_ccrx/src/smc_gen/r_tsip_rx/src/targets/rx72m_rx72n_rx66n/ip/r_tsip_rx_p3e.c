...
/***********************************************************************************************************************
* Function Name: R_TSIP_Tls13SVGenerateApplicationTrafficKeySub
*******************************************************************************************************************/ /**
* @details       RX72M TLS1.3 Client Handshake Traffic Key Generation for Server
* @param[in]     InData_Cmd
...
e_tsip_err_t R_TSIP_Tls13SVGenerateApplicationTrafficKeySub(uint32_t *InData_Cmd, uint32_t *InData_Handle, uint32_t *InData_Master_SecretKeyIndex, uint32_t *InData_MsgHash, uint32_t *OutData_ServerApplicationSecretKeyIndex, uint32_t *OutData_ClientApplicationSecretKeyIndex, uint32_t *OutData_ServerWriteKeyIndex, uint32_t *OutData_ClientWriteKeyIndex)
{
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX72M_RX72N_RX66N_func100(change_endian_long(0xc696695cu), change_endian_long(0x87505642u), change_endian_long(0x55d5d728u), change_endian_long(0x4485f368u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX72M_RX72N_RX66N_func102(change_endian_long(0xa8d2b554u), change_endian_long(0x01c533b6u), change_endian_long(0x67031a69u), change_endian_long(0x6e37b3d8u));
    ...
    {
        RX72M_RX72N_RX66N_func100(change_endian_long(0x14ec06e9u), change_endian_long(0x944e1be6u), change_endian_long(0xd854e8ccu), change_endian_long(0x331e289bu));
        ...
        TSIP.REG_100H.WORD = change_endian_long(0x6cf8e0edu);
        TSIP.REG_28H.WORD = 0x00870001u;
        TSIP.REG_D0H.WORD = 0x00000100u;
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0x044682f4u), change_endian_long(0x7f43f047u), change_endian_long(0xf77564dbu), change_endian_long(0x4dc3f496u));
        TSIP.REG_C4H.WORD = 0x400c0b0cu;
        /* WAIT_LOOP */
        while (1u != TSIP.REG_104H.BIT.B31)
        {
        ...
        TSIP.REG_100H.WORD = change_endian_long(0x7010fdbdu);
        TSIP.REG_D0H.WORD = 0x00000100u;
        TSIP.REG_C4H.WORD = 0x02e087bfu;
        TSIP.REG_00H.WORD = 0x00002323u;
        TSIP.REG_2CH.WORD = 0x00000022u;
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0x73f83ad0u), change_endian_long(0xbd3409e7u), change_endian_long(0x57e39f9cu), change_endian_long(0xb07f3a5bu));
        ...
        TSIP.REG_100H.WORD = change_endian_long(0x8c22f90cu);
        TSIP.REG_ECH.WORD = 0x0000b7e0u;
        TSIP.REG_ECH.WORD = 0x00000050u;
        TSIP.REG_D0H.WORD = 0x00000100u;
        TSIP.REG_C4H.WORD = 0x02e087bfu;
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0xeb3228b1u), change_endian_long(0x65ab32b7u), change_endian_long(0x74a65b8fu), change_endian_long(0x60c3bc75u));
        TSIP.REG_E0H.WORD = 0x81040280u;
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0x6c48cfadu), change_endian_long(0x30c0c425u), change_endian_long(0x5ae01933u), change_endian_long(0x8ae9dc50u));
        TSIP.REG_C4H.WORD = 0x400c0b0cu;
        /* WAIT_LOOP */
        while (1u != TSIP.REG_104H.BIT.B31)
        {
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0x65374fa5u), change_endian_long(0x92523adfu), change_endian_long(0x7823253eu), change_endian_long(0x667b89bbu));
        TSIP.REG_E0H.WORD = 0x81040280u;
        TSIP.REG_04H.WORD = 0x00000612u;
        /* WAIT_LOOP */
        while (1u != TSIP.REG_04H.BIT.B30)
        ...
        RX72M_RX72N_RX66N_func102(change_endian_long(0xc3ecfa72u), change_endian_long(0x669947b7u), change_endian_long(0x0bbd6dbfu), change_endian_long(0xce453423u));
        TSIP.REG_1BCH.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_p3e_r1.prc
 *********************************************************************************************************************/
