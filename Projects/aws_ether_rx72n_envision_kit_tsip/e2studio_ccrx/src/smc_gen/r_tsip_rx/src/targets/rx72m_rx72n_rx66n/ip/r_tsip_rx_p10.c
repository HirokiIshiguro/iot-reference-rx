...
/***********************************************************************************************************************
* Function Name: R_TSIP_UpdateTlsRsaDataSub
*******************************************************************************************************************/ /**
* @details       RX72M Update TLS RSA Key
* @param[in]     InData_IV
...
e_tsip_err_t R_TSIP_UpdateTlsRsaDataSub(uint32_t *InData_IV, uint32_t *InData_InstData, uint32_t *OutData_InstData)
{
    ...
    TSIP.REG_84H.WORD = 0x00001001u;
    TSIP.REG_108H.WORD = 0x00000000u;
    RX72M_RX72N_RX66N_func100(change_endian_long(0x03ae96fdu), change_endian_long(0x55d8b1cau), change_endian_long(0xa2d71477u), change_endian_long(0x3fd931b6u));
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0x790bea2du), change_endian_long(0x34813a4fu), change_endian_long(0xeb0d5138u), change_endian_long(0xede2c1b4u));
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0x0e722d01u), change_endian_long(0x292b9b2au), change_endian_long(0x5a50ac2du), change_endian_long(0xadf6751fu));
    TSIP.REG_104H.WORD = 0x00000361u;
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0xf9b38561u), change_endian_long(0x8842cc0au), change_endian_long(0x1eeba56au), change_endian_long(0x514035e0u));
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0xfac68026u), change_endian_long(0xfd9802bbu), change_endian_long(0xb3526ed1u), change_endian_long(0x245d6751u));
    TSIP.REG_00H.WORD = 0x00012303u;
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0x9e51235fu), change_endian_long(0x5a58da57u), change_endian_long(0x40062e5au), change_endian_long(0x9587793du));
    TSIP.REG_104H.WORD = 0x00000361u;
    ...
    OutData_InstData[4+jLoop + 2] = TSIP.REG_100H.WORD;
    OutData_InstData[4+jLoop + 3] = TSIP.REG_100H.WORD;
    RX72M_RX72N_RX66N_func100(change_endian_long(0xd230faacu), change_endian_long(0xe2848a25u), change_endian_long(0x962a39d5u), change_endian_long(0x359dff30u));
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX72M_RX72N_RX66N_func100(change_endian_long(0x1b9ebb22u), change_endian_long(0x0fe98e17u), change_endian_long(0x16b67195u), change_endian_long(0xf4a120a0u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX72M_RX72N_RX66N_func102(change_endian_long(0xd5fad892u), change_endian_long(0xe0f71124u), change_endian_long(0x68051510u), change_endian_long(0x61bc0409u));
    ...
    {
        RX72M_RX72N_RX66N_func100(change_endian_long(0x79e313c7u), change_endian_long(0x416eee6fu), change_endian_long(0x9f02c123u), change_endian_long(0xa539541bu));
        TSIP.REG_104H.WORD = 0x00000052u;
        ...
        RX72M_RX72N_RX66N_func102(change_endian_long(0xf0db7aeeu), change_endian_long(0xeac2afe9u), change_endian_long(0xe87f6271u), change_endian_long(0xd951330du));
        TSIP.REG_1BCH.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_p10.prc
 *********************************************************************************************************************/
