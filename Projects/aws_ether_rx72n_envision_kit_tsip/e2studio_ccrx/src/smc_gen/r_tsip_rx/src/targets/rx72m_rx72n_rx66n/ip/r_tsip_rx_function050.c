...
/***********************************************************************************************************************
* Function Name: RX72M_RX72N_RX66N_func050
*******************************************************************************************************************/ /**
* @details       RX72M func050
* @param[in]     ARG1
* @note          None
*/
void RX72M_RX72N_RX66N_func050(uint32_t ARG1)
{
    ...
    TSIP.REG_14H.WORD = 0x10000000u;
    TSIP.REG_10CH.WORD = change_endian_long(ARG1);
}
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_func050.prc
 *********************************************************************************************************************/
TSIP_SEC_DEFAULT
