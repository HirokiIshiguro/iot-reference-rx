...
/***********************************************************************************************************************
* Function Name: R_TSIP_GenerateEccPublicKeyIndexSub
*******************************************************************************************************************/ /**
* @details       RX72M Install P-192/224/256 ECC Public key
...
* @note          None
*/
e_tsip_err_t R_TSIP_GenerateEccPublicKeyIndexSub(uint32_t *InData_SharedKeyIndex, uint32_t *InData_SessionKey, uint32_t *InData_Cmd, uint32_t *InData_IV, uint32_t *InData_InstData, uint32_t *OutData_KeyIndex)
{
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0xcad27e54u), change_endian_long(0xec0c6aa9u), change_endian_long(0xd64f73ecu), change_endian_long(0xe6d9198eu));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX72M_RX72N_RX66N_func102(change_endian_long(0x6c06cca6u), change_endian_long(0x15f10ff1u), change_endian_long(0x7e1ec93cu), change_endian_long(0x3559da00u));
    ...
    {
        RX72M_RX72N_RX66N_func100(change_endian_long(0xf943ea04u), change_endian_long(0x0632fde4u), change_endian_long(0x5eb9ae97u), change_endian_long(0x594b4507u));
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0x970dd1adu), change_endian_long(0x923729cbu), change_endian_long(0x38505dc0u), change_endian_long(0x602c8f32u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0xc1d04a0du), change_endian_long(0x69785d6du), change_endian_long(0xc74918ebu), change_endian_long(0xeb0bc778u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0x4833d524u), change_endian_long(0xb30f192eu), change_endian_long(0xe3589610u), change_endian_long(0x92bd2346u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0xc3e0662au), change_endian_long(0x705465a2u), change_endian_long(0x3783246bu), change_endian_long(0x01874837u));
        ...
        TSIP.REG_00H.WORD = 0x00002133u;
        TSIP.REG_104H.WORD = 0x00000b61u;
        TSIP.REG_B0H.WORD = 0x00000200u;
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0x3b37ea05u), change_endian_long(0xaea7ca83u), change_endian_long(0x84349ff9u), change_endian_long(0x2e6ef0c6u));
        TSIP.REG_104H.WORD = 0x00000052u;
        ...
        TSIP.REG_100H.WORD = InData_InstData[12];
        TSIP.REG_100H.WORD = InData_InstData[13];
        TSIP.REG_100H.WORD = InData_InstData[14];
        TSIP.REG_100H.WORD = InData_InstData[15];
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0xe799491au), change_endian_long(0x253c150eu), change_endian_long(0x70696dd0u), change_endian_long(0xde8c1daau));
        TSIP.REG_104H.WORD = 0x00000052u;
        ...
        TSIP.REG_100H.WORD = InData_InstData[16];
        TSIP.REG_100H.WORD = InData_InstData[17];
        TSIP.REG_100H.WORD = InData_InstData[18];
        TSIP.REG_100H.WORD = InData_InstData[19];
        ...
        TSIP.REG_1CH.WORD = 0x00001800u;
        RX72M_RX72N_RX66N_func100(change_endian_long(0x8318bb06u), change_endian_long(0x4a6ca80eu), change_endian_long(0x4dd082cbu), change_endian_long(0x761d9253u));
        TSIP.REG_1CH.WORD = 0x00400000u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            RX72M_RX72N_RX66N_func102(change_endian_long(0x84928c9cu), change_endian_long(0x8c9b4c44u), change_endian_long(0x4ee05539u), change_endian_long(0xa88fc364u));
            TSIP.REG_1B4H.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
        ...
        {
            RX72M_RX72N_RX66N_func100(change_endian_long(0x1390a0b0u), change_endian_long(0xc79ff0e6u), change_endian_long(0x39026774u), change_endian_long(0x1c7c6f4cu));
            TSIP.REG_E0H.WORD = 0x81040000u;
            ...
            RX72M_RX72N_RX66N_func102(change_endian_long(0x869499ccu), change_endian_long(0xc6f50fcfu), change_endian_long(0x370b5d2cu), change_endian_long(0xa1b6f668u));
            TSIP.REG_1B4H.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_pfa_r1.prc
 *********************************************************************************************************************/
#endif /* #if TSIP_PRV_USE_ECC == 1 */
