...
e_tsip_err_t R_TSIP_TlsCertificateVerificationSub(uint32_t *InData_Sel_InDataPubKeyType, uint32_t *InData_Sel_OutDataPubKeyType, uint32_t *InData_PubKey, uint32_t *InData_TBSCertificate, uint32_t *InData_TBSCertificateLength, uint32_t *InData_Signature, uint32_t *InData_TBSCertificateInfo, const uint32_t *InData_DomainParam, uint32_t *OutData_PubKey)
{
    ...
    RX72M_RX72N_RX66N_func101(change_endian_long(0x67b2aebcu), change_endian_long(0xee3f5be8u), change_endian_long(0xf225a179u), change_endian_long(0xfd0afa2fu));
    RX72M_RX72N_RX66N_func403(InData_Sel_InDataPubKeyType, InData_Sel_OutDataPubKeyType, InData_PubKey, InData_TBSCertificate, InData_TBSCertificateLength, InData_Signature, InData_TBSCertificateInfo, InData_DomainParam, OutData_PubKey);
    TSIP.REG_ECH.WORD = 0x38000c00u;
    TSIP.REG_E0H.WORD = 0x00000080u;
    TSIP.REG_1CH.WORD = 0x00A60000u;
    RX72M_RX72N_RX66N_func100(change_endian_long(0x9ab4974fu), change_endian_long(0x4ad37d37u), change_endian_long(0xec5dd587u), change_endian_long(0x46c79b6cu));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX72M_RX72N_RX66N_func102(change_endian_long(0x69dd50f1u), change_endian_long(0x44bdb480u), change_endian_long(0xbdaa456bu), change_endian_long(0xf7384193u));
    ...
    {
        RX72M_RX72N_RX66N_func102(change_endian_long(0x1c4009a6u), change_endian_long(0x526de329u), change_endian_long(0x36be15aeu), change_endian_long(0x0ff730a6u));
        TSIP.REG_1B8H.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_pe1_r4.prc
 *********************************************************************************************************************/
#endif /* #if TSIP_TLS == 1 */
