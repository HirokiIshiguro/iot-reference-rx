...
*******************************************************************************************************************/ /**
* @details       RX72M TLS MasterSecret Generation for Server
...
e_tsip_err_t R_TSIP_TlsSVGenerateMasterSecretSub(uint32_t *InData_Sel_CipherSuite, uint32_t *InData_PreMasterSecret, uint32_t *InData_ClientRandom, uint32_t *InData_ServerRandom, uint32_t *InData_MAC, uint32_t *OutData_MasterSecret)
{
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0xc99d6305u), change_endian_long(0xebd8e439u), change_endian_long(0x703fa597u), change_endian_long(0xb1304bdau));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX72M_RX72N_RX66N_func102(change_endian_long(0x13625f4bu), change_endian_long(0xcc4a415au), change_endian_long(0x7fdd9656u), change_endian_long(0x85503a62u));
    ...
    else
    {
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0x9ab5080eu), change_endian_long(0xff3b9ee6u), change_endian_long(0x353a9e6du), change_endian_long(0x78f52b89u));
        TSIP.REG_1CH.WORD = 0x00400000u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            ...
            RX72M_RX72N_RX66N_func101(change_endian_long(0x3ee57a0du), change_endian_long(0xd631913eu), change_endian_long(0xbb51cd2eu), change_endian_long(0x78f2dfb0u));
        }
        else
        {
            TSIP.REG_C4H.WORD = 0x400c0b0cu;
            ...
            TSIP.REG_100H.WORD = InData_PreMasterSecret[14];
            TSIP.REG_100H.WORD = InData_PreMasterSecret[15];
            RX72M_RX72N_RX66N_func101(change_endian_long(0x2be0662fu), change_endian_long(0x9f80da97u), change_endian_long(0x97804311u), change_endian_long(0xdffc9ceau));
        }
        ...
        TSIP.REG_1CH.WORD = 0x00001800u;
        RX72M_RX72N_RX66N_func100(change_endian_long(0xac7f056au), change_endian_long(0xac752c0eu), change_endian_long(0x681cd7d0u), change_endian_long(0x15c37c33u));
        TSIP.REG_1CH.WORD = 0x00400000u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            RX72M_RX72N_RX66N_func102(change_endian_long(0xeb396648u), change_endian_long(0x2a6b2493u), change_endian_long(0x7a9bc6ceu), change_endian_long(0x67d43c1eu));
            TSIP.REG_1B8H.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
        ...
        else
        {
            ...
            TSIP.REG_1CH.WORD = 0x00001800u;
            RX72M_RX72N_RX66N_func100(change_endian_long(0xfdd6749cu), change_endian_long(0x524116bcu), change_endian_long(0x44a22ac8u), change_endian_long(0x8a9ea820u));
            TSIP.REG_1CH.WORD = 0x00400000u;
            TSIP.REG_1D0H.WORD = 0x00000000u;
            if (1u == (TSIP.REG_1CH.BIT.B22))
            {
                RX72M_RX72N_RX66N_func102(change_endian_long(0x2ff9bd11u), change_endian_long(0xf2bd003bu), change_endian_long(0x246da4bdu), change_endian_long(0x1f60d9f4u));
            ...
            else
            {
                ...
                RX72M_RX72N_RX66N_func101(change_endian_long(0xe9a757ffu), change_endian_long(0xe9233139u), change_endian_long(0x6d465cc4u), change_endian_long(0x1c727714u));
                ...
                RX72M_RX72N_RX66N_func101(change_endian_long(0x088c6ae1u), change_endian_long(0xb1d3d423u), change_endian_long(0xa43243e8u), change_endian_long(0x72afd02cu));
                RX72M_RX72N_RX66N_func032();
                ...
                TSIP.REG_ECH.WORD = 0x0000b5c0u;
                TSIP.REG_ECH.WORD = 0x00000020u;
                RX72M_RX72N_RX66N_func101(change_endian_long(0xc6cbe7d0u), change_endian_long(0xe5ace7d6u), change_endian_long(0xfd789a3fu), change_endian_long(0x97e12634u));
                RX72M_RX72N_RX66N_func032();
                TSIP.REG_ECH.WORD = 0x00002c20u;
                TSIP.REG_ECH.WORD = 0x0000096bu;
                TSIP.REG_ECH.WORD = 0x0000b580u;
                ...
                TSIP.REG_ECH.WORD = 0x0000b5c0u;
                TSIP.REG_ECH.WORD = 0x0000006du;
                RX72M_RX72N_RX66N_func101(change_endian_long(0x2aef4817u), change_endian_long(0xb12bfa59u), change_endian_long(0x3f32f6b5u), change_endian_long(0xda94f824u));
                RX72M_RX72N_RX66N_func032();
                RX72M_RX72N_RX66N_func100(change_endian_long(0x6f3dd6e7u), change_endian_long(0x8c6b2f23u), change_endian_long(0x6791b29bu), change_endian_long(0x1fc6cb21u));
                ...
                RX72M_RX72N_RX66N_func100(change_endian_long(0xade1efc0u), change_endian_long(0x022e4436u), change_endian_long(0x01ecdebeu), change_endian_long(0x002cc4a7u));
                TSIP.REG_104H.WORD = 0x00000052u;
                ...
                RX72M_RX72N_RX66N_func100(change_endian_long(0xecaf8955u), change_endian_long(0x179a8adbu), change_endian_long(0x006a028bu), change_endian_long(0x88c479d9u));
                TSIP.REG_104H.WORD = 0x00000052u;
                ...
                RX72M_RX72N_RX66N_func100(change_endian_long(0xfe080529u), change_endian_long(0xb8a0bb4bu), change_endian_long(0x22026bfcu), change_endian_long(0x2d60b81du));
                TSIP.REG_104H.WORD = 0x00000052u;
                ...
                RX72M_RX72N_RX66N_func102(change_endian_long(0x121dff00u), change_endian_long(0xe6451d39u), change_endian_long(0xc4f3c911u), change_endian_long(0x8463f6efu));
                TSIP.REG_1B8H.WORD = 0x00000040u;
                /* WAIT_LOOP */
                while (0u != TSIP.REG_18H.BIT.B12)
                {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_pc4.prc
 *********************************************************************************************************************/
