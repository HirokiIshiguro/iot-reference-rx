...
e_tsip_err_t R_TSIP_TlsSVCertificateVerificationSub(uint32_t *InData_Sel_InDataPubKeyType, uint32_t *InData_Sel_OutDataPubKeyType, uint32_t *InData_PubKey, uint32_t *InData_TBSCertificate, uint32_t *InData_TBSCertificateLength, uint32_t *InData_Signature, uint32_t *InData_TBSCertificateInfo, const uint32_t *InData_DomainParam, uint32_t *OutData_PubKey)
{
    ...
    RX72M_RX72N_RX66N_func101(change_endian_long(0x8dcaeb0au), change_endian_long(0xa8df5c06u), change_endian_long(0xfc48a08cu), change_endian_long(0xde016c27u));
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0x25e1110bu), change_endian_long(0xe8271fccu), change_endian_long(0x47447911u), change_endian_long(0xaf7f3409u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX72M_RX72N_RX66N_func102(change_endian_long(0x7a6fb92eu), change_endian_long(0x2c702ec3u), change_endian_long(0xe873e992u), change_endian_long(0x52f8a4e2u));
    ...
    {
        RX72M_RX72N_RX66N_func102(change_endian_long(0x00504b2du), change_endian_long(0x438e3df8u), change_endian_long(0xb1732c3fu), change_endian_long(0x00459671u));
        TSIP.REG_1B8H.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_pc1_r2.prc
 *********************************************************************************************************************/
