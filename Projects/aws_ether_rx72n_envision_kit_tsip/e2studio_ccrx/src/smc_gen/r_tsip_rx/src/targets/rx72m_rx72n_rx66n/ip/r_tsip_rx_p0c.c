...
/***********************************************************************************************************************
* Function Name: R_TSIP_UpdateRsa1024PrivateKeyIndexSub
*******************************************************************************************************************/ /**
* @details       RX72M Update 1024bit RSA Private Key
* @param[in]     InData_IV
...
* @note          None
*/
e_tsip_err_t R_TSIP_UpdateRsa1024PrivateKeyIndexSub(uint32_t *InData_IV, uint32_t *InData_InstData, uint32_t *OutData_KeyIndex)
{
    ...
    TSIP.REG_84H.WORD = 0x00000c01u;
    TSIP.REG_108H.WORD = 0x00000000u;
    RX72M_RX72N_RX66N_func100(change_endian_long(0x2b1ffcf7u), change_endian_long(0xb6c08a87u), change_endian_long(0x60784740u), change_endian_long(0x2e446f99u));
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0xb17bcdeeu), change_endian_long(0x75abeb82u), change_endian_long(0xac0a62e4u), change_endian_long(0x21b88827u));
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0x3d8a88d8u), change_endian_long(0x7fc33fd2u), change_endian_long(0xd31c4a85u), change_endian_long(0xa0339fddu));
    TSIP.REG_104H.WORD = 0x00000361u;
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0x11c510fau), change_endian_long(0xecc6e2c6u), change_endian_long(0x812fb346u), change_endian_long(0x195e847du));
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX72M_RX72N_RX66N_func100(change_endian_long(0xceb3a27bu), change_endian_long(0xd8e4f9a8u), change_endian_long(0x2501e992u), change_endian_long(0x60f67d14u));
    TSIP.REG_00H.WORD = 0x00003183u;
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX72M_RX72N_RX66N_func100(change_endian_long(0x2dce0e5eu), change_endian_long(0x373965f2u), change_endian_long(0x955b7fefu), change_endian_long(0x714902c0u));
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX72M_RX72N_RX66N_func100(change_endian_long(0x8618ec5du), change_endian_long(0xbe978a8fu), change_endian_long(0x1f364a99u), change_endian_long(0x80045f2fu));
    TSIP.REG_104H.WORD = 0x00000052u;
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX72M_RX72N_RX66N_func100(change_endian_long(0xe764aac2u), change_endian_long(0x86eaec27u), change_endian_long(0x094eab71u), change_endian_long(0x7d982160u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX72M_RX72N_RX66N_func102(change_endian_long(0x5544f69du), change_endian_long(0x04061dc0u), change_endian_long(0x4416a61au), change_endian_long(0xad80f12du));
    ...
    {
        RX72M_RX72N_RX66N_func100(change_endian_long(0xea5196e7u), change_endian_long(0xbc9b29efu), change_endian_long(0xa45f9d2bu), change_endian_long(0xf3a39b2du));
        TSIP.REG_E0H.WORD = 0x81040000u;
        ...
        RX72M_RX72N_RX66N_func102(change_endian_long(0x0919a59du), change_endian_long(0xaff41b24u), change_endian_long(0xc68e3f60u), change_endian_long(0x6820723bu));
        TSIP.REG_1BCH.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_p0c_r1.prc
 *********************************************************************************************************************/
