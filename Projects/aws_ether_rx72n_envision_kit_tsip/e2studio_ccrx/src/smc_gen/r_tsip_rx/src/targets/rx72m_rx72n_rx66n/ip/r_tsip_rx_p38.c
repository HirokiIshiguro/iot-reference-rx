...
*******************************************************************************************************************/ /**
* @details       RX72M TLS1.3 ECDHE Shared Secret Calculation for Server
* @param[in]     InData_Cmd
...
* @note          None
*/
e_tsip_err_t R_TSIP_Tls13SVGenerateEcdheSharedSecretSub(uint32_t *InData_Cmd, uint32_t *InData_PubKey, uint32_t *InData_KeyIndex, const uint32_t *InData_DomainParam, uint32_t *OutData_SharedSecretKeyIndex)
{
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0x8d0e115bu), change_endian_long(0x5f80428cu), change_endian_long(0x1d205159u), change_endian_long(0x279b205cu));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX72M_RX72N_RX66N_func102(change_endian_long(0x5084f2a0u), change_endian_long(0xaa00d071u), change_endian_long(0xcb73fb72u), change_endian_long(0x2c0376b4u));
    ...
    else
    {
        ...
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            RX72M_RX72N_RX66N_func102(change_endian_long(0x87ce25e0u), change_endian_long(0xf9763c11u), change_endian_long(0x96cedd5fu), change_endian_long(0x08f938cdu));
            TSIP.REG_1B8H.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
        ...
        {
            RX72M_RX72N_RX66N_func100(change_endian_long(0xe464bc06u), change_endian_long(0xff78f4dau), change_endian_long(0xeb265331u), change_endian_long(0x133e364fu));
            TSIP.REG_24H.WORD = 0x0000dcd0u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_24H.BIT.B21)
            {
            ...
            RX72M_RX72N_RX66N_func100(change_endian_long(0x38750bc6u), change_endian_long(0x7d03847du), change_endian_long(0x85088656u), change_endian_long(0x12aadf98u));
            TSIP.REG_1CH.WORD = 0x00400000u;
            TSIP.REG_1D0H.WORD = 0x00000000u;
            if (1u == (TSIP.REG_1CH.BIT.B22))
            {
                RX72M_RX72N_RX66N_func102(change_endian_long(0xd53ff74eu), change_endian_long(0x0f48d3d3u), change_endian_long(0xe85bc5e6u), change_endian_long(0x0682e6ecu));
                TSIP.REG_1B8H.WORD = 0x00000040u;
                /* WAIT_LOOP */
                while (0u != TSIP.REG_18H.BIT.B12)
                {
            ...
            {
                RX72M_RX72N_RX66N_func100(change_endian_long(0x12e1140bu), change_endian_long(0x5a703c0au), change_endian_long(0x8db1d25cu), change_endian_long(0xf13497ecu));
                ...
                TSIP.REG_18H.WORD = 0x00000000u;
                RX72M_RX72N_RX66N_func100(change_endian_long(0xd2247752u), change_endian_long(0x4adaa615u), change_endian_long(0x95a3640cu), change_endian_long(0x5f203cc3u));
                TSIP.REG_34H.WORD = 0x00000003u;
                TSIP.REG_24H.WORD = 0x800048d0u;
                /* WAIT_LOOP */
                while (0u != TSIP.REG_24H.BIT.B21)
                ...
                RX72M_RX72N_RX66N_func100(change_endian_long(0xaafe87d0u), change_endian_long(0x2d813a9cu), change_endian_long(0x29e4f638u), change_endian_long(0x592c83c6u));
                ...
                RX72M_RX72N_RX66N_func100(change_endian_long(0x9891c802u), change_endian_long(0xb27948ddu), change_endian_long(0x6c27a9b6u), change_endian_long(0xee2b432cu));
                TSIP.REG_E0H.WORD = 0x81040280u;
                ...
                RX72M_RX72N_RX66N_func102(change_endian_long(0x11fbea06u), change_endian_long(0xc95aad30u), change_endian_long(0xe70bb5f8u), change_endian_long(0x34449974u));
                TSIP.REG_1B8H.WORD = 0x00000040u;
                /* WAIT_LOOP */
                while (0u != TSIP.REG_18H.BIT.B12)
                {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_p38_r2.prc
 *********************************************************************************************************************/
