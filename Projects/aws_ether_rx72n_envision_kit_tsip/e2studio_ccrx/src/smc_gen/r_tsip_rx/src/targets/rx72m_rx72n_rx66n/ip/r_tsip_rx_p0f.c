...
*******************************************************************************************************************/ /**
* @details       RX72M Update HMAC-SHA1/SHA224/SHA256 Key
* @param[in]     InData_Cmd
* @param[in]     InData_IV
...
e_tsip_err_t R_TSIP_UpdateShaHmacKeyIndexSub(uint32_t *InData_Cmd, uint32_t *InData_IV, uint32_t *InData_InstData, uint32_t *OutData_KeyIndex)
{
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0xcdd207ccu), change_endian_long(0x7ec18bbdu), change_endian_long(0x5d48b8bdu), change_endian_long(0xf242c513u));
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0x53b5028du), change_endian_long(0xc29cbc8bu), change_endian_long(0xe140e5cdu), change_endian_long(0x451bd51bu));
    TSIP.REG_104H.WORD = 0x00000361u;
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0x0e65f4f3u), change_endian_long(0x43e32279u), change_endian_long(0x48df0a4du), change_endian_long(0x5b825a4fu));
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0x879dbb77u), change_endian_long(0xaa82fbd3u), change_endian_long(0x6c58ac82u), change_endian_long(0x90be5245u));
    TSIP.REG_104H.WORD = 0x00000052u;
    ...
    {
        RX72M_RX72N_RX66N_func102(change_endian_long(0xbe0e8eb9u), change_endian_long(0xbb6bf866u), change_endian_long(0x3650ea49u), change_endian_long(0x6049bebdu));
    ...
    {
        RX72M_RX72N_RX66N_func100(change_endian_long(0x5fc73dc9u), change_endian_long(0xf714c19bu), change_endian_long(0x434c9e34u), change_endian_long(0xebacacfdu));
        TSIP.REG_E0H.WORD = 0x81040000u;
        ...
        RX72M_RX72N_RX66N_func102(change_endian_long(0x81385049u), change_endian_long(0x41813a51u), change_endian_long(0x2beb0e65u), change_endian_long(0xe1d31f2eu));
        TSIP.REG_1B4H.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_p0f_r1.prc
 *********************************************************************************************************************/
