...
e_tsip_err_t R_TSIP_EcdsaSigunatureVerificationSub(uint32_t *InData_Cmd, uint32_t *InData_KeyIndex, uint32_t *InData_MsgDgst, uint32_t *InData_Signature, const uint32_t *InData_DomainParam)
{
    ...
    else
    {
        ...
        else
        {
            ...
            RX72M_RX72N_RX66N_func101(change_endian_long(0xd4cb5399u), change_endian_long(0xd5146e13u), change_endian_long(0x4266169cu), change_endian_long(0x26234df3u));
            RX72M_RX72N_RX66N_func010(InData_DomainParam);
            RX72M_RX72N_RX66N_func100(change_endian_long(0x601b4a9du), change_endian_long(0x076203f2u), change_endian_long(0x4c9dd703u), change_endian_long(0x9277f7d2u));
            TSIP.REG_1CH.WORD = 0x00400000u;
            TSIP.REG_1D0H.WORD = 0x00000000u;
            if (1u == (TSIP.REG_1CH.BIT.B22))
            {
                RX72M_RX72N_RX66N_func102(change_endian_long(0x588f0096u), change_endian_long(0x6216d506u), change_endian_long(0x22501bdbu), change_endian_long(0x0a765921u));
                TSIP.REG_1BCH.WORD = 0x00000040u;
                /* WAIT_LOOP */
                while (0u != TSIP.REG_18H.BIT.B12)
                {
            ...
            {
                RX72M_RX72N_RX66N_func102(change_endian_long(0x628c9737u), change_endian_long(0x558f3b50u), change_endian_long(0x4627dc92u), change_endian_long(0x40afdd07u));
                TSIP.REG_1BCH.WORD = 0x00000040u;
                /* WAIT_LOOP */
                while (0u != TSIP.REG_18H.BIT.B12)
                {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_pf1_r2.prc
 *********************************************************************************************************************/
