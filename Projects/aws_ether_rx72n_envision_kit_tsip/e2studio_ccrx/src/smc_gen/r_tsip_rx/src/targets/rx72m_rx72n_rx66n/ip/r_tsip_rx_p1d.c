...
e_tsip_err_t R_TSIP_UpdateArc4KeyIndexSub(uint32_t *InData_IV, uint32_t *InData_InstData, uint32_t *OutData_KeyIndex)
{
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0xa935de0fu), change_endian_long(0xa55ebcdau), change_endian_long(0x745bf0bbu), change_endian_long(0x0f72cec4u));
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0x5c28818du), change_endian_long(0x54872496u), change_endian_long(0x82bccba6u), change_endian_long(0x7266f759u));
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0xa2542cd5u), change_endian_long(0x70fbd637u), change_endian_long(0x6d26a3b3u), change_endian_long(0xa5a1e58bu));
    TSIP.REG_104H.WORD = 0x00000361u;
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0x5bbb203bu), change_endian_long(0xd7fe2abbu), change_endian_long(0x38e05c80u), change_endian_long(0xbb145ad1u));
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0x78dbaae6u), change_endian_long(0x6aa269bdu), change_endian_long(0x2ccd353bu), change_endian_long(0x6ac54e2fu));
    TSIP.REG_104H.WORD = 0x00000052u;
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX72M_RX72N_RX66N_func100(change_endian_long(0xe6ece378u), change_endian_long(0xa3262d50u), change_endian_long(0x7d71042au), change_endian_long(0xd3e49719u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX72M_RX72N_RX66N_func102(change_endian_long(0x8014cccfu), change_endian_long(0x70d17b5fu), change_endian_long(0x62b061d5u), change_endian_long(0xa4bbd458u));
    ...
    {
        RX72M_RX72N_RX66N_func100(change_endian_long(0xeced5626u), change_endian_long(0xa0bb6108u), change_endian_long(0xc603e620u), change_endian_long(0x486ce17du));
        TSIP.REG_E0H.WORD = 0x81040000u;
        ...
        RX72M_RX72N_RX66N_func102(change_endian_long(0xefc591c9u), change_endian_long(0x24168726u), change_endian_long(0xe4a9bc49u), change_endian_long(0xf7ca4141u));
        TSIP.REG_1B4H.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_p1d.prc
 *********************************************************************************************************************/
