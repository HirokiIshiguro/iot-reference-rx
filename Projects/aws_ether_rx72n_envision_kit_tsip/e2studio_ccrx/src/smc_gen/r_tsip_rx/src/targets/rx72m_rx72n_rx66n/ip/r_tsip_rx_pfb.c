...
*******************************************************************************************************************/ /**
* @details       RX72M Install P-384 ECC Public Key
...
e_tsip_err_t R_TSIP_GenerateEccP384PublicKeyIndexSub(uint32_t *InData_SharedKeyIndex, uint32_t *InData_SessionKey, uint32_t *InData_IV, uint32_t *InData_InstData, uint32_t *OutData_KeyIndex)
{
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0xe1f411ddu), change_endian_long(0x62c0e5e8u), change_endian_long(0x40f7ab64u), change_endian_long(0x5d401312u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX72M_RX72N_RX66N_func102(change_endian_long(0x65ccfe17u), change_endian_long(0xc1182459u), change_endian_long(0x61932fbeu), change_endian_long(0xbf08191du));
    ...
    {
        RX72M_RX72N_RX66N_func100(change_endian_long(0x1cfe2051u), change_endian_long(0x0ad23020u), change_endian_long(0x9ff4279du), change_endian_long(0x4d56d873u));
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0x1c9f107cu), change_endian_long(0xa6bd60e1u), change_endian_long(0xe17d67b2u), change_endian_long(0x5eea13acu));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0x2fca3f50u), change_endian_long(0x8cc01502u), change_endian_long(0xa8a255b3u), change_endian_long(0xbf634170u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0x146a3bedu), change_endian_long(0x89e50803u), change_endian_long(0x83ae9011u), change_endian_long(0x0e02f7e7u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0xcadbcd28u), change_endian_long(0x94564082u), change_endian_long(0x99950234u), change_endian_long(0x580bec00u));
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0xc9114a4du), change_endian_long(0x231971b2u), change_endian_long(0xc3322537u), change_endian_long(0xb6884e28u));
        TSIP.REG_104H.WORD = 0x00000052u;
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0xf6b0eb70u), change_endian_long(0x046a8104u), change_endian_long(0x7605af67u), change_endian_long(0xf90c1623u));
        TSIP.REG_104H.WORD = 0x00000052u;
        ...
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            RX72M_RX72N_RX66N_func102(change_endian_long(0x32fca50eu), change_endian_long(0x9926973cu), change_endian_long(0x564f780au), change_endian_long(0x4cca1146u));
            TSIP.REG_1B4H.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
        ...
        {
            RX72M_RX72N_RX66N_func100(change_endian_long(0x7d406139u), change_endian_long(0xf73258d4u), change_endian_long(0x7f222e98u), change_endian_long(0xe0cd6669u));
            TSIP.REG_E0H.WORD = 0x81040000u;
            ...
            RX72M_RX72N_RX66N_func102(change_endian_long(0x554ef319u), change_endian_long(0x78c8d503u), change_endian_long(0xb7fadd4eu), change_endian_long(0x1fd6dfe9u));
            TSIP.REG_1B4H.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_pfb.prc
 *********************************************************************************************************************/
