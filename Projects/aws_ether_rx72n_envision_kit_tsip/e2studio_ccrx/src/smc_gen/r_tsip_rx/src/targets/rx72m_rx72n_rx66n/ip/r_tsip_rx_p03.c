...
*******************************************************************************************************************/ /**
* @details       RX72M Install 128bit AES Key
...
e_tsip_err_t R_TSIP_GenerateAes128KeyIndexSub(uint32_t *InData_SharedKeyIndex, uint32_t *InData_SessionKey, uint32_t *InData_IV, uint32_t *InData_InstData, uint32_t *OutData_KeyIndex)
{
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0x5a36c6e6u), change_endian_long(0x503de1aau), change_endian_long(0x69cb473eu), change_endian_long(0xa0e44989u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX72M_RX72N_RX66N_func102(change_endian_long(0x6f05a654u), change_endian_long(0xe0579d4eu), change_endian_long(0xdc6f44fcu), change_endian_long(0x98f74cfbu));
    ...
    {
        RX72M_RX72N_RX66N_func100(change_endian_long(0x9e0db225u), change_endian_long(0xfbb06f56u), change_endian_long(0xc01e04a8u), change_endian_long(0x73fb9733u));
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0xc20a9d29u), change_endian_long(0xf23aa0e2u), change_endian_long(0xe849cb45u), change_endian_long(0x75b99e5du));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0x958b1476u), change_endian_long(0x6193028au), change_endian_long(0xc078f56fu), change_endian_long(0x5876052du));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0xcddbf4afu), change_endian_long(0x9345a087u), change_endian_long(0x042fbfefu), change_endian_long(0x1df818e3u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0xa26d48b3u), change_endian_long(0xee28c472u), change_endian_long(0xce53c018u), change_endian_long(0x2112837du));
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0xf12f5fcbu), change_endian_long(0x1be7b6fbu), change_endian_long(0x3c5f6514u), change_endian_long(0xa10d616cu));
        TSIP.REG_104H.WORD = 0x00000052u;
        ...
        TSIP.REG_1CH.WORD = 0x00001800u;
        RX72M_RX72N_RX66N_func100(change_endian_long(0x2f1e55a9u), change_endian_long(0xf9f75cafu), change_endian_long(0x40e2b0e5u), change_endian_long(0xbd891ef3u));
        TSIP.REG_1CH.WORD = 0x00400000u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            RX72M_RX72N_RX66N_func102(change_endian_long(0x5c3ffacdu), change_endian_long(0x1b57355fu), change_endian_long(0x265264abu), change_endian_long(0x56e4b0a2u));
            TSIP.REG_1BCH.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
        ...
        {
            RX72M_RX72N_RX66N_func100(change_endian_long(0xbf9b4d77u), change_endian_long(0xd365a0b0u), change_endian_long(0x425a0d1du), change_endian_long(0x7df3bcfau));
            TSIP.REG_E0H.WORD = 0x81040000u;
            ...
            RX72M_RX72N_RX66N_func102(change_endian_long(0x9070f082u), change_endian_long(0xf8b28169u), change_endian_long(0x9de17357u), change_endian_long(0x499c4240u));
            TSIP.REG_1BCH.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_p03.prc
 *********************************************************************************************************************/
