...
/***********************************************************************************************************************
* Function Name: R_TSIP_Tls13SVGenerateClientHandshakeTrafficKeySub
*******************************************************************************************************************/ /**
...
* @note          None
*/
e_tsip_err_t R_TSIP_Tls13SVGenerateClientHandshakeTrafficKeySub(uint32_t *InData_Cmd, uint32_t *InData_Handshake_SecretKeyIndex, uint32_t *InData_MsgHash, uint32_t *OutData_ClientWriteKeyIndex, uint32_t *OutData_ClientFinishedKeyIndex)
{
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX72M_RX72N_RX66N_func100(change_endian_long(0xdee22c7bu), change_endian_long(0x6e0c43efu), change_endian_long(0xf6f18a2fu), change_endian_long(0x6cf81e41u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX72M_RX72N_RX66N_func102(change_endian_long(0x2ae86b99u), change_endian_long(0xd792880fu), change_endian_long(0x531a57f1u), change_endian_long(0x8cf52a2au));
    ...
    {
        RX72M_RX72N_RX66N_func100(change_endian_long(0x29ecac6au), change_endian_long(0x10b82680u), change_endian_long(0x0430f114u), change_endian_long(0xffbbe9a7u));
        ...
        TSIP.REG_100H.WORD = change_endian_long(0x091b4e6eu);
        TSIP.REG_ECH.WORD = 0x00000bffu;
        TSIP.REG_D0H.WORD = 0x00000100u;
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0x205b264eu), change_endian_long(0x6ae4aeb5u), change_endian_long(0xc907a282u), change_endian_long(0x6290b350u));
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0x774731ebu), change_endian_long(0xa04515a0u), change_endian_long(0x89354176u), change_endian_long(0x9066fdc9u));
        TSIP.REG_C4H.WORD = 0x400c0b0cu;
        /* WAIT_LOOP */
        while (1u != TSIP.REG_104H.BIT.B31)
        {
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0x3c37849du), change_endian_long(0xdc7a1d3du), change_endian_long(0x43fea2e1u), change_endian_long(0xa4cb0841u));
        TSIP.REG_E0H.WORD = 0x81040280u;
        TSIP.REG_04H.WORD = 0x00000612u;
        /* WAIT_LOOP */
        while (1u != TSIP.REG_04H.BIT.B30)
        ...
        RX72M_RX72N_RX66N_func102(change_endian_long(0x2b1cc69eu), change_endian_long(0x1424de04u), change_endian_long(0x89cabc77u), change_endian_long(0x185d8ff2u));
        TSIP.REG_1BCH.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_p3c_r1.prc
 *********************************************************************************************************************/
