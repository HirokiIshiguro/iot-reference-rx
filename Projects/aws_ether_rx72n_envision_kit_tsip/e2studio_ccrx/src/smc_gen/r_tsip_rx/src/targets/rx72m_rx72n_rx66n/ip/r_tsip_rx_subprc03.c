...
/***********************************************************************************************************************
* Function Name: R_TSIP_TlsRootCertificateVerificationSubSub
*******************************************************************************************************************/ /**
* @details       RX72M TSIP RSA2048 PSS Signature Verification subprocedure 03
* @note          None
*/
void R_TSIP_TlsRootCertificateVerificationSubSub(void)
{
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0xab6d7c15u), change_endian_long(0x9dbd9b6cu), change_endian_long(0x3dd6d523u), change_endian_long(0x3bba9028u));
    ...
    TSIP.REG_ECH.WORD = 0x00002862u;
    RX72M_RX72N_RX66N_func100(change_endian_long(0xd6f15312u), change_endian_long(0xfb66fcd3u), change_endian_long(0x41bb5c5bu), change_endian_long(0x6edfffa2u));
    TSIP.REG_E0H.WORD = 0x81010020u;
    ...
    for (iLoop = 0; iLoop < S_RAM[0]; iLoop = iLoop + 1)
    {
        ...
        RX72M_RX72N_RX66N_func101(change_endian_long(0xc7303bbau), change_endian_long(0x864c1d93u), change_endian_long(0x471ea230u), change_endian_long(0xf8340771u));
    }
    ...
    TSIP.REG_ECH.WORD = 0x0000b460u;
    TSIP.REG_ECH.WORD = 0x80000000u;
    RX72M_RX72N_RX66N_func100(change_endian_long(0x34cd76dcu), change_endian_long(0xfb870140u), change_endian_long(0xcc744133u), change_endian_long(0x6d075cd9u));
    TSIP.REG_E0H.WORD = 0x81010020u;
    TSIP.REG_04H.WORD = 0x00000707u;
    /* WAIT_LOOP */
    while (1u != TSIP.REG_04H.BIT.B30)
    ...
    for (iLoop = 0; iLoop < S_RAM[0]; iLoop = iLoop + 1)
    {
        ...
        RX72M_RX72N_RX66N_func101(change_endian_long(0x3cd5da22u), change_endian_long(0xb01c77eau), change_endian_long(0x1f0846aeu), change_endian_long(0x36481062u));
    }
    TSIP.REG_ECH.WORD = 0x00007c01u;
    TSIP.REG_1CH.WORD = 0x00602000u;
    TSIP.REG_F8H.WORD = 0x00000040u;
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_subprc03.prc
 *********************************************************************************************************************/
