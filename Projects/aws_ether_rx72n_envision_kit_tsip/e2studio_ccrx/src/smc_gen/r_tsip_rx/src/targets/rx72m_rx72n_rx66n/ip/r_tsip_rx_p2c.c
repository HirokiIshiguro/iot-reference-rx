...
/***********************************************************************************************************************
* Function Name: R_TSIP_UpdateEccPublicKeyIndexSub
*******************************************************************************************************************/ /**
* @details       RX72M Update P-192/224/256 ECC Public key
* @param[in]     InData_Cmd
* @param[in]     InData_IV
...
* @note          None
*/
e_tsip_err_t R_TSIP_UpdateEccPublicKeyIndexSub(uint32_t *InData_Cmd, uint32_t *InData_IV, uint32_t *InData_InstData, uint32_t *OutData_KeyIndex)
{
    ...
    TSIP.REG_84H.WORD = 0x00002c01u;
    TSIP.REG_108H.WORD = 0x00000000u;
    RX72M_RX72N_RX66N_func100(change_endian_long(0xfaf0e69au), change_endian_long(0x9602dc33u), change_endian_long(0x1a43613du), change_endian_long(0x6860b7dau));
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0xc9f21ed4u), change_endian_long(0x8801d0ccu), change_endian_long(0x3975a1dbu), change_endian_long(0x75f66c80u));
    TSIP.REG_104H.WORD = 0x00000361u;
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0x12c9710fu), change_endian_long(0xbf4974b8u), change_endian_long(0x57777516u), change_endian_long(0x1ab1817cu));
    TSIP.REG_104H.WORD = 0x00000361u;
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0x17583da4u), change_endian_long(0x70669a4du), change_endian_long(0x444eb402u), change_endian_long(0x02b45f9eu));
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0x9f88c6e1u), change_endian_long(0x46e58a90u), change_endian_long(0x2b8dcbdbu), change_endian_long(0x4fe42074u));
    TSIP.REG_104H.WORD = 0x00000052u;
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0x865ef0b4u), change_endian_long(0x9b1dafb0u), change_endian_long(0x665dad5eu), change_endian_long(0x8e6ecccdu));
    TSIP.REG_104H.WORD = 0x00000052u;
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX72M_RX72N_RX66N_func100(change_endian_long(0xe572ba06u), change_endian_long(0x6f3f587au), change_endian_long(0x79406f97u), change_endian_long(0xa37e973du));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX72M_RX72N_RX66N_func102(change_endian_long(0xac41a4cfu), change_endian_long(0x1f4f3349u), change_endian_long(0x6fda3423u), change_endian_long(0x3622db57u));
    ...
    {
        RX72M_RX72N_RX66N_func100(change_endian_long(0x945cbde9u), change_endian_long(0x62896d87u), change_endian_long(0x4042e059u), change_endian_long(0xd3b0ade0u));
        TSIP.REG_E0H.WORD = 0x81040000u;
        ...
        RX72M_RX72N_RX66N_func102(change_endian_long(0x74ac418au), change_endian_long(0x5588aaefu), change_endian_long(0xe629f44du), change_endian_long(0xe876b9a2u));
        TSIP.REG_1B4H.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_p2c_r1.prc
 *********************************************************************************************************************/
