...
*******************************************************************************************************************/ /**
* @details       RX72M TLS1.3 Client Handshake Traffic Key Generation
* @param[in]     InData_Cmd
...
e_tsip_err_t R_TSIP_Tls13GenerateClientHandshakeTrafficKeySub(uint32_t *InData_Cmd, uint32_t *InData_Handshake_SecretKeyIndex, uint32_t *InData_MsgHash, uint32_t *OutData_ClientWriteKeyIndex, uint32_t *OutData_ClientFinishedKeyIndex)
{
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX72M_RX72N_RX66N_func100(change_endian_long(0xc12aeb8du), change_endian_long(0x0fafed6fu), change_endian_long(0x1967ec3eu), change_endian_long(0xdeb04f97u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX72M_RX72N_RX66N_func102(change_endian_long(0x41e0bb19u), change_endian_long(0x38a069c2u), change_endian_long(0xc5ca95adu), change_endian_long(0x2fdbcab5u));
    ...
    {
        RX72M_RX72N_RX66N_func100(change_endian_long(0x6be990fcu), change_endian_long(0x6ecf0109u), change_endian_long(0x923f784du), change_endian_long(0x247050c3u));
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0xc71b4129u), change_endian_long(0x9e01f6e6u), change_endian_long(0x9b8ca718u), change_endian_long(0x35818451u));
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0xfcb4231au), change_endian_long(0x46234d6fu), change_endian_long(0xf17de50au), change_endian_long(0x36083dc2u));
        TSIP.REG_C4H.WORD = 0x400c0b0cu;
        /* WAIT_LOOP */
        while (1u != TSIP.REG_104H.BIT.B31)
        {
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0xc70d2238u), change_endian_long(0xa0b718ccu), change_endian_long(0xacf6b6d7u), change_endian_long(0x6c405bacu));
        TSIP.REG_E0H.WORD = 0x81040280u;
        TSIP.REG_04H.WORD = 0x00000612u;
        /* WAIT_LOOP */
        while (1u != TSIP.REG_04H.BIT.B30)
        ...
        RX72M_RX72N_RX66N_func102(change_endian_long(0xe2ca9e7au), change_endian_long(0x8d4a6bc3u), change_endian_long(0x7c4ca5d4u), change_endian_long(0x061d0ec9u));
        TSIP.REG_1BCH.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_pcb_r1.prc
 *********************************************************************************************************************/
