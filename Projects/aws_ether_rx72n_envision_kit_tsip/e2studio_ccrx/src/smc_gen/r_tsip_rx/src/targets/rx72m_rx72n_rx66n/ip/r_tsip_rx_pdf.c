...
/***********************************************************************************************************************
* Function Name: R_TSIP_GenerateTlsRsaInstallDataSub
*******************************************************************************************************************/ /**
* @details       RX72M TLS RSA Key Install
...
* @note          None
*/
e_tsip_err_t R_TSIP_GenerateTlsRsaInstallDataSub(uint32_t *InData_SharedKeyIndex, uint32_t *InData_SessionKey, uint32_t *InData_IV, uint32_t *InData_InstData, uint32_t *OutData_InstData)
{
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0x25412685u), change_endian_long(0x2c6a1be8u), change_endian_long(0xf1bcbd8au), change_endian_long(0xd9dc53deu));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX72M_RX72N_RX66N_func102(change_endian_long(0xa891a4f4u), change_endian_long(0xbcc971f5u), change_endian_long(0xa8cfa978u), change_endian_long(0xca7756bfu));
    ...
    {
        RX72M_RX72N_RX66N_func100(change_endian_long(0xf28171a6u), change_endian_long(0xeeefeb84u), change_endian_long(0x99040fa4u), change_endian_long(0xbbb454cfu));
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0xedfaaeb6u), change_endian_long(0x005e4bf1u), change_endian_long(0x5d0bef79u), change_endian_long(0x2cc567f8u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0xaa482937u), change_endian_long(0xf439415cu), change_endian_long(0xe4b2401eu), change_endian_long(0x4a4a1786u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0xc093af9fu), change_endian_long(0x818b1645u), change_endian_long(0x20da2ff5u), change_endian_long(0x991ee967u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0x6de1e94fu), change_endian_long(0x7d4d1b59u), change_endian_long(0x76b88363u), change_endian_long(0x65d5913bu));
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0xeeb4dd20u), change_endian_long(0x46cb6913u), change_endian_long(0x130ec013u), change_endian_long(0x24857fa5u));
        TSIP.REG_00H.WORD = 0x00012303u;
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0xd0765c0eu), change_endian_long(0xdcc846b5u), change_endian_long(0x771ccb5bu), change_endian_long(0x6664c38cu));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        OutData_InstData[4+jLoop + 2] = TSIP.REG_100H.WORD;
        OutData_InstData[4+jLoop + 3] = TSIP.REG_100H.WORD;
        RX72M_RX72N_RX66N_func100(change_endian_long(0xa05eb5adu), change_endian_long(0x694daa4du), change_endian_long(0xc623db99u), change_endian_long(0xa0c22bedu));
        ...
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            RX72M_RX72N_RX66N_func102(change_endian_long(0x7e6898c6u), change_endian_long(0x643ea327u), change_endian_long(0x9fdf5c3fu), change_endian_long(0x89aec227u));
            TSIP.REG_1BCH.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
        ...
        {
            RX72M_RX72N_RX66N_func100(change_endian_long(0x42c54f91u), change_endian_long(0x31fe9efau), change_endian_long(0xa1fe682du), change_endian_long(0xed143ae0u));
            TSIP.REG_104H.WORD = 0x00000052u;
            ...
            RX72M_RX72N_RX66N_func102(change_endian_long(0xbe5026a1u), change_endian_long(0x3004f0f1u), change_endian_long(0x67778319u), change_endian_long(0x25bfc861u));
            TSIP.REG_1BCH.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_pdf.prc
 *********************************************************************************************************************/
