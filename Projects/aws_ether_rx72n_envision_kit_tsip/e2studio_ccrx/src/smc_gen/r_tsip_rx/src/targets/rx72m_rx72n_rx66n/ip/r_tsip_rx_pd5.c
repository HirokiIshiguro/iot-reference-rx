...
/***********************************************************************************************************************
* Function Name: R_TSIP_Md5GenerateMessageDigestSub
*******************************************************************************************************************/ /**
* @details       RX72M MD5 Message Digest Generation
* @param[in]     InData_MD5InitVal
...
* @note          None
*/
e_tsip_err_t R_TSIP_Md5GenerateMessageDigestSub(uint32_t *InData_MD5InitVal, uint32_t *InData_PaddedMsg, uint32_t MAX_CNT, uint32_t *OutData_MsgDigest)
{
    ...
    TSIP.REG_84H.WORD = 0x0000d501u;
    TSIP.REG_108H.WORD = 0x00000000u;
    RX72M_RX72N_RX66N_func100(change_endian_long(0x82854013u), change_endian_long(0x653ba7b3u), change_endian_long(0x5907a388u), change_endian_long(0x0376e2e8u));
    ...
    TSIP.REG_100H.WORD = InData_MD5InitVal[0];
    TSIP.REG_100H.WORD = InData_MD5InitVal[1];
    TSIP.REG_100H.WORD = InData_MD5InitVal[2];
    TSIP.REG_100H.WORD = InData_MD5InitVal[3];
    ...
    RX72M_RX72N_RX66N_func102(change_endian_long(0x542e5c68u), change_endian_long(0x99e4281eu), change_endian_long(0xe97d491eu), change_endian_long(0xfd8c1de3u));
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_pd5.prc
 *********************************************************************************************************************/
#endif /* #if TSIP_MD5 == 1 */
