...
*******************************************************************************************************************/ /**
* @details       RX72M AES-128 CMAC generation/verification Final
* @param[in]     InData_Cmd
...
e_tsip_err_t R_TSIP_Aes128CmacFinalSub(uint32_t *InData_Cmd, uint32_t *InData_Text, uint32_t *InData_DataT, uint32_t *InData_DataTLen, uint32_t *OutData_DataT)
{
    ...
    (void)KEY_ADR;
    (void)OFS_ADR;
    RX72M_RX72N_RX66N_func100(change_endian_long(0x27c20fd1u), change_endian_long(0x0614f11du), change_endian_long(0x30da2712u), change_endian_long(0x9f189417u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX72M_RX72N_RX66N_func102(change_endian_long(0x41690914u), change_endian_long(0x11dca393u), change_endian_long(0x1e712ecbu), change_endian_long(0xfcf98321u));
    ...
    else
    {
        if ((InData_Cmd[0] == 0x00000000) || (InData_Cmd[0] == 0x00000002))
        {
            ...
            RX72M_RX72N_RX66N_func101(change_endian_long(0x3f16bbdfu), change_endian_long(0x256a3d74u), change_endian_long(0xc66e0db8u), change_endian_long(0x68025312u));
        }
        else
        {
            TSIP.REG_104H.WORD = 0x00000051u;
            ...
            TSIP.REG_100H.WORD = change_endian_long(0x00000000u);
            RX72M_RX72N_RX66N_func101(change_endian_long(0xd19f401eu), change_endian_long(0x6bef2ca9u), change_endian_long(0x4784713cu), change_endian_long(0x86f74b0fu));
        }
        ...
        {
            RX72M_RX72N_RX66N_func100(change_endian_long(0xf84db8cfu), change_endian_long(0x64f53fd2u), change_endian_long(0x54402ac1u), change_endian_long(0xcbf7296eu));
            ...
            RX72M_RX72N_RX66N_func102(change_endian_long(0x57c75720u), change_endian_long(0x05b6bb3eu), change_endian_long(0xc87206a5u), change_endian_long(0x34daea32u));
            TSIP.REG_1BCH.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
        ...
        else
        {
            ...
            TSIP.REG_E0H.WORD = 0x00000080u;
            TSIP.REG_1CH.WORD = 0x00260000u;
            RX72M_RX72N_RX66N_func100(change_endian_long(0x66d542ddu), change_endian_long(0xbc258c9au), change_endian_long(0x5902da89u), change_endian_long(0x50107a35u));
            TSIP.REG_1CH.WORD = 0x00400000u;
            TSIP.REG_1D0H.WORD = 0x00000000u;
            if (1u == (TSIP.REG_1CH.BIT.B22))
            {
                RX72M_RX72N_RX66N_func102(change_endian_long(0xe8813186u), change_endian_long(0xb153d19du), change_endian_long(0x71a6b020u), change_endian_long(0x08613e89u));
                TSIP.REG_1BCH.WORD = 0x00000040u;
                /* WAIT_LOOP */
                while (0u != TSIP.REG_18H.BIT.B12)
                {
            ...
            else
            {
                ...
                RX72M_RX72N_RX66N_func100(change_endian_long(0x09ebfedfu), change_endian_long(0x3fea59acu), change_endian_long(0x50568e0du), change_endian_long(0x943c638du));
                TSIP.REG_1CH.WORD = 0x00400000u;
                TSIP.REG_1D0H.WORD = 0x00000000u;
                if (1u == (TSIP.REG_1CH.BIT.B22))
                {
                    RX72M_RX72N_RX66N_func102(change_endian_long(0xc1b39d6cu), change_endian_long(0xe086ef85u), change_endian_long(0x87ad7c99u), change_endian_long(0xa739c741u));
                    TSIP.REG_1BCH.WORD = 0x00000040u;
                    /* WAIT_LOOP */
                    while (0u != TSIP.REG_18H.BIT.B12)
                    {
                ...
                {
                    RX72M_RX72N_RX66N_func102(change_endian_long(0xf0d11587u), change_endian_long(0xa4554b6eu), change_endian_long(0xc3eb160bu), change_endian_long(0xd23b5cd7u));
                    TSIP.REG_1BCH.WORD = 0x00000040u;
                    /* WAIT_LOOP */
                    while (0u != TSIP.REG_18H.BIT.B12)
                    {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_p41f.prc
 *********************************************************************************************************************/
