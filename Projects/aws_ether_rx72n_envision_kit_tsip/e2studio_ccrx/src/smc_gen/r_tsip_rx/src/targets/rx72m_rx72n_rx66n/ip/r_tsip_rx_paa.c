...
*******************************************************************************************************************/ /**
* @details       RX72M RSA-3072 Public Key Install
...
e_tsip_err_t R_TSIP_GenerateRsa3072PublicKeyIndexSub(uint32_t *InData_SharedKeyIndex, uint32_t *InData_SessionKey, uint32_t *InData_IV, uint32_t *InData_InstData, uint32_t *OutData_KeyIndex)
{
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0xb2870d98u), change_endian_long(0x630ffa7au), change_endian_long(0x97969fd8u), change_endian_long(0x433e1b2cu));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX72M_RX72N_RX66N_func102(change_endian_long(0x53912027u), change_endian_long(0xf4b557ddu), change_endian_long(0xc355f240u), change_endian_long(0xadfcfb40u));
    ...
    {
        RX72M_RX72N_RX66N_func100(change_endian_long(0xb05a5d33u), change_endian_long(0xc5b94433u), change_endian_long(0xe8b42463u), change_endian_long(0xdd800b15u));
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0xbe28c03du), change_endian_long(0xd6169b4du), change_endian_long(0xef606e88u), change_endian_long(0x739bb5a5u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0x0144b6a2u), change_endian_long(0xa9d0c411u), change_endian_long(0x3ad071b0u), change_endian_long(0x04ebd7a2u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0x7d0f97feu), change_endian_long(0x817eaae4u), change_endian_long(0xc7e3d2a0u), change_endian_long(0x908f06eeu));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0xb46e5eedu), change_endian_long(0x3c1b204bu), change_endian_long(0x6b8020b8u), change_endian_long(0xca66a285u));
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0x94bbbbc4u), change_endian_long(0xf547a786u), change_endian_long(0x6f1261bcu), change_endian_long(0xac24ef4du));
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0x144a97cdu), change_endian_long(0x45c1562du), change_endian_long(0x710e3c7bu), change_endian_long(0x46d40127u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0xb45e6351u), change_endian_long(0xf2bc08fdu), change_endian_long(0xde2f2c64u), change_endian_long(0x45ea5586u));
        TSIP.REG_104H.WORD = 0x00000052u;
        ...
        TSIP.REG_1CH.WORD = 0x00001800u;
        RX72M_RX72N_RX66N_func100(change_endian_long(0x33dfe5c6u), change_endian_long(0x346a5ba3u), change_endian_long(0xaadf4cceu), change_endian_long(0x9d94f890u));
        TSIP.REG_1CH.WORD = 0x00400000u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            RX72M_RX72N_RX66N_func102(change_endian_long(0x1f0c79d0u), change_endian_long(0xdcf01b11u), change_endian_long(0x038c6a46u), change_endian_long(0xa6f69b4cu));
            TSIP.REG_1B4H.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
        ...
        {
            RX72M_RX72N_RX66N_func100(change_endian_long(0xb0f14511u), change_endian_long(0xb5d2b253u), change_endian_long(0xd582b654u), change_endian_long(0xfdb2a9ddu));
            TSIP.REG_E0H.WORD = 0x81040000u;
            ...
            RX72M_RX72N_RX66N_func102(change_endian_long(0x0e5d87aeu), change_endian_long(0x655ca6c5u), change_endian_long(0x0b33407cu), change_endian_long(0xc1d14c61u));
            TSIP.REG_1B4H.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_paa.prc
 *********************************************************************************************************************/
