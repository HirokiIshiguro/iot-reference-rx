...
/***********************************************************************************************************************
* Function Name: R_TSIP_GenerateFirmwareMacInitSub
*******************************************************************************************************************/ /**
* @details       RX72M F/W update Init
...
* @note          None
*/
e_tsip_err_t R_TSIP_GenerateFirmwareMacInitSub(uint32_t *InData_KeyIndex, uint32_t *InData_SessionKey, uint32_t *InData_IV)
{
    ...
    else
    {
        ...
        RX72M_RX72N_RX66N_func101(change_endian_long(0xb9795ee9u), change_endian_long(0x4469b826u), change_endian_long(0x2996f25bu), change_endian_long(0x1fce96a7u));
        return TSIP_SUCCESS;
    }
}
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_p23i.prc
 *********************************************************************************************************************/
