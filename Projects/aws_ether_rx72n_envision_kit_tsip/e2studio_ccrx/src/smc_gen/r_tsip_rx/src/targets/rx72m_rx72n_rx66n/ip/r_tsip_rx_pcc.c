...
*******************************************************************************************************************/ /**
* @details       RX72M TLS1.3 Master Secret Generation
* @param[in]     InData_Cmd
...
e_tsip_err_t R_TSIP_Tls13GenerateMasterSecretSub(uint32_t *InData_Cmd, uint32_t *InData_Handshake_SecretKeyIndex, uint32_t *InData_VerifyDataIndex, uint32_t *OutData_Handle, uint32_t *OutData_Master_SecretKeyIndex)
{
    ...
    {
        RX72M_RX72N_RX66N_func102(change_endian_long(0x5b99dc5du), change_endian_long(0x46cdd0b4u), change_endian_long(0x84c0d89fu), change_endian_long(0xdc357acfu));
    ...
    else
    {
        ...
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            RX72M_RX72N_RX66N_func102(change_endian_long(0xf44427bau), change_endian_long(0x16cd09c4u), change_endian_long(0x4693f08du), change_endian_long(0x1c5208d6u));
            TSIP.REG_1BCH.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
        ...
        {
            RX72M_RX72N_RX66N_func100(change_endian_long(0x3a38cb67u), change_endian_long(0x17341dc7u), change_endian_long(0x2ee9e348u), change_endian_long(0x1f80c173u));
            ...
            RX72M_RX72N_RX66N_func100(change_endian_long(0x08ec5a9du), change_endian_long(0x4f5f0f8eu), change_endian_long(0x20996d50u), change_endian_long(0x3bc7f9e2u));
            ...
            RX72M_RX72N_RX66N_func102(change_endian_long(0x97576debu), change_endian_long(0x77e9271cu), change_endian_long(0xd5f373d9u), change_endian_long(0x6c87d7b2u));
            TSIP.REG_1BCH.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_pcc_r1.prc
 *********************************************************************************************************************/
