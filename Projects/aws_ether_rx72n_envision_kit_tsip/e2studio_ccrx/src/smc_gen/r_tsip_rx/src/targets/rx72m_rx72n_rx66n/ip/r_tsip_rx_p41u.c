...
/***********************************************************************************************************************
* Function Name: R_TSIP_Aes128CmacUpdateSub
*******************************************************************************************************************/ /**
* @details       RX72M AES-128 CMAC generation/verification Update
...
void R_TSIP_Aes128CmacUpdateSub(uint32_t *InData_Text, uint32_t MAX_CNT)
{
    ...
    RX72M_RX72N_RX66N_func101(change_endian_long(0x6220bed1u), change_endian_long(0xcd02783au), change_endian_long(0xdbcecf54u), change_endian_long(0x18e6f435u));
}
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_p41u.prc
 *********************************************************************************************************************/
