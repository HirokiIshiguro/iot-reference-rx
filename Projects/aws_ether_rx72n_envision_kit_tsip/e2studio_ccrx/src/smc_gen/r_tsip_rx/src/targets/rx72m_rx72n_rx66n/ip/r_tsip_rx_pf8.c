...
/***********************************************************************************************************************
* Function Name: R_TSIP_GenerateEccP384PrivateKeyIndexSub
*******************************************************************************************************************/ /**
* @details       RX72M Install P-384 ECC Private Key
...
* @note          None
*/
e_tsip_err_t R_TSIP_GenerateEccP384PrivateKeyIndexSub(uint32_t *InData_SharedKeyIndex, uint32_t *InData_SessionKey, uint32_t *InData_IV, uint32_t *InData_InstData, uint32_t *OutData_KeyIndex)
{
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0x0e3aa161u), change_endian_long(0xb9a2f631u), change_endian_long(0x8c9a186du), change_endian_long(0xdd76a95du));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX72M_RX72N_RX66N_func102(change_endian_long(0x8fd4f1f2u), change_endian_long(0xaef56867u), change_endian_long(0x9913d90fu), change_endian_long(0xfa4cf7feu));
    ...
    {
        RX72M_RX72N_RX66N_func100(change_endian_long(0x5f66dae7u), change_endian_long(0xc8957742u), change_endian_long(0x9b648e88u), change_endian_long(0x2bd94ab2u));
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0x8d9c4a45u), change_endian_long(0x119a1c25u), change_endian_long(0x4aaf34a4u), change_endian_long(0x3ac8b094u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0xe5f377f9u), change_endian_long(0xac09caf7u), change_endian_long(0x38bb0594u), change_endian_long(0x60c115f5u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0xda6d03e0u), change_endian_long(0x0499b7f9u), change_endian_long(0x3417ae57u), change_endian_long(0x08fa2b19u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0xd26ceb81u), change_endian_long(0x81bbccd5u), change_endian_long(0x4924882fu), change_endian_long(0x90e2654fu));
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0x921ed61fu), change_endian_long(0x6d1bdc3fu), change_endian_long(0x4e19bd76u), change_endian_long(0xfe96327au));
        TSIP.REG_104H.WORD = 0x00000052u;
        ...
        TSIP.REG_1CH.WORD = 0x00001800u;
        RX72M_RX72N_RX66N_func100(change_endian_long(0x2c0e9f4du), change_endian_long(0x07031eeeu), change_endian_long(0xb50a2017u), change_endian_long(0xba24c575u));
        TSIP.REG_1CH.WORD = 0x00400000u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            RX72M_RX72N_RX66N_func102(change_endian_long(0xf785048au), change_endian_long(0xfb3e6bc2u), change_endian_long(0x5a727100u), change_endian_long(0xfbd1e3beu));
            TSIP.REG_1B4H.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
        ...
        {
            RX72M_RX72N_RX66N_func100(change_endian_long(0x0395c2a9u), change_endian_long(0x8c3254afu), change_endian_long(0x311c96a2u), change_endian_long(0x107594f3u));
            TSIP.REG_E0H.WORD = 0x81040000u;
            ...
            RX72M_RX72N_RX66N_func102(change_endian_long(0xa53a2527u), change_endian_long(0x99254f8cu), change_endian_long(0x4e646e79u), change_endian_long(0x6ecae1a3u));
            TSIP.REG_1B4H.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_pf8.prc
 *********************************************************************************************************************/
