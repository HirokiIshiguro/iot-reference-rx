...
*******************************************************************************************************************/ /**
* @details       RX72M TLS Root Certificate Verification for Server
...
e_tsip_err_t R_TSIP_TlsSVRootCertificateVerificationSub(uint32_t *InData_Sel_PubKeyType, uint32_t *InData_Certificates, uint32_t *InData_CertificatesLength, uint32_t *InData_Signature, uint32_t *InData_CertificatesInfo, uint32_t *OutData_PubKey)
{
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0x24548bcau), change_endian_long(0x5cbc27d1u), change_endian_long(0xc7b54da9u), change_endian_long(0x8bc11f15u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX72M_RX72N_RX66N_func102(change_endian_long(0x2fe13156u), change_endian_long(0xb1946f66u), change_endian_long(0x1d1d8b3fu), change_endian_long(0xd96b848fu));
    ...
    {
        RX72M_RX72N_RX66N_func100(change_endian_long(0xf501cf1du), change_endian_long(0xf0363902u), change_endian_long(0x99d34e56u), change_endian_long(0xfcfc431fu));
        ...
        if (0x00000000u == (TSIP.REG_1CH.WORD & 0xff000000u))
        {
            ...
            TSIP.REG_E0H.WORD = 0x00000080u;
            TSIP.REG_1CH.WORD = 0x00A60000u;
            RX72M_RX72N_RX66N_func101(change_endian_long(0x6ef1cee6u), change_endian_long(0x51143871u), change_endian_long(0x9e3877fcu), change_endian_long(0x4141f178u));
        }
        else
        {
            TSIP.REG_ECH.WORD = 0x3c002af8u;
            ...
            TSIP.REG_E0H.WORD = 0x00000080u;
            TSIP.REG_1CH.WORD = 0x00A60000u;
            RX72M_RX72N_RX66N_func101(change_endian_long(0x049b8cb5u), change_endian_long(0x4931cc54u), change_endian_long(0x3f6b8114u), change_endian_long(0xa49cc390u));
        }
        RX72M_RX72N_RX66N_func100(change_endian_long(0x93d49592u), change_endian_long(0x290fbccdu), change_endian_long(0x230c4995u), change_endian_long(0x04eba66cu));
        TSIP.REG_1CH.WORD = 0x00400000u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            RX72M_RX72N_RX66N_func102(change_endian_long(0x002da1f3u), change_endian_long(0x05bc9356u), change_endian_long(0x518f8ba1u), change_endian_long(0x7e052d94u));
            TSIP.REG_1B8H.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
        ...
        {
            RX72M_RX72N_RX66N_func100(change_endian_long(0xab5cfe80u), change_endian_long(0x71cad3eau), change_endian_long(0x91c63e03u), change_endian_long(0x7e6580e1u));
            ...
            for (iLoop = 0; iLoop < S_RAM[0]; iLoop = iLoop + 4)
            {
                ...
                RX72M_RX72N_RX66N_func101(change_endian_long(0x9c03fe85u), change_endian_long(0x007fabd4u), change_endian_long(0x0a3f9765u), change_endian_long(0x91f0881eu));
            }
            RX72M_RX72N_RX66N_func100(change_endian_long(0xc8be3528u), change_endian_long(0xda66d955u), change_endian_long(0x6b2f9ebcu), change_endian_long(0x4d872121u));
            ...
            if (0x00000000u == (TSIP.REG_1CH.WORD & 0xff000000u))
            {
                RX72M_RX72N_RX66N_func100(change_endian_long(0xe9d83f14u), change_endian_long(0x8d0d7376u), change_endian_long(0xc3b1429cu), change_endian_long(0x055f2c6cu));
                TSIP.REG_28H.WORD = 0x00bf0001u;
                ...
                for ( ; iLoop < S_RAM[0]; iLoop = iLoop + 1)
                {
                    ...
                    for (jLoop = 0; jLoop < 4; jLoop = jLoop + 1)
                    {
                        ...
                        TSIP.REG_E0H.WORD = 0x00000080u;
                        TSIP.REG_1CH.WORD = 0x00260000u;
                        RX72M_RX72N_RX66N_func100(change_endian_long(0xa4557c37u), change_endian_long(0x1207e917u), change_endian_long(0xec2c7ae1u), change_endian_long(0x8d423b2au));
                        TSIP.REG_1CH.WORD = 0x00400000u;
                        TSIP.REG_1D0H.WORD = 0x00000000u;
                        if (1u == (TSIP.REG_1CH.BIT.B22))
                        {
                            ...
                            TSIP.REG_1CH.WORD = 0x00001800u;
                            RX72M_RX72N_RX66N_func101(change_endian_long(0xaa9795d8u), change_endian_long(0xec4e594au), change_endian_long(0xfcdeae40u), change_endian_long(0x7463b9e6u));
                        }
                        TSIP.REG_ECH.WORD = 0x00000863u;
                        ...
                        TSIP.REG_E0H.WORD = 0x00000080u;
                        TSIP.REG_1CH.WORD = 0x00260000u;
                        RX72M_RX72N_RX66N_func100(change_endian_long(0x1e774d48u), change_endian_long(0x5458ff15u), change_endian_long(0x344ccbeeu), change_endian_long(0x8b682984u));
                        TSIP.REG_1CH.WORD = 0x00400000u;
                        TSIP.REG_1D0H.WORD = 0x00000000u;
                        if (1u == (TSIP.REG_1CH.BIT.B22))
                        {
                            ...
                            TSIP.REG_1CH.WORD = 0x00001800u;
                            RX72M_RX72N_RX66N_func101(change_endian_long(0xbdd66751u), change_endian_long(0x95df810bu), change_endian_long(0x3dcdc9e9u), change_endian_long(0x55d2a6bcu));
                        }
                        TSIP.REG_ECH.WORD = 0x00002c40u;
                        RX72M_RX72N_RX66N_func101(change_endian_long(0x454bd624u), change_endian_long(0x23891b10u), change_endian_long(0x115e5c96u), change_endian_long(0x67028940u));
                    }
                    ...
                    RX72M_RX72N_RX66N_func101(change_endian_long(0xee38163au), change_endian_long(0x6ba9cd4du), change_endian_long(0x6e2cbc27u), change_endian_long(0xf550fcaeu));
                }
                TSIP.REG_ECH.WORD = 0x38000805u;
                TSIP.REG_E0H.WORD = 0x00000080u;
                TSIP.REG_1CH.WORD = 0x00260000u;
                TSIP.REG_1CH.WORD = 0x00402000u;
                RX72M_RX72N_RX66N_func101(change_endian_long(0x9f4c78dcu), change_endian_long(0xbc2920acu), change_endian_long(0x0cb50ca0u), change_endian_long(0x45aa881cu));
            }
            else
            {
                RX72M_RX72N_RX66N_func100(change_endian_long(0xaea56a64u), change_endian_long(0x9f73c826u), change_endian_long(0x43d2b3efu), change_endian_long(0xfb944485u));
                ...
                for ( ; iLoop < S_RAM[0]; iLoop = iLoop + 1)
                {
                    ...
                    for (jLoop = 0; jLoop < 4; jLoop = jLoop + 1)
                    {
                        ...
                        TSIP.REG_E0H.WORD = 0x00000080u;
                        TSIP.REG_1CH.WORD = 0x00260000u;
                        RX72M_RX72N_RX66N_func100(change_endian_long(0x71768a90u), change_endian_long(0x3cab39aeu), change_endian_long(0x7f292ef0u), change_endian_long(0x624138e8u));
                        TSIP.REG_1CH.WORD = 0x00400000u;
                        TSIP.REG_1D0H.WORD = 0x00000000u;
                        if (1u == (TSIP.REG_1CH.BIT.B22))
                        {
                            ...
                            TSIP.REG_1CH.WORD = 0x00001800u;
                            RX72M_RX72N_RX66N_func101(change_endian_long(0xe7148d1cu), change_endian_long(0xde86af10u), change_endian_long(0xcb16daf9u), change_endian_long(0x03483f1au));
                        }
                        TSIP.REG_ECH.WORD = 0x00000863u;
                        TSIP.REG_ECH.WORD = 0x3c002857u;
                        TSIP.REG_ECH.WORD = 0x20002c60u;
                        ...
                        TSIP.REG_E0H.WORD = 0x00000080u;
                        TSIP.REG_1CH.WORD = 0x00260000u;
                        RX72M_RX72N_RX66N_func100(change_endian_long(0x96108630u), change_endian_long(0x409b7729u), change_endian_long(0x132d0775u), change_endian_long(0xf5ff26a9u));
                        TSIP.REG_1CH.WORD = 0x00400000u;
                        TSIP.REG_1D0H.WORD = 0x00000000u;
                        if (1u == (TSIP.REG_1CH.BIT.B22))
                        {
                            ...
                            TSIP.REG_1CH.WORD = 0x00001800u;
                            RX72M_RX72N_RX66N_func101(change_endian_long(0x644e1046u), change_endian_long(0xef476136u), change_endian_long(0xd939215cu), change_endian_long(0x51316006u));
                        }
                        TSIP.REG_ECH.WORD = 0x00000863u;
                        TSIP.REG_ECH.WORD = 0x3c0028c2u;
                        TSIP.REG_ECH.WORD = 0x20002c60u;
                        ...
                        TSIP.REG_E0H.WORD = 0x00000080u;
                        TSIP.REG_1CH.WORD = 0x00260000u;
                        RX72M_RX72N_RX66N_func100(change_endian_long(0xa6423636u), change_endian_long(0x526c8e1cu), change_endian_long(0x100cdce3u), change_endian_long(0x6c8e1112u));
                        TSIP.REG_1CH.WORD = 0x00400000u;
                        TSIP.REG_1D0H.WORD = 0x00000000u;
                        if (1u == (TSIP.REG_1CH.BIT.B22))
                        {
                            ...
                            TSIP.REG_1CH.WORD = 0x00001800u;
                            RX72M_RX72N_RX66N_func101(change_endian_long(0x2e0240dau), change_endian_long(0xb7fad194u), change_endian_long(0x34388e39u), change_endian_long(0x16e17e4bu));
                        }
                        TSIP.REG_ECH.WORD = 0x00002c40u;
                        RX72M_RX72N_RX66N_func101(change_endian_long(0xab378eaeu), change_endian_long(0xb3e518b5u), change_endian_long(0x2d33d807u), change_endian_long(0x332408cdu));
                    }
                    TSIP.REG_ECH.WORD = 0x08000c21u;
                    TSIP.REG_E0H.WORD = 0x00000080u;
                    TSIP.REG_1CH.WORD = 0x00260000u;
                    TSIP.REG_1CH.WORD = 0x00402000u;
                    TSIP.REG_ECH.WORD = 0x00002ca0u;
                    RX72M_RX72N_RX66N_func101(change_endian_long(0x53e8bd83u), change_endian_long(0x8a846f35u), change_endian_long(0xd544687du), change_endian_long(0x6ed25e67u));
                }
                TSIP.REG_ECH.WORD = 0x38000805u;
                TSIP.REG_E0H.WORD = 0x00000080u;
                TSIP.REG_1CH.WORD = 0x00260000u;
                TSIP.REG_1CH.WORD = 0x00402000u;
                RX72M_RX72N_RX66N_func101(change_endian_long(0x2a0b877eu), change_endian_long(0x3e50665du), change_endian_long(0x78ef80a0u), change_endian_long(0x3dfa2befu));
            }
            RX72M_RX72N_RX66N_func100(change_endian_long(0x8eb81abbu), change_endian_long(0x32692112u), change_endian_long(0x8d88ec42u), change_endian_long(0x8e1c1d61u));
            TSIP.REG_ECH.WORD = 0x00003416u;
            ...
            for (iLoop = 0; iLoop < S_RAM[0]; iLoop = iLoop + 1)
            {
                ...
                TSIP.REG_ECH.WORD = 0x00002ca0u;
                RX72M_RX72N_RX66N_func101(change_endian_long(0x8c9673c1u), change_endian_long(0x4e1d383du), change_endian_long(0x79afb92fu), change_endian_long(0x41f4cce5u));
            }
            RX72M_RX72N_RX66N_func100(change_endian_long(0x0b82990fu), change_endian_long(0x2bddfcb9u), change_endian_long(0xf3eea131u), change_endian_long(0xae1d8702u));
            ...
            if (0x00000000u == (TSIP.REG_1CH.WORD & 0xff000000u))
            {
                ...
                TSIP.REG_1CH.WORD = 0x00001800u;
                RX72M_RX72N_RX66N_func101(change_endian_long(0xae7d0e80u), change_endian_long(0xd4a75069u), change_endian_long(0x8726eb6bu), change_endian_long(0xb497d2f0u));
            }
            else
            {
                ...
                TSIP.REG_1CH.WORD = 0x00001800u;
                TSIP.REG_28H.WORD = 0x00bf0001u;
                RX72M_RX72N_RX66N_func101(change_endian_long(0x60d45f70u), change_endian_long(0xb1358707u), change_endian_long(0x3dc7b22du), change_endian_long(0xfaf8ad8fu));
            }
            TSIP.REG_2CH.WORD = 0x00000010u;
            ...
            TSIP.REG_1CH.WORD = 0x00001800u;
            RX72M_RX72N_RX66N_func101(change_endian_long(0xcfa3ae8eu), change_endian_long(0xdef8278bu), change_endian_long(0x59937aebu), change_endian_long(0x37842f3bu));
            ...
            TSIP.REG_1CH.WORD = 0x00001800u;
            RX72M_RX72N_RX66N_func100(change_endian_long(0xc4319e0du), change_endian_long(0xc132e8e7u), change_endian_long(0x7a72f19eu), change_endian_long(0xbd3fe375u));
            TSIP.REG_1CH.WORD = 0x00400000u;
            TSIP.REG_1D0H.WORD = 0x00000000u;
            if (1u == (TSIP.REG_1CH.BIT.B22))
            {
                RX72M_RX72N_RX66N_func102(change_endian_long(0xb003f436u), change_endian_long(0x0e9717c8u), change_endian_long(0xf31819b3u), change_endian_long(0x123ff77fu));
                TSIP.REG_1B8H.WORD = 0x00000040u;
                /* WAIT_LOOP */
                while (0u != TSIP.REG_18H.BIT.B12)
                {
            ...
            {
                RX72M_RX72N_RX66N_func100(change_endian_long(0xbc96805cu), change_endian_long(0xb6b24127u), change_endian_long(0x32c131a2u), change_endian_long(0x2095a56eu));
                TSIP.REG_ECH.WORD = 0x00007c0fu;
                TSIP.REG_1CH.WORD = 0x00600000u;
                TSIP.REG_1D0H.WORD = 0x00000000u;
                if (0x00000000u == (TSIP.REG_1CH.WORD & 0xff000000u))
                {
                    RX72M_RX72N_RX66N_func100(change_endian_long(0x31c12461u), change_endian_long(0x72063129u), change_endian_long(0xf569fb45u), change_endian_long(0x70dab727u));
                    TSIP.REG_28H.WORD = 0x00bf0001u;
                    ...
                    TSIP.REG_1CH.WORD = 0x00001800u;
                    RX72M_RX72N_RX66N_func100(change_endian_long(0xa306aeadu), change_endian_long(0x05139610u), change_endian_long(0x3230694fu), change_endian_long(0x6ae9a2c5u));
                    ...
                    RX72M_RX72N_RX66N_func100(change_endian_long(0x921d95e3u), change_endian_long(0x34130467u), change_endian_long(0xa3315484u), change_endian_long(0x2ad23255u));
                    TSIP.REG_00H.WORD = 0x00012303u;
                    ...
                    RX72M_RX72N_RX66N_func100(change_endian_long(0x7773ccedu), change_endian_long(0x0340c62cu), change_endian_long(0xb3db6839u), change_endian_long(0xc57599cdu));
                    ...
                    OutData_PubKey[iLoop + 2] = TSIP.REG_100H.WORD;
                    OutData_PubKey[iLoop + 3] = TSIP.REG_100H.WORD;
                    RX72M_RX72N_RX66N_func100(change_endian_long(0x8ad99659u), change_endian_long(0xfb84bb7du), change_endian_long(0xcbb23438u), change_endian_long(0xcb3b2363u));
                    iLoop = iLoop+4;
                    TSIP.REG_104H.WORD = 0x00000052u;
                    ...
                    OutData_PubKey[iLoop + 2] = TSIP.REG_100H.WORD;
                    OutData_PubKey[iLoop + 3] = TSIP.REG_100H.WORD;
                    RX72M_RX72N_RX66N_func100(change_endian_long(0x76dbbba6u), change_endian_long(0x92fcab96u), change_endian_long(0x4c1acd4bu), change_endian_long(0x06c7d5b4u));
                    TSIP.REG_E0H.WORD = 0x81040000u;
                    ...
                    RX72M_RX72N_RX66N_func102(change_endian_long(0x87b39ae1u), change_endian_long(0x12237ef4u), change_endian_long(0xe2e68c11u), change_endian_long(0xbf0493d3u));
                    TSIP.REG_1B8H.WORD = 0x00000040u;
                    /* WAIT_LOOP */
                    while (0u != TSIP.REG_18H.BIT.B12)
                    {
                ...
                else
                {
                    ...
                    RX72M_RX72N_RX66N_func100(change_endian_long(0xd1ab188eu), change_endian_long(0xf3f0f192u), change_endian_long(0x16872426u), change_endian_long(0xdf8d51b2u));
                    TSIP.REG_1CH.WORD = 0x00400000u;
                    TSIP.REG_1D0H.WORD = 0x00000000u;
                    if (1u == (TSIP.REG_1CH.BIT.B22))
                    {
                        RX72M_RX72N_RX66N_func102(change_endian_long(0xfb944ba5u), change_endian_long(0x281bc353u), change_endian_long(0x2807559fu), change_endian_long(0x0a8190a5u));
                        TSIP.REG_1B8H.WORD = 0x00000040u;
                        /* WAIT_LOOP */
                        while (0u != TSIP.REG_18H.BIT.B12)
                        {
                    ...
                    {
                        RX72M_RX72N_RX66N_func100(change_endian_long(0x14a68ca5u), change_endian_long(0x2a3d42a0u), change_endian_long(0xec8cc6d5u), change_endian_long(0xe036c403u));
                        ...
                        TSIP.REG_1CH.WORD = 0x00001800u;
                        RX72M_RX72N_RX66N_func100(change_endian_long(0xe9ad8a02u), change_endian_long(0xd77e22ccu), change_endian_long(0x6e1f9f38u), change_endian_long(0xafef5a4fu));
                        TSIP.REG_C4H.WORD = 0x000c2b0du;
                        TSIP.REG_E0H.WORD = 0x81040000u;
                        TSIP.REG_00H.WORD = 0x00002813u;
                        /* WAIT_LOOP */
                        ...
                        TSIP.REG_1CH.WORD = 0x00001800u;
                        RX72M_RX72N_RX66N_func100(change_endian_long(0xb22cd828u), change_endian_long(0x6b607ba0u), change_endian_long(0x04a36cf6u), change_endian_long(0x38f5355bu));
                        TSIP.REG_104H.WORD = 0x00000052u;
                        TSIP.REG_C4H.WORD = 0x00000c84u;
                        /* WAIT_LOOP */
                        while (1u != TSIP.REG_104H.BIT.B31)
                        ...
                        OutData_PubKey[iLoop + 2] = TSIP.REG_100H.WORD;
                        OutData_PubKey[iLoop + 3] = TSIP.REG_100H.WORD;
                        RX72M_RX72N_RX66N_func100(change_endian_long(0x857c3d09u), change_endian_long(0x52166667u), change_endian_long(0xa8421ce2u), change_endian_long(0xa2f8e777u));
                        TSIP.REG_E0H.WORD = 0x81040000u;
                        TSIP.REG_04H.WORD = 0x00000612u;
                        /* WAIT_LOOP */
                        while (1u != TSIP.REG_04H.BIT.B30)
                        ...
                        OutData_PubKey[3] = TSIP.REG_100H.WORD;
                        RX72M_RX72N_RX66N_func102(change_endian_long(0x8d1cb388u), change_endian_long(0xa71e7ac2u), change_endian_long(0x71a7716bu), change_endian_long(0xf5094bfbu));
                        TSIP.REG_1B8H.WORD = 0x00000040u;
                        /* WAIT_LOOP */
                        while (0u != TSIP.REG_18H.BIT.B12)
                        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_pc0.prc
 *********************************************************************************************************************/
