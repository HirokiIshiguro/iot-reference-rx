...
/***********************************************************************************************************************
* Function Name: RX72M_RX72N_RX66N_func015
*******************************************************************************************************************/ /**
* @details       RX72M func015
* @note          None
*/
void RX72M_RX72N_RX66N_func015(void)
{
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0x07fb8633u), change_endian_long(0x104171d5u), change_endian_long(0x07271c18u), change_endian_long(0x82917149u));
    ...
    TSIP.REG_ECH.WORD = 0x00002862u;
    RX72M_RX72N_RX66N_func100(change_endian_long(0x15cef3b1u), change_endian_long(0x4f1c8108u), change_endian_long(0xf8cbf75bu), change_endian_long(0x47aabaf1u));
    TSIP.REG_E0H.WORD = 0x81010020u;
    ...
    for (iLoop = 0; iLoop < S_RAM[0]; iLoop = iLoop + 1)
    {
        ...
        RX72M_RX72N_RX66N_func101(change_endian_long(0x5430a5ecu), change_endian_long(0x268bf7ffu), change_endian_long(0x75c884c6u), change_endian_long(0x540b3646u));
    }
    ...
    TSIP.REG_ECH.WORD = 0x0000b460u;
    TSIP.REG_ECH.WORD = 0x80000000u;
    RX72M_RX72N_RX66N_func100(change_endian_long(0xef481a3fu), change_endian_long(0x2af5d26du), change_endian_long(0xcd62f585u), change_endian_long(0x7ffd9d0cu));
    TSIP.REG_E0H.WORD = 0x81010020u;
    TSIP.REG_04H.WORD = 0x00000707u;
    /* WAIT_LOOP */
    while (1u != TSIP.REG_04H.BIT.B30)
    ...
    for (iLoop = 0; iLoop < S_RAM[0]; iLoop = iLoop + 1)
    {
        ...
        RX72M_RX72N_RX66N_func101(change_endian_long(0x6c6405bfu), change_endian_long(0x04cddfaau), change_endian_long(0x0b50ca2eu), change_endian_long(0x828eb4afu));
    }
    TSIP.REG_ECH.WORD = 0x00007c01u;
    TSIP.REG_1CH.WORD = 0x00602000u;
    TSIP.REG_F8H.WORD = 0x00000040u;
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_func015.prc
 *********************************************************************************************************************/
