...
/***********************************************************************************************************************
* Function Name: R_TSIP_Aes256CmacUpdateSub
*******************************************************************************************************************/ /**
* @details       RX72M AES-256 CMAC generation/verification Update
...
void R_TSIP_Aes256CmacUpdateSub(uint32_t *InData_Text, uint32_t MAX_CNT)
{
    ...
    RX72M_RX72N_RX66N_func101(change_endian_long(0x3b2810f1u), change_endian_long(0xb041ebf5u), change_endian_long(0xd2ce8153u), change_endian_long(0x266ab214u));
}
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_p44u.prc
 *********************************************************************************************************************/
