...
/***********************************************************************************************************************
* Function Name: R_TSIP_Aes128CcmDecryptUpdateSub
*******************************************************************************************************************/ /**
* @details       RX72M AES-128 Decryption and MAC verification with CCM Mode Update
...
void R_TSIP_Aes128CcmDecryptUpdateSub(uint32_t *InData_Text, uint32_t *OutData_Text, uint32_t MAX_CNT)
{
    ...
    (void)KEY_ADR;
    (void)OFS_ADR;
    RX72M_RX72N_RX66N_func100(change_endian_long(0x1f1966c0u), change_endian_long(0x05740cfbu), change_endian_long(0x2ea6baa0u), change_endian_long(0x4a5300bcu));
    TSIP.REG_104H.WORD = 0x000000b1u;
    TSIP.REG_A4H.WORD = 0x00f007b6u;
    ...
    RX72M_RX72N_RX66N_func207();//DisableINTEGRATE_WRRDYBandINTEGRATE_RDRDYBinthisfunction.
    RX72M_RX72N_RX66N_func101(change_endian_long(0xa77b957fu), change_endian_long(0x0dc1d4fcu), change_endian_long(0xc2f74aaau), change_endian_long(0xc32f4547u));
}
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_p98u_r1.prc
 *********************************************************************************************************************/
