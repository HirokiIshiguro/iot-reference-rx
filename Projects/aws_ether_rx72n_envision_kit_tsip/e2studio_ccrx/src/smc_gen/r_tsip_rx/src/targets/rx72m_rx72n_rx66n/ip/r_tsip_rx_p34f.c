...
*******************************************************************************************************************/ /**
* @details       RX72M AES-256 Encryption with GCM Mode Final
...
e_tsip_err_t R_TSIP_Aes256GcmEncryptFinalSub(uint32_t *InData_Text, uint32_t *InData_DataALen, uint32_t *InData_TextLen, uint32_t *OutData_Text, uint32_t *OutData_DataT)
{
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0xc5350d20u), change_endian_long(0xde69af47u), change_endian_long(0xed4373adu), change_endian_long(0x8b89521au));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX72M_RX72N_RX66N_func102(change_endian_long(0x0156463bu), change_endian_long(0xdecf9cf0u), change_endian_long(0x0769142bu), change_endian_long(0x935f7fd1u));
    ...
    else
    {
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0xb3e02212u), change_endian_long(0xa4a93437u), change_endian_long(0x6e3aa274u), change_endian_long(0x9d90a6ffu));
        TSIP.REG_1CH.WORD = 0x00400000u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            ...
            RX72M_RX72N_RX66N_func100(change_endian_long(0xd1ebdd3du), change_endian_long(0xf63358a6u), change_endian_long(0xea4dbabdu), change_endian_long(0xaf92e5cdu));
            ...
            RX72M_RX72N_RX66N_func101(change_endian_long(0x3346727au), change_endian_long(0x0f78de94u), change_endian_long(0xbceeecceu), change_endian_long(0x44b53363u));
        }
        ...
        TSIP.REG_1CH.WORD = 0x00001800u;
        RX72M_RX72N_RX66N_func100(change_endian_long(0xdd8d42d4u), change_endian_long(0xa461549cu), change_endian_long(0xd9582264u), change_endian_long(0x4a11896fu));
        TSIP.REG_B0H.WORD = 0x40000020u;
        TSIP.REG_A4H.WORD = 0x000087b5u;
        ...
        RX72M_RX72N_RX66N_func102(change_endian_long(0x4c1db1ebu), change_endian_long(0x214b034bu), change_endian_long(0x6dd41903u), change_endian_long(0xf8ec2081u));
        TSIP.REG_1BCH.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_p34f.prc
 *********************************************************************************************************************/
