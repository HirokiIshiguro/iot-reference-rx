...
/***********************************************************************************************************************
* Function Name: RX72M_RX72N_RX66N_func060
*******************************************************************************************************************/ /**
* @details       RX72M func060
* @note          None
*/
void RX72M_RX72N_RX66N_func060(void)
{
    ...
    (void)KEY_ADR;
    (void)OFS_ADR;
    TSIP.REG_ECH.WORD = 0x300033c0u;
    TSIP.REG_ECH.WORD = 0x00070020u;
    TSIP.REG_ECH.WORD = 0x0000b7a0u;
    TSIP.REG_ECH.WORD = 0x2a46c04bu;
    TSIP.REG_ECH.WORD = 0x00030040u;
    TSIP.REG_ECH.WORD = 0x0000b7a0u;
    TSIP.REG_ECH.WORD = 0x85d04999u;
    TSIP.REG_ECH.WORD = 0x00050040u;
    TSIP.REG_ECH.WORD = 0x0000b7a0u;
    TSIP.REG_ECH.WORD = 0xb6e3697fu;
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_func060.prc
 *********************************************************************************************************************/
