...
*******************************************************************************************************************/ /**
* @details       RX72M TLS1.3 PreSharedKey Generation for Server
* @param[in]     InData_Cmd
...
e_tsip_err_t R_TSIP_Tls13SVGeneratePreSharedKeySub(uint32_t *InData_Cmd, uint32_t *InData_Handle, uint32_t *InData_RMaster_SecretKeyIndex, uint32_t *InData_TicketNonceLen, uint32_t *InData_TicketNonce, uint32_t *OutData_PreSharedKeyIndex)
{
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0xa538050au), change_endian_long(0x9d4d3e77u), change_endian_long(0x97b49a4du), change_endian_long(0xc641b3b7u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX72M_RX72N_RX66N_func102(change_endian_long(0x09257b6du), change_endian_long(0x11f4bb09u), change_endian_long(0x7aae4ad9u), change_endian_long(0x2b919916u));
    ...
    else
    {
        ...
        TSIP.REG_1CH.WORD = 0x00001800u;
        RX72M_RX72N_RX66N_func100(change_endian_long(0xa5a12b4eu), change_endian_long(0x3513cae4u), change_endian_long(0xa032479fu), change_endian_long(0x48ca3f33u));
        TSIP.REG_1CH.WORD = 0x00400000u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            RX72M_RX72N_RX66N_func102(change_endian_long(0x397eef7cu), change_endian_long(0x25fdeb43u), change_endian_long(0xb317ff50u), change_endian_long(0xc9f77c03u));
            TSIP.REG_1BCH.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
        ...
        else
        {
            ...
            RX72M_RX72N_RX66N_func101(change_endian_long(0xa963133du), change_endian_long(0xa2978b94u), change_endian_long(0xbf8f402cu), change_endian_long(0x968689adu));
            RX72M_RX72N_RX66N_func073(InData_TicketNonce);
            RX72M_RX72N_RX66N_func100(change_endian_long(0xf474fd49u), change_endian_long(0x73a9a6fdu), change_endian_long(0xbf98965du), change_endian_long(0xcaa293bdu));
            ...
            RX72M_RX72N_RX66N_func102(change_endian_long(0x7ecb4214u), change_endian_long(0x663cfc02u), change_endian_long(0xf2bd56bcu), change_endian_long(0x7345634fu));
            TSIP.REG_1BCH.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_pbd_r2.prc
 *********************************************************************************************************************/
