...
/***********************************************************************************************************************
* Function Name: R_TSIP_Tls13SVGenerate0RttApplicationWriteKeySub
*******************************************************************************************************************/ /**
* @details       RX72M TLS1.3 0-RTT Application Write Key Generation for Server
...
* @note          None
*/
e_tsip_err_t R_TSIP_Tls13SVGenerate0RttApplicationWriteKeySub(uint32_t *InData_Handle, uint32_t *InData_PreSharedKeyIndex, uint32_t *InData_MsgHash, uint32_t *OutData_ClientWriteKeyIndex)
{
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX72M_RX72N_RX66N_func100(change_endian_long(0x9750b1adu), change_endian_long(0x49526929u), change_endian_long(0x2c630f36u), change_endian_long(0x351f2fddu));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX72M_RX72N_RX66N_func102(change_endian_long(0x191e748fu), change_endian_long(0xd4df89d8u), change_endian_long(0x5bfdc42cu), change_endian_long(0x2e74db1au));
    ...
    {
        RX72M_RX72N_RX66N_func100(change_endian_long(0x331dccafu), change_endian_long(0x1a41ea83u), change_endian_long(0x1d15df13u), change_endian_long(0xe2efbe2cu));
        ...
        TSIP.REG_100H.WORD = change_endian_long(0x20632065u);
        /* WAIT_LOOP */
        while (1u != TSIP.REG_104H.BIT.B31)
        {
            /* waiting */
        ...
        TSIP.REG_ECH.WORD = 0x000003B0u;
        RX72M_RX72N_RX66N_func074();
        TSIP.REG_E0H.WORD = 0x80080000u;
        TSIP.REG_00H.WORD = 0x00008523u;
        TSIP.REG_74H.WORD = 0x00000008u;
        /* WAIT_LOOP */
        ...
        TSIP.REG_100H.WORD = change_endian_long(0x512272a1u);
        TSIP.REG_ECH.WORD = 0x00000bffu;
        TSIP.REG_D0H.WORD = 0x00000100u;
        ...
        OutData_ClientWriteKeyIndex[4] = TSIP.REG_100H.WORD;
        OutData_ClientWriteKeyIndex[5] = TSIP.REG_100H.WORD;
        OutData_ClientWriteKeyIndex[6] = TSIP.REG_100H.WORD;
        OutData_ClientWriteKeyIndex[7] = TSIP.REG_100H.WORD;
        /* WAIT_LOOP */
        while (1u != TSIP.REG_04H.BIT.B30)
        {
            /* waiting */
        }
        OutData_ClientWriteKeyIndex[8] = TSIP.REG_100H.WORD;
        OutData_ClientWriteKeyIndex[9] = TSIP.REG_100H.WORD;
        OutData_ClientWriteKeyIndex[10] = TSIP.REG_100H.WORD;
        OutData_ClientWriteKeyIndex[11] = TSIP.REG_100H.WORD;
        /* WAIT_LOOP */
        while (1u != TSIP.REG_04H.BIT.B30)
        {
            /* waiting */
        }
        OutData_ClientWriteKeyIndex[12] = TSIP.REG_100H.WORD;
        OutData_ClientWriteKeyIndex[13] = TSIP.REG_100H.WORD;
        OutData_ClientWriteKeyIndex[14] = TSIP.REG_100H.WORD;
        OutData_ClientWriteKeyIndex[15] = TSIP.REG_100H.WORD;
        RX72M_RX72N_RX66N_func100(change_endian_long(0xf79b5a64u), change_endian_long(0xdb2282f1u), change_endian_long(0x295a92bcu), change_endian_long(0x55551784u));
        TSIP.REG_E0H.WORD = 0x81040280u;
        ...
        RX72M_RX72N_RX66N_func102(change_endian_long(0x2ca8dfdcu), change_endian_long(0xe76e8c69u), change_endian_long(0xe0bf8a0du), change_endian_long(0xd818058fu));
        TSIP.REG_1BCH.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_pbb.prc
 *********************************************************************************************************************/
