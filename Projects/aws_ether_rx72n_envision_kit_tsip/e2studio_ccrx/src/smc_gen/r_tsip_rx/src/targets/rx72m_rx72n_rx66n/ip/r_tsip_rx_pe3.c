...
*******************************************************************************************************************/ /**
* @details       RX72M TLS PreMasterSecret Generation
...
e_tsip_err_t R_TSIP_TlsGeneratePreMasterSecretSub(uint32_t *OutData_PreMasterSecret)
{
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0x4bba289eu), change_endian_long(0x312ff6bau), change_endian_long(0xfc20e9e2u), change_endian_long(0xda190828u));
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0x13f7c757u), change_endian_long(0x331def1cu), change_endian_long(0x41d2281bu), change_endian_long(0xf3266b97u));
    RX72M_RX72N_RX66N_func103();
    TSIP.REG_104H.WORD = 0x00000052u;
    TSIP.REG_C4H.WORD = 0x01000c84u;
    /* WAIT_LOOP */
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    TSIP.REG_ECH.WORD = 0x00002420u;
    RX72M_RX72N_RX66N_func100(change_endian_long(0xd4eef50du), change_endian_long(0x50307279u), change_endian_long(0x4661ad2au), change_endian_long(0x7c6428f9u));
    RX72M_RX72N_RX66N_func103();
    TSIP.REG_104H.WORD = 0x00000052u;
    TSIP.REG_C4H.WORD = 0x01000c84u;
    /* WAIT_LOOP */
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0x7fd1ca24u), change_endian_long(0xb3641f4bu), change_endian_long(0xbc6a0d7cu), change_endian_long(0x69307388u));
    RX72M_RX72N_RX66N_func103();
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0x65fd3171u), change_endian_long(0x9f4b5987u), change_endian_long(0xbb91c71cu), change_endian_long(0xbb27fcceu));
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0x0409720bu), change_endian_long(0xffcf2252u), change_endian_long(0x4a8bb1f3u), change_endian_long(0x7924177eu));
    TSIP.REG_104H.WORD = 0x00000052u;
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0x964ba2a4u), change_endian_long(0x36735cc5u), change_endian_long(0x6728dfc7u), change_endian_long(0xef3c71aeu));
    TSIP.REG_104H.WORD = 0x00000052u;
    TSIP.REG_C4H.WORD = 0x01000c84u;
    /* WAIT_LOOP */
    while (1u != TSIP.REG_104H.BIT.B31)
    ...
    RX72M_RX72N_RX66N_func102(change_endian_long(0x4fc29e54u), change_endian_long(0xffe9b7bfu), change_endian_long(0x8985b5a4u), change_endian_long(0x44429bc9u));
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_pe3.prc
 *********************************************************************************************************************/
#endif /* #if TSIP_TLS == 1 */
