...
/***********************************************************************************************************************
* Function Name: R_TSIP_Aes128CcmEncryptUpdateSub
*******************************************************************************************************************/ /**
* @details       RX72M AES-128 Encryption with CCM Mode Update
...
void R_TSIP_Aes128CcmEncryptUpdateSub(uint32_t *InData_Text, uint32_t *OutData_Text, uint32_t MAX_CNT)
{
    ...
    (void)KEY_ADR;
    (void)OFS_ADR;
    RX72M_RX72N_RX66N_func100(change_endian_long(0xb1ab3108u), change_endian_long(0xd6f3561du), change_endian_long(0xaf289110u), change_endian_long(0x645f1676u));
    TSIP.REG_104H.WORD = 0x000000b1u;
    TSIP.REG_A4H.WORD = 0x00e007b6u;
    ...
    RX72M_RX72N_RX66N_func101(change_endian_long(0xba335ed3u), change_endian_long(0x4af10e37u), change_endian_long(0xbf5d2990u), change_endian_long(0x4fdad922u));
}
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_p95u_r1.prc
 *********************************************************************************************************************/
