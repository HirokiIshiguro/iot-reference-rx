...
*******************************************************************************************************************/ /**
* @details       RX72M HMAC-SHA1/SHA224/SHA256 Key Install
...
e_tsip_err_t R_TSIP_GenerateShaHmacKeyIndexSub(uint32_t *InData_SharedKeyIndex, uint32_t *InData_SessionKey, uint32_t *InData_Cmd, uint32_t *InData_IV, uint32_t *InData_InstData, uint32_t *OutData_KeyIndex)
{
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0xf49159d7u), change_endian_long(0xba1a3195u), change_endian_long(0xd45191e2u), change_endian_long(0x0495c045u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX72M_RX72N_RX66N_func102(change_endian_long(0x5336aba8u), change_endian_long(0x5b020d25u), change_endian_long(0x7b592c08u), change_endian_long(0xe6c86e4au));
    ...
    {
        RX72M_RX72N_RX66N_func100(change_endian_long(0x6c8de6d9u), change_endian_long(0x74e6cf28u), change_endian_long(0x0087e86cu), change_endian_long(0x68581137u));
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0x532e03c9u), change_endian_long(0xf0fac461u), change_endian_long(0x8a4c9bb6u), change_endian_long(0xe7bf69eau));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0xfe92659bu), change_endian_long(0x591acd98u), change_endian_long(0x5834c94bu), change_endian_long(0x4d82b0edu));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0xda0289d3u), change_endian_long(0xd1a372d9u), change_endian_long(0x5fcd72aau), change_endian_long(0xce11ca8cu));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0x483c6240u), change_endian_long(0x24c9e747u), change_endian_long(0x09fd5be0u), change_endian_long(0x1c3b1a70u));
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0x7572769fu), change_endian_long(0x6e8aac60u), change_endian_long(0x0b91e2d8u), change_endian_long(0xee58a5d5u));
        TSIP.REG_104H.WORD = 0x00000052u;
        ...
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            RX72M_RX72N_RX66N_func102(change_endian_long(0x7156b33au), change_endian_long(0x164d2c56u), change_endian_long(0xc289b002u), change_endian_long(0xda9f6174u));
            TSIP.REG_1BCH.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
        ...
        {
            RX72M_RX72N_RX66N_func100(change_endian_long(0xf7b29f96u), change_endian_long(0xdab0cf3bu), change_endian_long(0xdf109c08u), change_endian_long(0x3907b913u));
            TSIP.REG_E0H.WORD = 0x81040000u;
            ...
            RX72M_RX72N_RX66N_func102(change_endian_long(0x974f4876u), change_endian_long(0x65b60ed3u), change_endian_long(0xc7c71c81u), change_endian_long(0x981a4d42u));
            TSIP.REG_1BCH.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_p80_r1.prc
 *********************************************************************************************************************/
