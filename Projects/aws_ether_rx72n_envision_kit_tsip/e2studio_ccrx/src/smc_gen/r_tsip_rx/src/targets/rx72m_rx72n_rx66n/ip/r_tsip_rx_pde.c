...
*******************************************************************************************************************/ /**
* @details       RX72M TLS1.3 Resumption/0-RTT Binder Key Generation
...
e_tsip_err_t R_TSIP_Tls13GeneratePskBinderKeySub(uint32_t *InData_Handle, uint32_t *InData_PreSharedKeyIndex, uint32_t *OutData_BinderKeyIndex)
{
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX72M_RX72N_RX66N_func100(change_endian_long(0x3bd284f5u), change_endian_long(0x20f0aa4du), change_endian_long(0x667c68e8u), change_endian_long(0x56acd808u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX72M_RX72N_RX66N_func102(change_endian_long(0x36182f35u), change_endian_long(0xfc6f23e1u), change_endian_long(0xec6069afu), change_endian_long(0xc9a6a70bu));
    ...
    else
    {
        ...
        RX72M_RX72N_RX66N_func070();
        RX72M_RX72N_RX66N_func100(change_endian_long(0x919f8457u), change_endian_long(0xfb27ed12u), change_endian_long(0x0952b8fbu), change_endian_long(0xb9726985u));
        TSIP.REG_C4H.WORD = 0x400c0b0cu;
        /* WAIT_LOOP */
        while (1u != TSIP.REG_104H.BIT.B31)
        {
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0xa8a478bbu), change_endian_long(0x483f65beu), change_endian_long(0xc609e0f6u), change_endian_long(0x918f781au));
        TSIP.REG_E0H.WORD = 0x81040280u;
        ...
        RX72M_RX72N_RX66N_func102(change_endian_long(0x2439c94cu), change_endian_long(0xad69f9c4u), change_endian_long(0xf0a98523u), change_endian_long(0x216cb801u));
        TSIP.REG_1BCH.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_pde.prc
 *********************************************************************************************************************/
