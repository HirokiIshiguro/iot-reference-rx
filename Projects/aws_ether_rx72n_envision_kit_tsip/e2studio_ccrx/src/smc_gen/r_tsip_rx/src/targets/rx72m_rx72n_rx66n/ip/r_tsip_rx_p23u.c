...
/***********************************************************************************************************************
* Function Name: R_TSIP_GenerateFirmwareMacUpdateSub
*******************************************************************************************************************/ /**
* @details       RX65NHU F/W update Update
...
* @note          None
*/
e_tsip_err_t R_TSIP_GenerateFirmwareMacUpdateSub(uint32_t *InData_UpProgram, uint32_t *OutData_Program, uint32_t MAX_CNT)
{
    ...
    RX72M_RX72N_RX66N_func101(change_endian_long(0xd35e276fu), change_endian_long(0xc857e094u), change_endian_long(0xf6e9b15du), change_endian_long(0x2772c955u));
    return TSIP_SUCCESS;
}
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_p23u.prc
 *********************************************************************************************************************/
