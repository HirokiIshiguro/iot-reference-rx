...
/***********************************************************************************************************************
* Function Name: RX72M_RX72N_RX66N_func023
*******************************************************************************************************************/ /**
* @details       RX72M func023
* @note          None
*/
void RX72M_RX72N_RX66N_func023(void)
{
    ...
    TSIP.REG_ECH.WORD = 0xd1717d6eu;
    TSIP.REG_ECH.WORD = 0x00030040u;
    TSIP.REG_ECH.WORD = 0x0000b7c0u;
    TSIP.REG_ECH.WORD = 0x87ad98e8u;
    TSIP.REG_ECH.WORD = 0x00050040u;
    TSIP.REG_ECH.WORD = 0x0000b7c0u;
    TSIP.REG_ECH.WORD = 0xb6fbf2e5u;
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_func023.prc
 *********************************************************************************************************************/
