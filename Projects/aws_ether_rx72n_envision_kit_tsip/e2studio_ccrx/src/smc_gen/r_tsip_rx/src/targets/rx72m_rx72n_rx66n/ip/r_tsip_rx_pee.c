...
/***********************************************************************************************************************
* Function Name: R_TSIP_Tls13Generate0RttApplicationWriteKeySub
*******************************************************************************************************************/ /**
* @details       RX72M TLS1.3 0-RTT Application Write Key Generation
...
* @note          None
*/
e_tsip_err_t R_TSIP_Tls13Generate0RttApplicationWriteKeySub(uint32_t *InData_Handle, uint32_t *InData_PreSharedKeyIndex, uint32_t *InData_MsgHash, uint32_t *OutData_ClientWriteKeyIndex)
{
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX72M_RX72N_RX66N_func100(change_endian_long(0xb38a877bu), change_endian_long(0x0c5f360bu), change_endian_long(0x73ee70dau), change_endian_long(0xcc886d42u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX72M_RX72N_RX66N_func102(change_endian_long(0x453077bbu), change_endian_long(0x1995f723u), change_endian_long(0xdd31e03au), change_endian_long(0xfb0bbc1fu));
    ...
    {
        RX72M_RX72N_RX66N_func100(change_endian_long(0xd6d8f1c0u), change_endian_long(0x17dc32d8u), change_endian_long(0x51cc045cu), change_endian_long(0xd56968ecu));
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0xd9927534u), change_endian_long(0xc9381552u), change_endian_long(0xd0d0b4fcu), change_endian_long(0xaa1c7791u));
        TSIP.REG_E0H.WORD = 0x81040280u;
        ...
        RX72M_RX72N_RX66N_func102(change_endian_long(0xbcf5f9f6u), change_endian_long(0x0e7648b1u), change_endian_long(0x2bc1518cu), change_endian_long(0xb9db482cu));
        TSIP.REG_1BCH.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_pee.prc
 *********************************************************************************************************************/
