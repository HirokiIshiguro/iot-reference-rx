...
*******************************************************************************************************************/ /**
* @details       RX72M Install 256bit AES Key
...
e_tsip_err_t R_TSIP_GenerateAes256KeyIndexSub(uint32_t *InData_SharedKeyIndex, uint32_t *InData_SessionKey, uint32_t *InData_IV, uint32_t *InData_InstData, uint32_t *OutData_KeyIndex)
{
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0x8b6440c4u), change_endian_long(0x25213195u), change_endian_long(0x31c10316u), change_endian_long(0x77ff0e45u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX72M_RX72N_RX66N_func102(change_endian_long(0x66274b28u), change_endian_long(0xf2e38375u), change_endian_long(0xe25c10e3u), change_endian_long(0xef2bf9d1u));
    ...
    {
        RX72M_RX72N_RX66N_func100(change_endian_long(0xf837b23fu), change_endian_long(0xcb767f92u), change_endian_long(0x322e7c23u), change_endian_long(0xdd1ab19cu));
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0xac740fdeu), change_endian_long(0x7cdbc507u), change_endian_long(0xda05e983u), change_endian_long(0x16a46f19u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0xbbd9c39eu), change_endian_long(0x63613de7u), change_endian_long(0xdbb1f190u), change_endian_long(0x11bfde6fu));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0xdc7776fbu), change_endian_long(0xf246ebfbu), change_endian_long(0xc79162ffu), change_endian_long(0xa22060fbu));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0x4339f3acu), change_endian_long(0x1595ad17u), change_endian_long(0x0dd1e584u), change_endian_long(0x13cc695au));
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0x5d5c7f11u), change_endian_long(0x76625d12u), change_endian_long(0xa963c55fu), change_endian_long(0xc52f0b11u));
        TSIP.REG_104H.WORD = 0x00000052u;
        ...
        TSIP.REG_1CH.WORD = 0x00001800u;
        RX72M_RX72N_RX66N_func100(change_endian_long(0x4d113275u), change_endian_long(0xe288076bu), change_endian_long(0xa1268d40u), change_endian_long(0xb9d2ffa5u));
        TSIP.REG_1CH.WORD = 0x00400000u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            RX72M_RX72N_RX66N_func102(change_endian_long(0x1809e99bu), change_endian_long(0xb8096518u), change_endian_long(0x25819ed6u), change_endian_long(0x1fb1627du));
            TSIP.REG_1BCH.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
        ...
        {
            RX72M_RX72N_RX66N_func100(change_endian_long(0x40ebff73u), change_endian_long(0x90b561fcu), change_endian_long(0x223ee342u), change_endian_long(0x5474639bu));
            TSIP.REG_E0H.WORD = 0x81040000u;
            ...
            RX72M_RX72N_RX66N_func102(change_endian_long(0x43ca42d1u), change_endian_long(0x2b559eaeu), change_endian_long(0xb1062101u), change_endian_long(0x06e3ab79u));
            TSIP.REG_1BCH.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_p04.prc
 *********************************************************************************************************************/
