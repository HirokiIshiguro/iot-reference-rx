...
/***********************************************************************************************************************
* Function Name: R_TSIP_Tls13SVGenerateServerHandshakeTrafficKeySub
*******************************************************************************************************************/ /**
* @details       RX72M TLS1.3 Server Handshake Traffic Key Generation for Server
* @param[in]     InData_Cmd
...
* @note          None
*/
e_tsip_err_t R_TSIP_Tls13SVGenerateServerHandshakeTrafficKeySub(uint32_t *InData_Cmd, uint32_t *InData_Handshake_SecretKeyIndex, uint32_t *InData_MsgHash, uint32_t *OutData_ServerWriteKeyIndex, uint32_t *OutData_ServerFinishedKeyIndex)
{
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX72M_RX72N_RX66N_func100(change_endian_long(0xc8f8359eu), change_endian_long(0x3f0b0f58u), change_endian_long(0x6105f329u), change_endian_long(0xbee53470u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX72M_RX72N_RX66N_func102(change_endian_long(0x9fd5d102u), change_endian_long(0x504c5e02u), change_endian_long(0x76fa8449u), change_endian_long(0x2d68e77cu));
    ...
    {
        RX72M_RX72N_RX66N_func100(change_endian_long(0xed031840u), change_endian_long(0xbd7d26bau), change_endian_long(0x16e918a8u), change_endian_long(0x0ffe7a63u));
        ...
        TSIP.REG_100H.WORD = change_endian_long(0x302bcd1du);
        TSIP.REG_ECH.WORD = 0x00000bffu;
        TSIP.REG_D0H.WORD = 0x00000100u;
        ...
        TSIP.REG_1CH.WORD = 0x00001800u;
        RX72M_RX72N_RX66N_func100(change_endian_long(0x1dad0f2fu), change_endian_long(0xac0282bfu), change_endian_long(0xd3c680bbu), change_endian_long(0x623057e5u));
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0x409983bau), change_endian_long(0x11177390u), change_endian_long(0xf2ad0649u), change_endian_long(0xd91d7096u));
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0xeed69465u), change_endian_long(0x77a668dcu), change_endian_long(0xb458bba6u), change_endian_long(0x7fdc898fu));
        TSIP.REG_C4H.WORD = 0x400c0b0cu;
        /* WAIT_LOOP */
        while (1u != TSIP.REG_104H.BIT.B31)
        {
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0xffcc64e9u), change_endian_long(0x41d86455u), change_endian_long(0x885fdc3eu), change_endian_long(0xa454f7a4u));
        TSIP.REG_E0H.WORD = 0x81040280u;
        TSIP.REG_04H.WORD = 0x00000612u;
        /* WAIT_LOOP */
        while (1u != TSIP.REG_04H.BIT.B30)
        ...
        RX72M_RX72N_RX66N_func102(change_endian_long(0x5f0db74fu), change_endian_long(0xf8d2d8ebu), change_endian_long(0x611dd309u), change_endian_long(0x893952b2u));
        TSIP.REG_1BCH.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_p3a_r1.prc
 *********************************************************************************************************************/
