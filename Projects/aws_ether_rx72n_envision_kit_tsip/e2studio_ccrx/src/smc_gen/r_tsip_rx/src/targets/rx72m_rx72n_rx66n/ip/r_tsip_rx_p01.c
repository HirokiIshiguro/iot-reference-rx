...
*******************************************************************************************************************/ /**
* @details       RX72M TSIP Initialization 1
* @retval        TSIP_SUCCESS
...
e_tsip_err_t R_TSIP_SelfCheck1Sub(void)
{
    ...
    RX72M_RX72N_RX66N_func101(0x24460793u, 0x5a6b9859u, 0x00324cf3u, 0x2ecf83ebu);
    ...
    TSIP.REG_100H.WORD = 0x4124576eu;
    TSIP.REG_100H.WORD = 0x3ea0da7du;
    TSIP.REG_100H.WORD = 0x9558c42cu;
    TSIP.REG_100H.WORD = 0x20f12b75u;
    RX72M_RX72N_RX66N_func101(0x43d6638du, 0x1b98d85au, 0x6c35caefu, 0x59369301u);
    RX72M_RX72N_RX66N_func100(0x01756619u, 0xbf718d8cu, 0xa79c3a5au, 0x6ac457a7u);
    ...
    else
    {
        ...
        RX72M_RX72N_RX66N_func102(0xbab281f4u, 0xf2815118u, 0x0c5d1b4du, 0x2df3af21u);
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_p01_r1.prc
 *********************************************************************************************************************/
TSIP_SEC_DEFAULT
