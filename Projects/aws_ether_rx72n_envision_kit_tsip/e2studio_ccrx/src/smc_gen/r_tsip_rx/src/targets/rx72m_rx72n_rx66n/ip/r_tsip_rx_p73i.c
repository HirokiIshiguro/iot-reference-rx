...
*******************************************************************************************************************/ /**
* @details       RX72M HMAC-SHA1 Message Digest Generation Init
...
e_tsip_err_t R_TSIP_Sha1HmacInitSub(uint32_t *InData_KeyType, uint32_t *InData_Cmd, uint32_t *InData_KeyIndex)
{
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0x92f24cfau), change_endian_long(0x12ea175cu), change_endian_long(0x9af7080du), change_endian_long(0x0de37015u));
    ...
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        ...
        RX72M_RX72N_RX66N_func101(change_endian_long(0x7dd9e9b2u), change_endian_long(0xa0bb2af0u), change_endian_long(0x5d8e3383u), change_endian_long(0x26441972u));
    }
    else
    {
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0xcfb90ccbu), change_endian_long(0xcfe2e081u), change_endian_long(0x82b8c7eeu), change_endian_long(0x4ecdd5e9u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX72M_RX72N_RX66N_func102(change_endian_long(0xe4c57406u), change_endian_long(0x238fc54bu), change_endian_long(0x054df1adu), change_endian_long(0xd772bd79u));
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_p73i_r1.prc
 *********************************************************************************************************************/
