...
*******************************************************************************************************************/ /**
* @details       RX72M TLS1.3 ECDHE Shared Secret Calculation
* @param[in]     InData_Cmd
...
e_tsip_err_t R_TSIP_Tls13GenerateEcdheSharedSecretSub(uint32_t *InData_Cmd, uint32_t *InData_PubKey, uint32_t *InData_KeyIndex, const uint32_t *InData_DomainParam, uint32_t *OutData_SharedSecretKeyIndex)
{
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0x5dcb0d0eu), change_endian_long(0x36e7d614u), change_endian_long(0x33fbbe33u), change_endian_long(0x6af157ebu));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX72M_RX72N_RX66N_func102(change_endian_long(0x70ddb578u), change_endian_long(0x449051aau), change_endian_long(0x9cde3d6eu), change_endian_long(0x82b34d9bu));
    ...
    else
    {
        ...
        TSIP.REG_1CH.WORD = 0x00001800u;
        RX72M_RX72N_RX66N_func100(change_endian_long(0x19610302u), change_endian_long(0x7a5cb401u), change_endian_long(0xe7b106fbu), change_endian_long(0x91446234u));
        TSIP.REG_1CH.WORD = 0x00400000u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            RX72M_RX72N_RX66N_func102(change_endian_long(0x935ff76fu), change_endian_long(0x06d984b6u), change_endian_long(0xba8933e9u), change_endian_long(0x4d0fcd5bu));
            TSIP.REG_1B8H.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
        ...
        {
            RX72M_RX72N_RX66N_func100(change_endian_long(0xbbccc94au), change_endian_long(0xaf61e521u), change_endian_long(0x1ecb9a55u), change_endian_long(0x988eaa88u));
            TSIP.REG_24H.WORD = 0x0000dcd0u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_24H.BIT.B21)
            {
            ...
            RX72M_RX72N_RX66N_func100(change_endian_long(0x269894aeu), change_endian_long(0xf5b8af1fu), change_endian_long(0xdcecc12bu), change_endian_long(0xab61d0f2u));
            TSIP.REG_1CH.WORD = 0x00400000u;
            TSIP.REG_1D0H.WORD = 0x00000000u;
            if (1u == (TSIP.REG_1CH.BIT.B22))
            {
                RX72M_RX72N_RX66N_func102(change_endian_long(0xed4d8126u), change_endian_long(0x28720834u), change_endian_long(0xa431f8b6u), change_endian_long(0xd73c255fu));
                TSIP.REG_1B8H.WORD = 0x00000040u;
                /* WAIT_LOOP */
                while (0u != TSIP.REG_18H.BIT.B12)
                {
            ...
            {
                RX72M_RX72N_RX66N_func100(change_endian_long(0x3db90b04u), change_endian_long(0x1445ce6bu), change_endian_long(0x0ad81b67u), change_endian_long(0x7fd39cddu));
                ...
                TSIP.REG_18H.WORD = 0x00000000u;
                RX72M_RX72N_RX66N_func100(change_endian_long(0xfda43229u), change_endian_long(0x58182759u), change_endian_long(0x9f364c68u), change_endian_long(0xe4fd12c4u));
                TSIP.REG_34H.WORD = 0x00000003u;
                TSIP.REG_24H.WORD = 0x800048d0u;
                /* WAIT_LOOP */
                while (0u != TSIP.REG_24H.BIT.B21)
                ...
                RX72M_RX72N_RX66N_func100(change_endian_long(0x8ec8783au), change_endian_long(0xfe3db6aeu), change_endian_long(0x84087481u), change_endian_long(0xf72b2dcdu));
                ...
                RX72M_RX72N_RX66N_func100(change_endian_long(0xce1579ccu), change_endian_long(0x03223d0eu), change_endian_long(0x60f69808u), change_endian_long(0xc57dd5b1u));
                TSIP.REG_E0H.WORD = 0x81040280u;
                ...
                RX72M_RX72N_RX66N_func102(change_endian_long(0xb008760du), change_endian_long(0xb62860dcu), change_endian_long(0x37c50d35u), change_endian_long(0xb342085cu));
                TSIP.REG_1B8H.WORD = 0x00000040u;
                /* WAIT_LOOP */
                while (0u != TSIP.REG_18H.BIT.B12)
                {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_peb_r3.prc
 *********************************************************************************************************************/
