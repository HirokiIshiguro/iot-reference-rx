...
/***********************************************************************************************************************
* Function Name: R_TSIP_Aes256GcmEncryptUpdateSub
*******************************************************************************************************************/ /**
* @details       RX72M AES-256 Encryption with GCM Mode Update
...
void R_TSIP_Aes256GcmEncryptUpdateSub(uint32_t *InData_Text, uint32_t *OutData_Text, uint32_t MAX_CNT)
{
    ...
    (void)KEY_ADR;
    (void)OFS_ADR;
    RX72M_RX72N_RX66N_func100(change_endian_long(0x9828e73au), change_endian_long(0x9414fa50u), change_endian_long(0x853da93eu), change_endian_long(0xe405cc52u));
    TSIP.REG_00H.WORD = 0x80007100u;
    TSIP.REG_104H.WORD = 0x000000b1u;
    TSIP.REG_B0H.WORD = 0x40000020u;
    TSIP.REG_A4H.WORD = 0x000087b6u;
    TSIP.REG_C4H.WORD = 0x00000886u;
    ...
    RX72M_RX72N_RX66N_func101(change_endian_long(0x828a87e3u), change_endian_long(0xddef104au), change_endian_long(0x3d91f7b9u), change_endian_long(0xfecbb50du));
}
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_p34u_r1.prc
 *********************************************************************************************************************/
