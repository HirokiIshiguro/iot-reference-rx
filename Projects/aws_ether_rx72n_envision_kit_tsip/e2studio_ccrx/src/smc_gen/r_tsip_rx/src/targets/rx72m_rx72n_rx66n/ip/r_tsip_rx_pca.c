...
*******************************************************************************************************************/ /**
* @details       RX72M TLS1.3 Server Handshake Verify
* @param[in]     InData_Cmd
...
e_tsip_err_t R_TSIP_Tls13ServerHandshakeVerificationSub(uint32_t *InData_Cmd, uint32_t *InData_ServerFinishedKeyIndex, uint32_t *InData_MsgHash, uint32_t *InData_ServerFinished, uint32_t *OutData_VerifyDataIndex)
{
    ...
    {
        RX72M_RX72N_RX66N_func102(change_endian_long(0x00c71d45u), change_endian_long(0x4786b43du), change_endian_long(0x0cdce454u), change_endian_long(0xef6d8b7fu));
    ...
    else
    {
        ...
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            RX72M_RX72N_RX66N_func102(change_endian_long(0xcf3cdfb0u), change_endian_long(0xfc2193c0u), change_endian_long(0x38bc02a1u), change_endian_long(0x75dd5202u));
            TSIP.REG_1BCH.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
        ...
        {
            RX72M_RX72N_RX66N_func100(change_endian_long(0xf006f19cu), change_endian_long(0x0d7dfe30u), change_endian_long(0x1a10e08au), change_endian_long(0x42f768c2u));
            TSIP.REG_C4H.WORD = 0x400c0b0cu;
            /* WAIT_LOOP */
            while (1u != TSIP.REG_104H.BIT.B31)
            {
            ...
            RX72M_RX72N_RX66N_func100(change_endian_long(0x2d51b5b5u), change_endian_long(0x90207385u), change_endian_long(0xdc1edc67u), change_endian_long(0x768fd820u));
            ...
            RX72M_RX72N_RX66N_func100(change_endian_long(0x4a286019u), change_endian_long(0x6318eabfu), change_endian_long(0xee8808d3u), change_endian_long(0x243fdd8bu));
            TSIP.REG_104H.WORD = 0x00000052u;
            ...
            RX72M_RX72N_RX66N_func102(change_endian_long(0x2b1782e1u), change_endian_long(0x37c4709eu), change_endian_long(0xf9af90c3u), change_endian_long(0x1110da7au));
            TSIP.REG_1BCH.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_pca_r1.prc
 *********************************************************************************************************************/
