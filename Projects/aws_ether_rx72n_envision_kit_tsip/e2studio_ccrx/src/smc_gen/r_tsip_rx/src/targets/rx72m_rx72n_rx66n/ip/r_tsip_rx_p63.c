...
*******************************************************************************************************************/ /**
* @details       RX72M Install 2048bit RSA Private Key
...
e_tsip_err_t R_TSIP_GenerateRsa2048PrivateKeyIndexSub(uint32_t *InData_SharedKeyIndex, uint32_t *InData_SessionKey, uint32_t *InData_IV, uint32_t *InData_InstData, uint32_t *OutData_KeyIndex)
{
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0x21780720u), change_endian_long(0xd4b7c0cfu), change_endian_long(0xd16bd87eu), change_endian_long(0x9e668951u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX72M_RX72N_RX66N_func102(change_endian_long(0xea08d7b8u), change_endian_long(0xad4371bcu), change_endian_long(0xd62740c5u), change_endian_long(0x88144994u));
    ...
    {
        RX72M_RX72N_RX66N_func100(change_endian_long(0x1b8477d9u), change_endian_long(0xc7705330u), change_endian_long(0xaab658a4u), change_endian_long(0xca754204u));
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0x4792ba48u), change_endian_long(0xdc3610dau), change_endian_long(0x45a7873bu), change_endian_long(0xe6aeea07u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0xeb654045u), change_endian_long(0x2140683au), change_endian_long(0x8017f75eu), change_endian_long(0x884aeae4u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0x93cccf73u), change_endian_long(0xd9b78fbau), change_endian_long(0xd699f593u), change_endian_long(0x8dd7ea9du));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0xa2e7d234u), change_endian_long(0x4597ca06u), change_endian_long(0xe0090ee9u), change_endian_long(0x38ade01fu));
        ...
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            RX72M_RX72N_RX66N_func102(change_endian_long(0x5545bc9au), change_endian_long(0xe2f02a3fu), change_endian_long(0x64bfed0bu), change_endian_long(0x0e5b3bbfu));
            TSIP.REG_1BCH.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
        ...
        {
            RX72M_RX72N_RX66N_func100(change_endian_long(0x71a3b0ccu), change_endian_long(0x3a4112feu), change_endian_long(0xd8e37e0fu), change_endian_long(0xc6cddf39u));
            TSIP.REG_E0H.WORD = 0x81040000u;
            ...
            RX72M_RX72N_RX66N_func102(change_endian_long(0x5a6dd9a8u), change_endian_long(0xd46fe67fu), change_endian_long(0xc2740fa3u), change_endian_long(0xfda31ed4u));
            TSIP.REG_1BCH.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_p63_r1.prc
 *********************************************************************************************************************/
