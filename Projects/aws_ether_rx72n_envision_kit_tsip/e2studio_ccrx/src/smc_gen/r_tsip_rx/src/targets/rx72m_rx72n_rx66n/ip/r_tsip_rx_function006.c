...
/***********************************************************************************************************************
* Function Name: RX72M_RX72N_RX66N_func006
*******************************************************************************************************************/ /**
* @details       RX72M func006
* @note          None
*/
void RX72M_RX72N_RX66N_func006(void)
{
    ...
    (void)KEY_ADR;
    (void)OFS_ADR;
    RX72M_RX72N_RX66N_func100(change_endian_long(0xb8ddf883u), change_endian_long(0x7a8c323au), change_endian_long(0xa17c4faau), change_endian_long(0x46903801u));
    TSIP.REG_34H.WORD = 0x00000010u;
    TSIP.REG_24H.WORD = 0x80009cd0u;
    /* WAIT_LOOP */
    ...
    TSIP.REG_34H.WORD = 0x00000c08u;
    TSIP.REG_24H.WORD = 0x8000d0d0u;
    /* WAIT_LOOP */
    while (0u != TSIP.REG_24H.BIT.B21)
    {
        /* waiting */
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0xc2f66c5eu), change_endian_long(0x4d445062u), change_endian_long(0x6e019abbu), change_endian_long(0x3dc11687u));
    TSIP.REG_24H.WORD = 0x00001dc0u;
    /* WAIT_LOOP */
    while (0u != TSIP.REG_24H.BIT.B21)
    {
    ...
    TSIP.REG_1CH.WORD = 0x00001f00u;
    TSIP.REG_1CH.WORD = 0x00210000u;
    TSIP.REG_ECH.WORD = 0x00007c1bu;
    TSIP.REG_1CH.WORD = 0x00602000u;
}
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_func006_r1.prc
 *********************************************************************************************************************/
