...
/***********************************************************************************************************************
* Function Name: R_TSIP_Aes256GcmDecryptUpdateSub
*******************************************************************************************************************/ /**
* @details       RX72M AES-256 Decryption with GCM Mode Update
...
void R_TSIP_Aes256GcmDecryptUpdateSub(uint32_t *InData_Text, uint32_t *OutData_Text, uint32_t MAX_CNT)
{
    ...
    (void)KEY_ADR;
    (void)OFS_ADR;
    RX72M_RX72N_RX66N_func100(change_endian_long(0xaef85316u), change_endian_long(0x2558f886u), change_endian_long(0xf9927fd6u), change_endian_long(0x9548e33au));
    ...
    RX72M_RX72N_RX66N_func101(change_endian_long(0x0b92a31cu), change_endian_long(0xb7c2e984u), change_endian_long(0xbe13c816u), change_endian_long(0x23244ffcu));
}
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_p36u_r1.prc
 *********************************************************************************************************************/
