...
*******************************************************************************************************************/ /**
* @details       RX72M Generate key for ARC4
...
e_tsip_err_t R_TSIP_GenerateArc4RandomKeyIndexSub(uint32_t *OutData_KeyIndex)
{
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0x54f063c9u), change_endian_long(0x56f40d3au), change_endian_long(0xb32bb13bu), change_endian_long(0x5614d6adu));
    ...
    {
        RX72M_RX72N_RX66N_func100(change_endian_long(0xcb1687f0u), change_endian_long(0x7c5af9c7u), change_endian_long(0x897fdde5u), change_endian_long(0x554280b7u));
        RX72M_RX72N_RX66N_func103();
        TSIP.REG_104H.WORD = 0x00000052u;
        TSIP.REG_C4H.WORD = 0x01000c84u;
        /* WAIT_LOOP */
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0xe9eb561du), change_endian_long(0xb2130b46u), change_endian_long(0x3f95e834u), change_endian_long(0x088d6cacu));
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0x1fa1bd26u), change_endian_long(0x237ec8eeu), change_endian_long(0x15fd8d5bu), change_endian_long(0x0d740cd4u));
    ...
    RX72M_RX72N_RX66N_func102(change_endian_long(0x9f8a56fbu), change_endian_long(0x46bc9931u), change_endian_long(0x714a2439u), change_endian_long(0x26eaaf8au));
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_p19.prc
 *********************************************************************************************************************/
