...
*******************************************************************************************************************/ /**
* @details       RX72M AES-256 Decryption and MAC verification with CCM Mode Update
...
void R_TSIP_Aes256CcmDecryptUpdateSub(uint32_t *InData_Text, uint32_t *OutData_Text, uint32_t MAX_CNT)
{
    ...
    (void)KEY_ADR;
    (void)OFS_ADR;
    RX72M_RX72N_RX66N_func100(change_endian_long(0x05fbe55eu), change_endian_long(0x321d0a72u), change_endian_long(0xe399e7bbu), change_endian_long(0x046e0436u));
    ...
    RX72M_RX72N_RX66N_func101(change_endian_long(0xa39d0cf3u), change_endian_long(0x9b80655fu), change_endian_long(0xd9e1b318u), change_endian_long(0xe1c1cb77u));
}
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_pa4u_r1.prc
 *********************************************************************************************************************/
