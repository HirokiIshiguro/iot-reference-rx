...
*******************************************************************************************************************/ /**
* @details       RX72M TLS1.3 P-256 Key Generation
* @param[in]     InData_Cmd
...
e_tsip_err_t R_TSIP_GenerateTls13P256EccKeyIndexSub(uint32_t *InData_Cmd, uint32_t *InData_Handle, const uint32_t *InData_DomainParam, uint32_t *OutData_KeyIndex, uint32_t *OutData_PubKey)
{
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0xa9ebd395u), change_endian_long(0x733af7bbu), change_endian_long(0x386c8e05u), change_endian_long(0x1b0cebd5u));
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0x76dfbc02u), change_endian_long(0xa4beeeacu), change_endian_long(0x922013deu), change_endian_long(0xb32a1804u));
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0x5b5a1333u), change_endian_long(0x1b46ee1eu), change_endian_long(0x3d19ba49u), change_endian_long(0x2bf24751u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX72M_RX72N_RX66N_func102(change_endian_long(0xddbb4a6du), change_endian_long(0x0d5bf192u), change_endian_long(0xbfa5ff15u), change_endian_long(0x380f2707u));
    ...
    {
        RX72M_RX72N_RX66N_func100(change_endian_long(0x674fee90u), change_endian_long(0xeac18d41u), change_endian_long(0x93e4f8a7u), change_endian_long(0x0a72e832u));
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0xda93d3edu), change_endian_long(0x4ff8e21fu), change_endian_long(0x260bba50u), change_endian_long(0x5b6820f0u));
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0xc2694f07u), change_endian_long(0x0e310833u), change_endian_long(0xb43a70b4u), change_endian_long(0x7132ee31u));
        TSIP.REG_1CH.WORD = 0x00400000u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            ...
            RX72M_RX72N_RX66N_func101(change_endian_long(0x188ac0e0u), change_endian_long(0x4a23b50cu), change_endian_long(0x523c369fu), change_endian_long(0xabd79748u));
        }
        RX72M_RX72N_RX66N_func100(change_endian_long(0x55330a32u), change_endian_long(0xea84efebu), change_endian_long(0xacea43fau), change_endian_long(0x5925e5f2u));
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0x09e94dcdu), change_endian_long(0x37a57566u), change_endian_long(0x2aecc9b8u), change_endian_long(0x94504edeu));
        TSIP.REG_104H.WORD = 0x00000052u;
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0x00c40b19u), change_endian_long(0xbb69ccc2u), change_endian_long(0x5db4af2cu), change_endian_long(0x95ea0631u));
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0xdf0ea2eau), change_endian_long(0xe8a0da5cu), change_endian_long(0x61f064b7u), change_endian_long(0xa5601189u));
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0xbd75ec80u), change_endian_long(0x9b5e68feu), change_endian_long(0xc342cd51u), change_endian_long(0x3981f94fu));
        ...
        RX72M_RX72N_RX66N_func102(change_endian_long(0x7125e301u), change_endian_long(0x1ab60e27u), change_endian_long(0x89ff39b7u), change_endian_long(0x20d8fe62u));
        TSIP.REG_1B8H.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_pea_r3.prc
 *********************************************************************************************************************/
