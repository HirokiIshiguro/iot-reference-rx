...
/***********************************************************************************************************************
* Function Name: R_TSIP_UpdateEccP384PrivateKeyIndexSub
*******************************************************************************************************************/ /**
* @details       RX72M Update P-384 ECC Private Key
* @param[in]     InData_IV
...
* @note          None
*/
e_tsip_err_t R_TSIP_UpdateEccP384PrivateKeyIndexSub(uint32_t *InData_IV, uint32_t *InData_InstData, uint32_t *OutData_KeyIndex)
{
    ...
    TSIP.REG_84H.WORD = 0x00002d01u;
    TSIP.REG_108H.WORD = 0x00000000u;
    RX72M_RX72N_RX66N_func100(change_endian_long(0xdfeea5f5u), change_endian_long(0x544fbd55u), change_endian_long(0xc596adebu), change_endian_long(0xabd36be7u));
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0x2b1230d8u), change_endian_long(0x670fd822u), change_endian_long(0x7977f1acu), change_endian_long(0xb2dd9515u));
    TSIP.REG_104H.WORD = 0x00000361u;
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0xba21d4c0u), change_endian_long(0x5219718du), change_endian_long(0xe4a9ecacu), change_endian_long(0xefac12d5u));
    TSIP.REG_104H.WORD = 0x00000361u;
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0x348fa3cdu), change_endian_long(0x709e062bu), change_endian_long(0xc3640023u), change_endian_long(0x2e7c2285u));
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0x5a3fc91au), change_endian_long(0x04ff4103u), change_endian_long(0x08c457b9u), change_endian_long(0xf9203640u));
    TSIP.REG_104H.WORD = 0x00000052u;
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX72M_RX72N_RX66N_func100(change_endian_long(0x81d8a478u), change_endian_long(0xf943476eu), change_endian_long(0xfa328648u), change_endian_long(0xf2b10650u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX72M_RX72N_RX66N_func102(change_endian_long(0xc52ca183u), change_endian_long(0xd72edc7bu), change_endian_long(0x0e5d11a2u), change_endian_long(0x2e54f1b0u));
    ...
    {
        RX72M_RX72N_RX66N_func100(change_endian_long(0x6cc8ef70u), change_endian_long(0x1d44bbdeu), change_endian_long(0x8da72c27u), change_endian_long(0xa1d0838cu));
        TSIP.REG_E0H.WORD = 0x81040000u;
        ...
        RX72M_RX72N_RX66N_func102(change_endian_long(0x30f9a93eu), change_endian_long(0x6f4e93cfu), change_endian_long(0xb23a6782u), change_endian_long(0x42976c92u));
        TSIP.REG_1B4H.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_p2d.prc
 *********************************************************************************************************************/
