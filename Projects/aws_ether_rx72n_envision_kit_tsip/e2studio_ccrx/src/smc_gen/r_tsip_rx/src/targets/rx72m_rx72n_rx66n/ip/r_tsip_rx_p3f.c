...
*******************************************************************************************************************/ /**
* @details       RX72M TLS1.3 Application Traffic Key Update for Server
* @param[in]     InData_Cmd
...
e_tsip_err_t R_TSIP_Tls13SVUpdateApplicationTrafficKeySub(uint32_t *InData_Cmd, uint32_t *InData_UpdateKeyType, uint32_t *InData_Handle, uint32_t *InData_ApplicationSecretKeyIndex, uint32_t *OutData_ApplicationSecretKeyIndex, uint32_t *OutData_ApplicationWriteKeyIndex)
{
    ...
    {
        RX72M_RX72N_RX66N_func102(change_endian_long(0x8014c95au), change_endian_long(0xb115a081u), change_endian_long(0xb141a44au), change_endian_long(0xad596ed4u));
    ...
    {
        RX72M_RX72N_RX66N_func100(change_endian_long(0x00284697u), change_endian_long(0xa2204404u), change_endian_long(0xa6524965u), change_endian_long(0xe8b776a7u));
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0x19b1f61au), change_endian_long(0x9e6c4fdau), change_endian_long(0x42586ab6u), change_endian_long(0xdf1a3ff1u));
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0x89f536d7u), change_endian_long(0xbc75dae9u), change_endian_long(0x55c308aau), change_endian_long(0x2b6ab5cdu));
        TSIP.REG_E0H.WORD = 0x81040280u;
        ...
        RX72M_RX72N_RX66N_func102(change_endian_long(0xa928472cu), change_endian_long(0xf7de7416u), change_endian_long(0xc39196a2u), change_endian_long(0x76134715u));
        TSIP.REG_1BCH.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_p3f_r1.prc
 *********************************************************************************************************************/
