...
/***********************************************************************************************************************
* Function Name: R_TSIP_Arc4EncryptDecryptUpdateSub
*******************************************************************************************************************/ /**
* @details       RX72M ARC4 Encryption/Decryption Update
...
void R_TSIP_Arc4EncryptDecryptUpdateSub(uint32_t *InData_Text, uint32_t *OutData_Text, uint32_t MAX_CNT)
{
    ...
    (void)KEY_ADR;
    (void)OFS_ADR;
    RX72M_RX72N_RX66N_func100(change_endian_long(0x6efdfef0u), change_endian_long(0x716e9e2fu), change_endian_long(0x9eaa1a1fu), change_endian_long(0x55f8cfe5u));
    ...
    RX72M_RX72N_RX66N_func101(change_endian_long(0x0481c99fu), change_endian_long(0x39bd1362u), change_endian_long(0x9ee46633u), change_endian_long(0x7878adf5u));
}
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_pd6u_r1.prc
 *********************************************************************************************************************/
