...
*******************************************************************************************************************/ /**
* @details       RX72M Update 256bit AES Key
* @param[in]     InData_IV
...
e_tsip_err_t R_TSIP_UpdateAes256KeyIndexSub(uint32_t *InData_IV, uint32_t *InData_InstData, uint32_t *OutData_KeyIndex)
{
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0x593a352du), change_endian_long(0x51e482b6u), change_endian_long(0xb6ec27cbu), change_endian_long(0xbdfd1f78u));
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0x0e86f1bdu), change_endian_long(0xd8a7d2d8u), change_endian_long(0x61a62d56u), change_endian_long(0xf74aea14u));
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0x7b592baeu), change_endian_long(0xd879af65u), change_endian_long(0x44219c3au), change_endian_long(0x63661e35u));
    TSIP.REG_104H.WORD = 0x00000361u;
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0x43d47deeu), change_endian_long(0xc98d503fu), change_endian_long(0x0da3e572u), change_endian_long(0xbe1e3559u));
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0xf62da93bu), change_endian_long(0x497c617bu), change_endian_long(0xa3e4235au), change_endian_long(0xc6efa310u));
    TSIP.REG_104H.WORD = 0x00000052u;
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX72M_RX72N_RX66N_func100(change_endian_long(0x4840c2b8u), change_endian_long(0x93b84e4eu), change_endian_long(0x36e4f192u), change_endian_long(0x5efe9d81u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX72M_RX72N_RX66N_func102(change_endian_long(0x6f1882f1u), change_endian_long(0x52fd6079u), change_endian_long(0xb8cf528du), change_endian_long(0xbd9ef52du));
    ...
    {
        RX72M_RX72N_RX66N_func100(change_endian_long(0xd93380e9u), change_endian_long(0x9f315490u), change_endian_long(0xed156d00u), change_endian_long(0x88728168u));
        TSIP.REG_E0H.WORD = 0x81040000u;
        ...
        RX72M_RX72N_RX66N_func102(change_endian_long(0x6f431801u), change_endian_long(0x22faf62au), change_endian_long(0x8e213382u), change_endian_long(0xacebdcb7u));
        TSIP.REG_1B4H.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_p06.prc
 *********************************************************************************************************************/
