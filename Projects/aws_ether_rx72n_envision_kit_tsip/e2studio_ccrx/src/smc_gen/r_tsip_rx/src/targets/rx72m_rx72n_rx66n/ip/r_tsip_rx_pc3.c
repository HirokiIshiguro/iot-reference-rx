...
e_tsip_err_t R_TSIP_TlsSVDecryptPreMasterSecretSub(uint32_t *InData_KeyIndex, uint32_t *InData_PreMasterSecret, uint32_t *OutData_PreMasterSecret)
{
    ...
    {
        RX72M_RX72N_RX66N_func102(change_endian_long(0x2f197d44u), change_endian_long(0x59873803u), change_endian_long(0xd821012cu), change_endian_long(0xc839b9d5u));
    ...
    {
        RX72M_RX72N_RX66N_func100(change_endian_long(0xf3a866a3u), change_endian_long(0xd8b2b334u), change_endian_long(0x37f518f4u), change_endian_long(0x50ec8834u));
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0xfb4bbc6du), change_endian_long(0x65a21815u), change_endian_long(0x5f8a5ee9u), change_endian_long(0xc8a3ca61u));
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0x5d946719u), change_endian_long(0xaa97fc27u), change_endian_long(0x3e4bf319u), change_endian_long(0xec6aa272u));
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0xcb22e0ffu), change_endian_long(0x6d14b1e5u), change_endian_long(0x2b85c623u), change_endian_long(0x85dd914du));
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0x7709cb5fu), change_endian_long(0x87831f5eu), change_endian_long(0x5ff3521cu), change_endian_long(0xbd842790u));
        TSIP.REG_104H.WORD = 0x00000052u;
        ...
        RX72M_RX72N_RX66N_func102(change_endian_long(0xd6e451bbu), change_endian_long(0x89dce89cu), change_endian_long(0x4c77b1ebu), change_endian_long(0x1f86a6f1u));
        TSIP.REG_1BCH.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_pc3.prc
 *********************************************************************************************************************/
