...
/***********************************************************************************************************************
* Function Name: R_TSIP_GenerateTlsP256EccKeyIndexSub
*******************************************************************************************************************/ /**
* @details       RX72M TLS P-256 ECC Key Generation
...
* @note          None
*/
e_tsip_err_t R_TSIP_GenerateTlsP256EccKeyIndexSub(const uint32_t *InData_DomainParam, uint32_t *OutData_KeyIndex, uint32_t *OutData_PubKey)
{
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0xb10bc9e3u), change_endian_long(0xc7ea584du), change_endian_long(0xfd237c8fu), change_endian_long(0x43b56cc4u));
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0xba5e806au), change_endian_long(0x6e97f792u), change_endian_long(0xfb4f61cbu), change_endian_long(0xcb26d515u));
    RX72M_RX72N_RX66N_func103();
    TSIP.REG_104H.WORD = 0x00000052u;
    TSIP.REG_C4H.WORD = 0x01000c84u;
    /* WAIT_LOOP */
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX72M_RX72N_RX66N_func100(change_endian_long(0x407afe05u), change_endian_long(0x4ae08941u), change_endian_long(0x6126f689u), change_endian_long(0x84e351ccu));
    RX72M_RX72N_RX66N_func103();
    TSIP.REG_104H.WORD = 0x00000052u;
    TSIP.REG_C4H.WORD = 0x01000c84u;
    /* WAIT_LOOP */
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0x5290532au), change_endian_long(0xc00c7464u), change_endian_long(0x79a41cddu), change_endian_long(0xdfe9bb47u));
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0xe3c9efcau), change_endian_long(0x8a6c4646u), change_endian_long(0x3fd9516eu), change_endian_long(0x30d3b4bcu));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX72M_RX72N_RX66N_func102(change_endian_long(0xaa2eba2fu), change_endian_long(0x250aeb44u), change_endian_long(0xb8d6ce1au), change_endian_long(0x9e58a27du));
    ...
    {
        RX72M_RX72N_RX66N_func100(change_endian_long(0xbc4cfb7au), change_endian_long(0x70d08138u), change_endian_long(0x38f6d39du), change_endian_long(0x41f19dabu));
        ...
        TSIP.REG_100H.WORD = change_endian_long(0x39020100u);
        RX72M_RX72N_RX66N_func100(change_endian_long(0x9ac36650u), change_endian_long(0xd1d88f0du), change_endian_long(0xcbe51d94u), change_endian_long(0x29ef87aeu));
        RX72M_RX72N_RX66N_func103();
        RX72M_RX72N_RX66N_func100(change_endian_long(0x4afaeda8u), change_endian_long(0xfcedfab3u), change_endian_long(0x3349996au), change_endian_long(0x6191aa61u));
        TSIP.REG_104H.WORD = 0x00000052u;
        TSIP.REG_C4H.WORD = 0x01000c84u;
        /* WAIT_LOOP */
        while (1u != TSIP.REG_104H.BIT.B31)
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0xd31f7adeu), change_endian_long(0x0f38b742u), change_endian_long(0x22cd497au), change_endian_long(0xd32c9051u));
        TSIP.REG_104H.WORD = 0x00000052u;
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0x23e40302u), change_endian_long(0x241d0123u), change_endian_long(0xe8aa3305u), change_endian_long(0xebb721f9u));
        TSIP.REG_E0H.WORD = 0x81040000u;
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0xe19eb8e3u), change_endian_long(0xc9d15962u), change_endian_long(0xb8e739d9u), change_endian_long(0x44b9d293u));
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0x166664aeu), change_endian_long(0xd051537cu), change_endian_long(0xa7b4c24au), change_endian_long(0xf5f836bfu));
        ...
        RX72M_RX72N_RX66N_func102(change_endian_long(0xea67cee2u), change_endian_long(0x954b8a57u), change_endian_long(0xf1adfdb9u), change_endian_long(0x9b901dc5u));
        TSIP.REG_1B8H.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_pe9_r1.prc
 *********************************************************************************************************************/
