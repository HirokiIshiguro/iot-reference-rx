...
/***********************************************************************************************************************
* Function Name: R_TSIP_Tls13GenerateHandshakeSecretSub
*******************************************************************************************************************/ /**
* @details       RX72M TLS1.3 Handshake Secret Generation
...
* @note          None
*/
e_tsip_err_t R_TSIP_Tls13GenerateHandshakeSecretSub(uint32_t *InData_SharedSecretKeyIndex, uint32_t *OutData_Handshake_SecretKeyIndex)
{
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX72M_RX72N_RX66N_func100(change_endian_long(0xc5f4c5edu), change_endian_long(0x1ce3d30au), change_endian_long(0xb077254fu), change_endian_long(0x36a7e871u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX72M_RX72N_RX66N_func102(change_endian_long(0xf1ede19au), change_endian_long(0x0821731du), change_endian_long(0x7e70bcf0u), change_endian_long(0x7430fef3u));
    ...
    else
    {
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0x81394afau), change_endian_long(0x2bfde3abu), change_endian_long(0x62f5ff73u), change_endian_long(0xd496f957u));
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0x4364ecf1u), change_endian_long(0x5db9da50u), change_endian_long(0x032471dfu), change_endian_long(0xee064112u));
        TSIP.REG_E0H.WORD = 0x81040280u;
        ...
        RX72M_RX72N_RX66N_func102(change_endian_long(0x6df62d32u), change_endian_long(0xef7653ebu), change_endian_long(0x47549f9fu), change_endian_long(0x7ca29e60u));
        TSIP.REG_1BCH.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_pec_r1.prc
 *********************************************************************************************************************/
