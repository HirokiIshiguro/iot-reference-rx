...
*******************************************************************************************************************/ /**
* @details       RX72M RSA-4096 Public Key Update
* @param[in]     InData_IV
...
e_tsip_err_t R_TSIP_UpdateRsa4096PublicKeyIndexSub(uint32_t *InData_IV, uint32_t *InData_InstData, uint32_t *OutData_KeyIndex)
{
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0x345f6fa4u), change_endian_long(0x1b27f6acu), change_endian_long(0xbc4ee5e6u), change_endian_long(0xf72a41a7u));
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0x907fdc87u), change_endian_long(0x67a82f16u), change_endian_long(0x4335309du), change_endian_long(0x1e905e60u));
    TSIP.REG_104H.WORD = 0x00000361u;
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0xaed490e5u), change_endian_long(0xae2a2a8cu), change_endian_long(0x54c15a7bu), change_endian_long(0x0aa57702u));
    TSIP.REG_104H.WORD = 0x00000361u;
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0xfdc72366u), change_endian_long(0x013d136du), change_endian_long(0x3d02a0ccu), change_endian_long(0xda7b02fcu));
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0x2650b3a7u), change_endian_long(0xaa7535e8u), change_endian_long(0x7ec9ce46u), change_endian_long(0xf608dcaau));
    TSIP.REG_00H.WORD = 0x00012103u;
    TSIP.REG_104H.WORD = 0x00000031u;
    TSIP.REG_B0H.WORD = 0x00000f00u;
    TSIP.REG_A4H.WORD = 0x00d0c9a7u;
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0x864211e3u), change_endian_long(0x872f3e89u), change_endian_long(0x9a840e2du), change_endian_long(0x7e6b0f13u));
    TSIP.REG_104H.WORD = 0x00000361u;
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0xff141039u), change_endian_long(0x449e5f42u), change_endian_long(0xe37e9321u), change_endian_long(0xd30bcda9u));
    TSIP.REG_104H.WORD = 0x00000052u;
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX72M_RX72N_RX66N_func100(change_endian_long(0xa95d265bu), change_endian_long(0x8458de0cu), change_endian_long(0x975f847bu), change_endian_long(0x9d2f8c71u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX72M_RX72N_RX66N_func102(change_endian_long(0x1b3b9f5au), change_endian_long(0xf5d9b03cu), change_endian_long(0x51700313u), change_endian_long(0x70cff13au));
    ...
    {
        RX72M_RX72N_RX66N_func100(change_endian_long(0x004cc9abu), change_endian_long(0x32116945u), change_endian_long(0x35f185d8u), change_endian_long(0x677a048du));
        TSIP.REG_E0H.WORD = 0x81040000u;
        ...
        RX72M_RX72N_RX66N_func102(change_endian_long(0x80654eeau), change_endian_long(0x90c21c3fu), change_endian_long(0x27259b1cu), change_endian_long(0xa2ef8890u));
        TSIP.REG_1B4H.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_pad.prc
 *********************************************************************************************************************/
