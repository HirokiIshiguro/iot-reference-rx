...
*******************************************************************************************************************/ /**
* @details       RX72M TLS1.3 Resumption/0-RTT Handshake Secret Generation for Server
...
e_tsip_err_t R_TSIP_Tls13SVGenerateResumptionHandshakeSecretSub(uint32_t *InData_Handle, uint32_t *InData_SharedSecretKeyIndexType, uint32_t *InData_PreSharedKeyIndex, uint32_t *InData_SharedSecretKeyIndex, uint32_t *OutData_Handshake_SecretKeyIndex)
{
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0x0e4fa1cdu), change_endian_long(0xc7f28a13u), change_endian_long(0x28ff4c62u), change_endian_long(0xc0290331u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX72M_RX72N_RX66N_func102(change_endian_long(0x7c74940cu), change_endian_long(0xca11ee3bu), change_endian_long(0x76f375e0u), change_endian_long(0xddff83c5u));
    ...
    else
    {
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0xe8908738u), change_endian_long(0xe75abcafu), change_endian_long(0xae4e20ecu), change_endian_long(0xe61ee38au));
        TSIP.REG_1CH.WORD = 0x00400000u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            RX72M_RX72N_RX66N_func102(change_endian_long(0xbff79182u), change_endian_long(0x00202c7du), change_endian_long(0x4db2576cu), change_endian_long(0x39812deau));
            TSIP.REG_1BCH.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
        ...
        else
        {
            ...
            TSIP.REG_1CH.WORD = 0x00001800u;
            RX72M_RX72N_RX66N_func100(change_endian_long(0x667f0590u), change_endian_long(0x40e223bfu), change_endian_long(0x42c9ed9cu), change_endian_long(0x50cb022bu));
            TSIP.REG_1CH.WORD = 0x00400000u;
            TSIP.REG_1D0H.WORD = 0x00000000u;
            if (1u == (TSIP.REG_1CH.BIT.B22))
            {
                RX72M_RX72N_RX66N_func102(change_endian_long(0x7c0423b7u), change_endian_long(0x99b64040u), change_endian_long(0x9d91f4c8u), change_endian_long(0x6bb0171fu));
                TSIP.REG_1BCH.WORD = 0x00000040u;
                /* WAIT_LOOP */
                while (0u != TSIP.REG_18H.BIT.B12)
                {
            ...
            else
            {
                ...
                TSIP.REG_1CH.WORD = 0x00001800u;
                RX72M_RX72N_RX66N_func100(change_endian_long(0xab5b74d5u), change_endian_long(0x621c2190u), change_endian_long(0xcfea5274u), change_endian_long(0x4c50fcd7u));
                TSIP.REG_1CH.WORD = 0x00400000u;
                TSIP.REG_1D0H.WORD = 0x00000000u;
                if (1u == (TSIP.REG_1CH.BIT.B22))
                {
                    RX72M_RX72N_RX66N_func102(change_endian_long(0xa9cd9a4cu), change_endian_long(0x515f671eu), change_endian_long(0x151bdacfu), change_endian_long(0xe6eeb8d1u));
                    TSIP.REG_1BCH.WORD = 0x00000040u;
                    /* WAIT_LOOP */
                    while (0u != TSIP.REG_18H.BIT.B12)
                    {
                ...
                else
                {
                    ...
                    TSIP.REG_28H.WORD = 0x008f0001u;
                    RX72M_RX72N_RX66N_func070();
                    RX72M_RX72N_RX66N_func100(change_endian_long(0x144e61f6u), change_endian_long(0x426d42a7u), change_endian_long(0x2dd7feefu), change_endian_long(0xa1e147e4u));
                    ...
                    RX72M_RX72N_RX66N_func100(change_endian_long(0x29b02fdau), change_endian_long(0xf028fcdfu), change_endian_long(0x2888d8b3u), change_endian_long(0x22b7d558u));
                    TSIP.REG_E0H.WORD = 0x81040280u;
                    ...
                    RX72M_RX72N_RX66N_func102(change_endian_long(0xd23beb52u), change_endian_long(0xea60589eu), change_endian_long(0xa5798709u), change_endian_long(0x39c5a5fbu));
                    TSIP.REG_1BCH.WORD = 0x00000040u;
                    /* WAIT_LOOP */
                    while (0u != TSIP.REG_18H.BIT.B12)
                    {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_pba_r1.prc
 *********************************************************************************************************************/
