...
*******************************************************************************************************************/ /**
* @details       RX72M ARC4 Encryption/Decryption Init
...
e_tsip_err_t R_TSIP_Arc4EncryptDecryptInitSub(uint32_t *InData_KeyIndex)
{
    ...
    {
        RX72M_RX72N_RX66N_func102(change_endian_long(0xf82fcc7bu), change_endian_long(0x18a4b625u), change_endian_long(0xcdd26985u), change_endian_long(0x453e83beu));
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_pd6i.prc
 *********************************************************************************************************************/
