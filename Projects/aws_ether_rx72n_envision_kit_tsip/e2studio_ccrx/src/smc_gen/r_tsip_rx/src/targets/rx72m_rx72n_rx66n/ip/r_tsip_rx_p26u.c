...
e_tsip_err_t R_TSIP_VerifyFirmwareMacUpdateSub(uint32_t *InData_Program, uint32_t MAX_CNT)
{
    ...
    RX72M_RX72N_RX66N_func101(change_endian_long(0x4a92c595u), change_endian_long(0x04ac836au), change_endian_long(0xd47b2948u), change_endian_long(0x4babcc38u));
    return TSIP_SUCCESS;
}
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_p26u.prc
 *********************************************************************************************************************/
TSIP_SEC_DEFAULT
