...
void R_TSIP_TlsGenerateSubSub(void)
{
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0x4bd89d05u), change_endian_long(0x311e1006u), change_endian_long(0x72a09168u), change_endian_long(0xf7786490u));
    ...
    for (iLoop = 0; iLoop < S_RAM[0]; iLoop = iLoop + 1)
    {
        ...
        RX72M_RX72N_RX66N_func101(change_endian_long(0x170493d8u), change_endian_long(0xbeb6add2u), change_endian_long(0x4c06811cu), change_endian_long(0xd46ec3dau));
    }
    TSIP.REG_ECH.WORD = 0x00007c0du;
    TSIP.REG_1CH.WORD = 0x00602000u;
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX72M_RX72N_RX66N_func100(change_endian_long(0x7ed8ddb5u), change_endian_long(0x411c9e86u), change_endian_long(0x5b03d595u), change_endian_long(0x4401e5bcu));
    TSIP.REG_ECH.WORD = 0x00007c01u;
    TSIP.REG_1CH.WORD = 0x00600000u;
}
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_subprc04.prc
 *********************************************************************************************************************/
