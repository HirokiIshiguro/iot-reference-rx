...
*******************************************************************************************************************/ /**
* @details       RX72M TLS RSA Key Install for Server
...
e_tsip_err_t R_TSIP_GenerateTlsSVRsaInstallDataSub(uint32_t *InData_SharedKeyIndex, uint32_t *InData_SessionKey, uint32_t *InData_IV, uint32_t *InData_InstData, uint32_t *OutData_InstData)
{
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0xc57dd746u), change_endian_long(0xd4ee98e5u), change_endian_long(0x70954e8au), change_endian_long(0x52ff5b30u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX72M_RX72N_RX66N_func102(change_endian_long(0x868afaa3u), change_endian_long(0x953c64cbu), change_endian_long(0xc93c945bu), change_endian_long(0x255f2323u));
    ...
    {
        RX72M_RX72N_RX66N_func100(change_endian_long(0x1897cf93u), change_endian_long(0xf8f1be20u), change_endian_long(0x08a6cd72u), change_endian_long(0xc82ad9dcu));
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0x04ac1ca7u), change_endian_long(0xcdb3b1e5u), change_endian_long(0x4f6a112bu), change_endian_long(0x2869f328u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0xeb287755u), change_endian_long(0x8b211242u), change_endian_long(0x29b4f921u), change_endian_long(0x85f7658eu));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0xc5ec6a94u), change_endian_long(0xb3796588u), change_endian_long(0x87f4fda5u), change_endian_long(0x83ede97eu));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0x1803e289u), change_endian_long(0x76bdd61fu), change_endian_long(0xc275fb05u), change_endian_long(0x3116d3bcu));
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0x471eec15u), change_endian_long(0x6688f441u), change_endian_long(0xf5ca1436u), change_endian_long(0xdbb9ce22u));
        TSIP.REG_00H.WORD = 0x00012303u;
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0x260faf4cu), change_endian_long(0x1f2b0c53u), change_endian_long(0x2cc58e01u), change_endian_long(0xba307d47u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        OutData_InstData[4+jLoop + 2] = TSIP.REG_100H.WORD;
        OutData_InstData[4+jLoop + 3] = TSIP.REG_100H.WORD;
        RX72M_RX72N_RX66N_func100(change_endian_long(0x3027cff0u), change_endian_long(0x7da35084u), change_endian_long(0xf8fadce0u), change_endian_long(0xea136cf2u));
        ...
        TSIP.REG_1CH.WORD = 0x00001800u;
        RX72M_RX72N_RX66N_func100(change_endian_long(0x28a0a34bu), change_endian_long(0x27602014u), change_endian_long(0x1e1d9ad3u), change_endian_long(0x66c965d7u));
        TSIP.REG_1CH.WORD = 0x00400000u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            RX72M_RX72N_RX66N_func102(change_endian_long(0xd4cee7ffu), change_endian_long(0xd82cf25fu), change_endian_long(0x24aa1b41u), change_endian_long(0xedae2912u));
            TSIP.REG_1BCH.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
        ...
        {
            RX72M_RX72N_RX66N_func100(change_endian_long(0x0e19f29du), change_endian_long(0x51d37bc8u), change_endian_long(0xf61bb558u), change_endian_long(0x28d7cf25u));
            TSIP.REG_104H.WORD = 0x00000052u;
            ...
            RX72M_RX72N_RX66N_func102(change_endian_long(0x551327eau), change_endian_long(0x42ee581au), change_endian_long(0x2089db27u), change_endian_long(0x96785c87u));
            TSIP.REG_1BCH.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_pbf.prc
 *********************************************************************************************************************/
