...
/***********************************************************************************************************************
* Function Name: RX72M_RX72N_RX66N_func032
*******************************************************************************************************************/ /**
* @details       RX72M PRF1 function of TLS - subprocedure 04
* @note          None
*/
void RX72M_RX72N_RX66N_func032(void)
{
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0x52f75765u), change_endian_long(0x87d1ce36u), change_endian_long(0x9e959971u), change_endian_long(0x8091c197u));
    ...
    for (iLoop = 0; iLoop < S_RAM[0]; iLoop = iLoop + 1)
    {
        ...
        RX72M_RX72N_RX66N_func101(change_endian_long(0x8198397fu), change_endian_long(0x110e92eau), change_endian_long(0x6d18c329u), change_endian_long(0xc9007ce2u));
    }
    TSIP.REG_ECH.WORD = 0x00007c0du;
    TSIP.REG_1CH.WORD = 0x00602000u;
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX72M_RX72N_RX66N_func100(change_endian_long(0x71e12d10u), change_endian_long(0x4b243851u), change_endian_long(0xa4a29b43u), change_endian_long(0x5a7c3043u));
    TSIP.REG_ECH.WORD = 0x00007c01u;
    TSIP.REG_1CH.WORD = 0x00600000u;
}
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_func032.prc
 *********************************************************************************************************************/
