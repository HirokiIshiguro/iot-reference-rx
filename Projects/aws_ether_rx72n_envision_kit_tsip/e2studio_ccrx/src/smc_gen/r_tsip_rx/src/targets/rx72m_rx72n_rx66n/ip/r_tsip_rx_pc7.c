...
e_tsip_err_t R_TSIP_TlsSVGenerateSessionKeySub(uint32_t *InData_Sel_CipherSuite, uint32_t *InData_MasterSecret, uint32_t *InData_ClientRandom, uint32_t *InData_ServerRandom, uint32_t *InData_MAC, uint32_t *InData_NonceExplicit, uint32_t *OutData_ClientMACKeyOperationCode, uint32_t *OutData_ServerMACKeyOperationCode, uint32_t *OutData_ClientEncKeyOperationCode, uint32_t *OutData_ServerEncKeyOperationCode, uint32_t* OutData_ClientIV, uint32_t* OutData_ServerIV)
{
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX72M_RX72N_RX66N_func100(change_endian_long(0x90916eadu), change_endian_long(0x2f7cc86du), change_endian_long(0x6412f653u), change_endian_long(0xc0c11014u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX72M_RX72N_RX66N_func102(change_endian_long(0xc4eb08c4u), change_endian_long(0x75f76b43u), change_endian_long(0xf0ae7239u), change_endian_long(0x0ca8df04u));
    ...
    else
    {
        ...
        TSIP.REG_100H.WORD = change_endian_long(0x80100000u);
        /* WAIT_LOOP */
        while (1u != TSIP.REG_104H.BIT.B31)
        {
            /* waiting */
        }
        TSIP.REG_100H.WORD = change_endian_long(0x80200000u);
        /* WAIT_LOOP */
        while (1u != TSIP.REG_104H.BIT.B31)
        {
            /* waiting */
        }
        TSIP.REG_100H.WORD = change_endian_long(0x80400000u);
        /* WAIT_LOOP */
        while (1u != TSIP.REG_104H.BIT.B31)
        {
            /* waiting */
        }
        TSIP.REG_100H.WORD = change_endian_long(0x80800000u);
        /* WAIT_LOOP */
        while (1u != TSIP.REG_104H.BIT.B31)
        {
            /* waiting */
        ...
        TSIP.REG_100H.WORD = change_endian_long(0x000000c7u);
        RX72M_RX72N_RX66N_func101(change_endian_long(0xbc11281du), change_endian_long(0x5461e718u), change_endian_long(0x4ec3b68fu), change_endian_long(0xfdd81766u));
        RX72M_RX72N_RX66N_func404(InData_Sel_CipherSuite, InData_MasterSecret, InData_ClientRandom, InData_NonceExplicit, OutData_ClientMACKeyOperationCode, OutData_ServerMACKeyOperationCode, OutData_ClientEncKeyOperationCode, OutData_ServerEncKeyOperationCode, OutData_ClientIV, OutData_ServerIV);
        TSIP.REG_ECH.WORD = 0x38000c00u;
        TSIP.REG_E0H.WORD = 0x00000080u;
        TSIP.REG_1CH.WORD = 0x00A60000u;
        RX72M_RX72N_RX66N_func100(change_endian_long(0x8a00b746u), change_endian_long(0x33053903u), change_endian_long(0x44006e3bu), change_endian_long(0x980e13d4u));
        TSIP.REG_1CH.WORD = 0x00400000u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            RX72M_RX72N_RX66N_func102(change_endian_long(0xd536afacu), change_endian_long(0x774dab07u), change_endian_long(0xa664e79eu), change_endian_long(0xd4383f86u));
            TSIP.REG_1BCH.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
        ...
        {
            RX72M_RX72N_RX66N_func102(change_endian_long(0x97d454f8u), change_endian_long(0x388fd837u), change_endian_long(0x6385736fu), change_endian_long(0xabd4ddbcu));
            TSIP.REG_1BCH.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_pc7_r1.prc
 *********************************************************************************************************************/
