...
/***********************************************************************************************************************
* Function Name: R_TSIP_Sha1GenerateMessageDigestSub
*******************************************************************************************************************/ /**
* @details       RX72M SHA-1 Message Digest Generation
* @param[in]     InData_SHA1InitVal
...
* @note          None
*/
e_tsip_err_t R_TSIP_Sha1GenerateMessageDigestSub(uint32_t *InData_SHA1InitVal, uint32_t *InData_PaddedMsg, uint32_t MAX_CNT, uint32_t *OutData_MsgDigest)
{
    ...
    TSIP.REG_84H.WORD = 0x00007101u;
    TSIP.REG_108H.WORD = 0x00000000u;
    RX72M_RX72N_RX66N_func100(change_endian_long(0x220d6e1fu), change_endian_long(0xad6cfeb8u), change_endian_long(0x14690c5bu), change_endian_long(0x7dd370dau));
    ...
    TSIP.REG_100H.WORD = InData_SHA1InitVal[0];
    TSIP.REG_100H.WORD = InData_SHA1InitVal[1];
    TSIP.REG_100H.WORD = InData_SHA1InitVal[2];
    TSIP.REG_100H.WORD = InData_SHA1InitVal[3];
    TSIP.REG_100H.WORD = InData_SHA1InitVal[4];
    ...
    RX72M_RX72N_RX66N_func102(change_endian_long(0xeea884deu), change_endian_long(0x999599f9u), change_endian_long(0xac319be0u), change_endian_long(0xf3d187d9u));
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_p71.prc
 *********************************************************************************************************************/
#endif /* #if TSIP_SHA_1 == 1 */
TSIP_SEC_DEFAULT
