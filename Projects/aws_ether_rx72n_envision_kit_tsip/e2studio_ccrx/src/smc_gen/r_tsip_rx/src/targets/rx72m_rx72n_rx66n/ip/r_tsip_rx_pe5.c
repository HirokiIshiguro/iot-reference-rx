...
e_tsip_err_t R_TSIP_TlsGenerateSessionKeySub(uint32_t *InData_Sel_CipherSuite, uint32_t *InData_MasterSecret, uint32_t *InData_ClientRandom, uint32_t *InData_ServerRandom, uint32_t *InData_NonceExplicit, uint32_t *OutData_ClientMACKeyOperationCode, uint32_t *OutData_ServerMACKeyOperationCode, uint32_t *OutData_ClientEncKeyOperationCode, uint32_t *OutData_ServerEncKeyOperationCode, uint32_t* OutData_ClientIV, uint32_t* OutData_ServerIV)
{
    ...
    RX72M_RX72N_RX66N_func101(change_endian_long(0x32ed25c9u), change_endian_long(0xedc6633cu), change_endian_long(0x9bb2addbu), change_endian_long(0xa62595b3u));
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0xe6c7014bu), change_endian_long(0x253490afu), change_endian_long(0x8f853fd4u), change_endian_long(0x4949b857u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX72M_RX72N_RX66N_func102(change_endian_long(0xb5a6c85cu), change_endian_long(0x56b4f094u), change_endian_long(0x457014c2u), change_endian_long(0x40498827u));
    ...
    {
        RX72M_RX72N_RX66N_func102(change_endian_long(0x1c3b6582u), change_endian_long(0xab15771bu), change_endian_long(0xa90e0ad2u), change_endian_long(0x594f295au));
        TSIP.REG_1BCH.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_pe5_r2.prc
 *********************************************************************************************************************/
#endif /* #if TSIP_TLS == 1 */
