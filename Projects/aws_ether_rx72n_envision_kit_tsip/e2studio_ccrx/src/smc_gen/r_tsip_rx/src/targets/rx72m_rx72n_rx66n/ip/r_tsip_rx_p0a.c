...
e_tsip_err_t R_TSIP_UpdateTdesKeyIndexSub(uint32_t *InData_IV, uint32_t *InData_InstData, uint32_t *OutData_KeyIndex)
{
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0xd7ece51cu), change_endian_long(0xffd2eee7u), change_endian_long(0x71c0bb79u), change_endian_long(0xd59e21d2u));
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0x925c2037u), change_endian_long(0xeaaeea9fu), change_endian_long(0xc838ac75u), change_endian_long(0x30f69fadu));
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0x581f6301u), change_endian_long(0x85b3ab82u), change_endian_long(0x2b06e4c0u), change_endian_long(0x3b4b3b85u));
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0xa1a7474bu), change_endian_long(0x0ab2b932u), change_endian_long(0xc2982686u), change_endian_long(0x5c56eb79u));
    TSIP.REG_104H.WORD = 0x00000052u;
    ...
    {
        RX72M_RX72N_RX66N_func102(change_endian_long(0x2b5f3fa1u), change_endian_long(0x29ccd93cu), change_endian_long(0x05865d53u), change_endian_long(0x28d5857cu));
    ...
    {
        RX72M_RX72N_RX66N_func100(change_endian_long(0x4193de97u), change_endian_long(0xa890ba25u), change_endian_long(0x1fa84ecau), change_endian_long(0x27797140u));
        TSIP.REG_E0H.WORD = 0x81040000u;
        ...
        RX72M_RX72N_RX66N_func102(change_endian_long(0x625d5ef5u), change_endian_long(0xa5e9ac82u), change_endian_long(0x116018fau), change_endian_long(0xf3048775u));
        TSIP.REG_1B4H.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_p0a.prc
 *********************************************************************************************************************/
