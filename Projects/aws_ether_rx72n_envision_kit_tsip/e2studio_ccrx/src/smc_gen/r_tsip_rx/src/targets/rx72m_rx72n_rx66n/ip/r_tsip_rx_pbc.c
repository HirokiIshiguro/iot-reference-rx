...
/***********************************************************************************************************************
* Function Name: R_TSIP_Tls13SVGenerateResumptionMasterSecretSub
*******************************************************************************************************************/ /**
* @details       RX72M TLS1.3 Resumption MasterSecret Generation for Server
* @param[in]     InData_Cmd
...
* @note          None
*/
e_tsip_err_t R_TSIP_Tls13SVGenerateResumptionMasterSecretSub(uint32_t *InData_Cmd, uint32_t *InData_Handle, uint32_t *InData_Master_SecretKeyIndex, uint32_t *InData_MsgHash, uint32_t *OutData_RMaster_SecretKeyIndex)
{
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX72M_RX72N_RX66N_func100(change_endian_long(0xd9f7eb14u), change_endian_long(0x7b939a05u), change_endian_long(0xca5784ebu), change_endian_long(0x4ba6de42u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX72M_RX72N_RX66N_func102(change_endian_long(0xe020d22eu), change_endian_long(0xa7febc64u), change_endian_long(0xaeb8df54u), change_endian_long(0x41b9efc1u));
    ...
    else
    {
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0xd01bbfb9u), change_endian_long(0xcf1a35d7u), change_endian_long(0x952fd191u), change_endian_long(0x69e6d944u));
        TSIP.REG_C4H.WORD = 0x400c0b0cu;
        /* WAIT_LOOP */
        while (1u != TSIP.REG_104H.BIT.B31)
        {
        ...
        RX72M_RX72N_RX66N_func102(change_endian_long(0x2e65b9abu), change_endian_long(0xbe396b98u), change_endian_long(0xff6c1f05u), change_endian_long(0xf3b60039u));
        TSIP.REG_1BCH.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_pbc_r1.prc
 *********************************************************************************************************************/
