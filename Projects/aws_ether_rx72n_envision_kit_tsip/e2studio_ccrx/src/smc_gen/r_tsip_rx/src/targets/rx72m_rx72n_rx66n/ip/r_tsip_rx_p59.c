...
/***********************************************************************************************************************
* Function Name: R_TSIP_GenerateRsa1024PublicKeyIndexSub
*******************************************************************************************************************/ /**
* @details       RX72M Install 1024bit RSA Public Key
...
* @note          None
*/
e_tsip_err_t R_TSIP_GenerateRsa1024PublicKeyIndexSub(uint32_t *InData_SharedKeyIndex, uint32_t *InData_SessionKey, uint32_t *InData_IV, uint32_t *InData_InstData, uint32_t *OutData_KeyIndex)
{
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0x03c66e65u), change_endian_long(0xbb6f708cu), change_endian_long(0xf05517f0u), change_endian_long(0x38c64fc0u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX72M_RX72N_RX66N_func102(change_endian_long(0xdd2d7fb2u), change_endian_long(0xf8bb7a4au), change_endian_long(0xf3b96cf8u), change_endian_long(0xb772294eu));
    ...
    {
        RX72M_RX72N_RX66N_func100(change_endian_long(0xb5acf776u), change_endian_long(0x3ddc7967u), change_endian_long(0x6558920du), change_endian_long(0xef8d03f0u));
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0x1f9f7847u), change_endian_long(0x11f1c4dbu), change_endian_long(0x062b6448u), change_endian_long(0xd5f41881u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0xd66c9c20u), change_endian_long(0xc6325a46u), change_endian_long(0x679e9660u), change_endian_long(0x0a0dc43du));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0x3ed1867bu), change_endian_long(0x23ab3e31u), change_endian_long(0xc003d152u), change_endian_long(0xddf4ab4fu));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0x164bab99u), change_endian_long(0x3b6782b4u), change_endian_long(0xbcb28bd4u), change_endian_long(0xf50a54bau));
        ...
        TSIP.REG_1CH.WORD = 0x00001800u;
        RX72M_RX72N_RX66N_func100(change_endian_long(0x35a35405u), change_endian_long(0x469510ddu), change_endian_long(0xa0a3fc05u), change_endian_long(0x105319e5u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0x20cd5962u), change_endian_long(0x639b839du), change_endian_long(0xefeb3e22u), change_endian_long(0x56bfa062u));
        ...
        TSIP.REG_1CH.WORD = 0x00001800u;
        RX72M_RX72N_RX66N_func100(change_endian_long(0x2619fcf3u), change_endian_long(0x521f398au), change_endian_long(0x2ddf2154u), change_endian_long(0x56cf8d45u));
        TSIP.REG_104H.WORD = 0x00000052u;
        ...
        TSIP.REG_1CH.WORD = 0x00001800u;
        RX72M_RX72N_RX66N_func100(change_endian_long(0x51737469u), change_endian_long(0x9780e6abu), change_endian_long(0x6f876394u), change_endian_long(0x5dbeba69u));
        TSIP.REG_1CH.WORD = 0x00400000u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            RX72M_RX72N_RX66N_func102(change_endian_long(0xc5fcfe39u), change_endian_long(0x2dc2ea83u), change_endian_long(0xfd0164c8u), change_endian_long(0x01a4e88cu));
            TSIP.REG_1BCH.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
        ...
        {
            RX72M_RX72N_RX66N_func100(change_endian_long(0x17dbcb0du), change_endian_long(0x9604b263u), change_endian_long(0x21d9b0b8u), change_endian_long(0x92b38136u));
            TSIP.REG_E0H.WORD = 0x81040000u;
            ...
            RX72M_RX72N_RX66N_func102(change_endian_long(0xb8a31ed7u), change_endian_long(0xddd85801u), change_endian_long(0xd737cde1u), change_endian_long(0xa6daeaf2u));
            TSIP.REG_1BCH.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_p59.prc
 *********************************************************************************************************************/
