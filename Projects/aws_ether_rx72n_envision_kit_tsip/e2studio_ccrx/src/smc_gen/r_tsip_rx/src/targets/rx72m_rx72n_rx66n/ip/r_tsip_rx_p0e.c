...
*******************************************************************************************************************/ /**
* @details       RX72M Update 2048bit RSA Private Key
* @param[in]     InData_IV
...
e_tsip_err_t R_TSIP_UpdateRsa2048PrivateKeyIndexSub(uint32_t *InData_IV, uint32_t *InData_InstData, uint32_t *OutData_KeyIndex)
{
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0x186eb723u), change_endian_long(0xe3251a09u), change_endian_long(0xc8bee826u), change_endian_long(0x8cf651d1u));
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0xe367e089u), change_endian_long(0x50be300bu), change_endian_long(0x96bc1908u), change_endian_long(0x8d0ec313u));
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0x78b23392u), change_endian_long(0x8d1d859eu), change_endian_long(0xe1257037u), change_endian_long(0x4e6dce2du));
    TSIP.REG_104H.WORD = 0x00000361u;
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0xdff2c2dbu), change_endian_long(0xffec0a0cu), change_endian_long(0x10c6370bu), change_endian_long(0xe4a41a94u));
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX72M_RX72N_RX66N_func100(change_endian_long(0x827d5bd4u), change_endian_long(0x476399c7u), change_endian_long(0x87f05005u), change_endian_long(0x29c0c981u));
    TSIP.REG_00H.WORD = 0x00013103u;
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX72M_RX72N_RX66N_func100(change_endian_long(0x4fe3f0b8u), change_endian_long(0x3c34c2a5u), change_endian_long(0x317c7b51u), change_endian_long(0x427543c8u));
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX72M_RX72N_RX66N_func100(change_endian_long(0xb08a2633u), change_endian_long(0x1c6bcb8fu), change_endian_long(0x5df9fe55u), change_endian_long(0xc145753eu));
    TSIP.REG_104H.WORD = 0x00000052u;
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX72M_RX72N_RX66N_func100(change_endian_long(0x0d6abc19u), change_endian_long(0x05f1f040u), change_endian_long(0xdf1a5940u), change_endian_long(0x9ad5b92au));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX72M_RX72N_RX66N_func102(change_endian_long(0xcfc90fb7u), change_endian_long(0x74a712e9u), change_endian_long(0x342219beu), change_endian_long(0x311628a3u));
    ...
    {
        RX72M_RX72N_RX66N_func100(change_endian_long(0xdba3792fu), change_endian_long(0x4deafe6au), change_endian_long(0xfdd6c509u), change_endian_long(0x475084d2u));
        TSIP.REG_E0H.WORD = 0x81040000u;
        ...
        RX72M_RX72N_RX66N_func102(change_endian_long(0xd069b8e8u), change_endian_long(0x8b068842u), change_endian_long(0x022c19feu), change_endian_long(0xbd803d53u));
        TSIP.REG_1BCH.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_p0e_r1.prc
 *********************************************************************************************************************/
