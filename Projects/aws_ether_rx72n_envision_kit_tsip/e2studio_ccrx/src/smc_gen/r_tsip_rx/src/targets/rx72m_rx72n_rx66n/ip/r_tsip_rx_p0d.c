...
*******************************************************************************************************************/ /**
* @details       RX72M Update 2048bit RSA Public Key
* @param[in]     InData_IV
...
e_tsip_err_t R_TSIP_UpdateRsa2048PublicKeyIndexSub(uint32_t *InData_IV, uint32_t *InData_InstData, uint32_t *OutData_KeyIndex)
{
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0xec2e691bu), change_endian_long(0x182e359eu), change_endian_long(0x6310a704u), change_endian_long(0x537915acu));
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0xc641f0f4u), change_endian_long(0x10b8bc77u), change_endian_long(0xcc287124u), change_endian_long(0x80670e2fu));
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0x621ace48u), change_endian_long(0xb3c11baau), change_endian_long(0x651bab06u), change_endian_long(0xcdb98a0cu));
    TSIP.REG_104H.WORD = 0x00000361u;
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0xcd0f4f27u), change_endian_long(0xf5b80777u), change_endian_long(0x395812dbu), change_endian_long(0xc06155cfu));
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX72M_RX72N_RX66N_func100(change_endian_long(0xe603c72bu), change_endian_long(0xd3c5adceu), change_endian_long(0x801cc689u), change_endian_long(0x44a90044u));
    TSIP.REG_104H.WORD = 0x00000361u;
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0xf7ed977au), change_endian_long(0x248a4edeu), change_endian_long(0x1dbf3cf4u), change_endian_long(0xf80d8a39u));
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX72M_RX72N_RX66N_func100(change_endian_long(0xd954cabcu), change_endian_long(0x04f3b09au), change_endian_long(0xa4bd51fcu), change_endian_long(0x7f59d8bbu));
    TSIP.REG_104H.WORD = 0x00000052u;
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX72M_RX72N_RX66N_func100(change_endian_long(0x30fb9a64u), change_endian_long(0x4015286bu), change_endian_long(0x60d3170au), change_endian_long(0x42e4b500u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX72M_RX72N_RX66N_func102(change_endian_long(0x10d2d3ceu), change_endian_long(0xd1dfd5efu), change_endian_long(0x4b664ddbu), change_endian_long(0xde495290u));
    ...
    {
        RX72M_RX72N_RX66N_func100(change_endian_long(0x99858c09u), change_endian_long(0x32ed33c9u), change_endian_long(0xc30565eau), change_endian_long(0xfa13bb26u));
        TSIP.REG_E0H.WORD = 0x81040000u;
        ...
        RX72M_RX72N_RX66N_func102(change_endian_long(0xe5742802u), change_endian_long(0xe3437a0du), change_endian_long(0x8904d7e5u), change_endian_long(0x19bb2db4u));
        TSIP.REG_1BCH.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_p0d.prc
 *********************************************************************************************************************/
