...
*******************************************************************************************************************/ /**
* @details       RX72M HMAC-SHA1 Message Digest Generation Final
* @param[in]     InData_Cmd
* @param[in]     InData_MAC
...
e_tsip_err_t R_TSIP_Sha1HmacFinalSub(uint32_t *InData_Cmd, uint32_t *InData_MAC, uint32_t *InData_length, uint32_t *OutData_MAC)
{
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0x67ccb69du), change_endian_long(0x9968c587u), change_endian_long(0xf2b0d1acu), change_endian_long(0xdfe88e32u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX72M_RX72N_RX66N_func102(change_endian_long(0x618b64c3u), change_endian_long(0x1fb918b0u), change_endian_long(0xcdf8a24bu), change_endian_long(0x3ee0ce1eu));
    ...
    else
    {
        ...
        TSIP.REG_E0H.WORD = 0x00000080u;
        TSIP.REG_1CH.WORD = 0x00260000u;
        RX72M_RX72N_RX66N_func100(change_endian_long(0x1f8d3f82u), change_endian_long(0x7202cf4fu), change_endian_long(0x3c9d6f98u), change_endian_long(0x54a67826u));
        TSIP.REG_1CH.WORD = 0x00400000u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            RX72M_RX72N_RX66N_func100(change_endian_long(0x0bbb1874u), change_endian_long(0x4bb8ac4bu), change_endian_long(0x29c61d3du), change_endian_long(0xc642f18eu));
            TSIP.REG_74H.WORD = 0x00000008u;
            ...
            RX72M_RX72N_RX66N_func102(change_endian_long(0xff20b93du), change_endian_long(0xc602cff5u), change_endian_long(0xf082287au), change_endian_long(0x21e1cf19u));
            TSIP.REG_1BCH.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
        ...
        else
        {
            ...
            RX72M_RX72N_RX66N_func100(change_endian_long(0xff3ae3c3u), change_endian_long(0x2f402be7u), change_endian_long(0x5c207cd9u), change_endian_long(0xcd178941u));
            TSIP.REG_1CH.WORD = 0x00400000u;
            TSIP.REG_1D0H.WORD = 0x00000000u;
            if (1u == (TSIP.REG_1CH.BIT.B22))
            {
                RX72M_RX72N_RX66N_func102(change_endian_long(0xed458dfcu), change_endian_long(0x183db1d0u), change_endian_long(0xc31cf8adu), change_endian_long(0xc090d54du));
                TSIP.REG_1BCH.WORD = 0x00000040u;
                /* WAIT_LOOP */
                while (0u != TSIP.REG_18H.BIT.B12)
                {
            ...
            else
            {
                ...
                RX72M_RX72N_RX66N_func100(change_endian_long(0xeecb9b40u), change_endian_long(0x0190d4bbu), change_endian_long(0x2f201194u), change_endian_long(0xbb7f1a3au));
                TSIP.REG_1CH.WORD = 0x00400000u;
                TSIP.REG_1D0H.WORD = 0x00000000u;
                if (1u == (TSIP.REG_1CH.BIT.B22))
                {
                    RX72M_RX72N_RX66N_func102(change_endian_long(0x3342b6c3u), change_endian_long(0x2790fc82u), change_endian_long(0xa3c3e37bu), change_endian_long(0x6765b5d7u));
                    TSIP.REG_1BCH.WORD = 0x00000040u;
                    /* WAIT_LOOP */
                    while (0u != TSIP.REG_18H.BIT.B12)
                    {
                ...
                {
                    RX72M_RX72N_RX66N_func102(change_endian_long(0xc314852eu), change_endian_long(0x1f5f91cau), change_endian_long(0x90169a4eu), change_endian_long(0xbb1c8a48u));
                    TSIP.REG_1BCH.WORD = 0x00000040u;
                    /* WAIT_LOOP */
                    while (0u != TSIP.REG_18H.BIT.B12)
                    {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_p73f.prc
 *********************************************************************************************************************/
