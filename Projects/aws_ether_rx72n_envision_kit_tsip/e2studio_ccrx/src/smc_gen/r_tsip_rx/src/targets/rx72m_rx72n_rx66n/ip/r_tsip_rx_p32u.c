...
/***********************************************************************************************************************
* Function Name: R_TSIP_Aes128GcmDecryptUpdateSub
*******************************************************************************************************************/ /**
* @details       RX72M AES-128 Decryption with GCM Mode Update
...
void R_TSIP_Aes128GcmDecryptUpdateSub(uint32_t *InData_Text, uint32_t *OutData_Text, uint32_t MAX_CNT)
{
    ...
    (void)KEY_ADR;
    (void)OFS_ADR;
    RX72M_RX72N_RX66N_func100(change_endian_long(0x76310eccu), change_endian_long(0x58013528u), change_endian_long(0xa15832e2u), change_endian_long(0x843bccb7u));
    TSIP.REG_00H.WORD = 0x80007100u;
    TSIP.REG_104H.WORD = 0x000000b1u;
    TSIP.REG_A4H.WORD = 0x00000886u;
    TSIP.REG_D0H.WORD = 0x00000020u;
    TSIP.REG_C4H.WORD = 0x000087b6u;
    TSIP.REG_04H.WORD = 0x0000c200u;
    if(MAX_CNT != 0)
    {
        /* WAIT_LOOP */
    ...
    RX72M_RX72N_RX66N_func200();//DisableINTEGRATE_WRRDYBandINTEGRATE_RDRDYBinthisfunction.
    RX72M_RX72N_RX66N_func101(change_endian_long(0x2bdc7addu), change_endian_long(0xbef5f3c7u), change_endian_long(0xfea7b39cu), change_endian_long(0x602911c3u));
}
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_p32u_r1.prc
 *********************************************************************************************************************/
