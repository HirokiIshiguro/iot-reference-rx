...
/***********************************************************************************************************************
* Function Name: R_TSIP_Aes256CcmEncryptUpdateSub
*******************************************************************************************************************/ /**
* @details       RX72M AES-256 Encryption with CCM Mode Update
...
void R_TSIP_Aes256CcmEncryptUpdateSub(uint32_t *InData_Text, uint32_t *OutData_Text, uint32_t MAX_CNT)
{
    ...
    (void)KEY_ADR;
    (void)OFS_ADR;
    RX72M_RX72N_RX66N_func100(change_endian_long(0x2e5e258bu), change_endian_long(0xdd174fccu), change_endian_long(0xc001085bu), change_endian_long(0x6a826cb6u));
    TSIP.REG_104H.WORD = 0x000000b1u;
    TSIP.REG_B0H.WORD = 0x40000000u;
    TSIP.REG_A4H.WORD = 0x00e087b6u;
    ...
    RX72M_RX72N_RX66N_func101(change_endian_long(0x51f541ffu), change_endian_long(0x31d48b57u), change_endian_long(0xbbff58a1u), change_endian_long(0xb17da947u));
}
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_pa1u_r1.prc
 *********************************************************************************************************************/
