...
*******************************************************************************************************************/ /**
* @details       RX72M RSA-3072 Public Key Update
* @param[in]     InData_IV
...
e_tsip_err_t R_TSIP_UpdateRsa3072PublicKeyIndexSub(uint32_t *InData_IV, uint32_t *InData_InstData, uint32_t *OutData_KeyIndex)
{
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0x4f3a445bu), change_endian_long(0xd849c8feu), change_endian_long(0x1d787ad9u), change_endian_long(0x103e919eu));
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0xb8804858u), change_endian_long(0x85b1c21du), change_endian_long(0x687d982au), change_endian_long(0x45d117dbu));
    TSIP.REG_104H.WORD = 0x00000361u;
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0x9635e8cbu), change_endian_long(0x17eb5fd8u), change_endian_long(0x3cb5b928u), change_endian_long(0xb309a058u));
    TSIP.REG_104H.WORD = 0x00000361u;
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0x719dde98u), change_endian_long(0x1b4a3edcu), change_endian_long(0xc28a9be6u), change_endian_long(0x71fd3754u));
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0xb6a755d3u), change_endian_long(0x4721c56fu), change_endian_long(0x9b2ee832u), change_endian_long(0xffba950du));
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0xc4211d32u), change_endian_long(0x150f5d9bu), change_endian_long(0xa1eec2b0u), change_endian_long(0x1fea9210u));
    TSIP.REG_104H.WORD = 0x00000361u;
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0x04251221u), change_endian_long(0xb0bf5a89u), change_endian_long(0xd4b3b164u), change_endian_long(0x2f488879u));
    TSIP.REG_104H.WORD = 0x00000052u;
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX72M_RX72N_RX66N_func100(change_endian_long(0x2a4243c3u), change_endian_long(0xd1232266u), change_endian_long(0xd22762a5u), change_endian_long(0x02e5ae54u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX72M_RX72N_RX66N_func102(change_endian_long(0xa2aae235u), change_endian_long(0x46aadde7u), change_endian_long(0x2154f172u), change_endian_long(0x56a6e0a5u));
    ...
    {
        RX72M_RX72N_RX66N_func100(change_endian_long(0xc3a03c98u), change_endian_long(0x7b7059e6u), change_endian_long(0x346df3abu), change_endian_long(0x025e7db9u));
        TSIP.REG_E0H.WORD = 0x81040000u;
        ...
        RX72M_RX72N_RX66N_func102(change_endian_long(0xd39418dau), change_endian_long(0x1b22e353u), change_endian_long(0x34460fd1u), change_endian_long(0xc78ca4f6u));
        TSIP.REG_1B4H.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_pac.prc
 *********************************************************************************************************************/
