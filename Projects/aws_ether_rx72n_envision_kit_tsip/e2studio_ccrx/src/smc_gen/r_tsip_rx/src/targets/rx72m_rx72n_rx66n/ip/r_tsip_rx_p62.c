...
*******************************************************************************************************************/ /**
* @details       RX72M Install 2048bit RSA Public Key
...
e_tsip_err_t R_TSIP_GenerateRsa2048PublicKeyIndexSub(uint32_t *InData_SharedKeyIndex, uint32_t *InData_SessionKey, uint32_t *InData_IV, uint32_t *InData_InstData, uint32_t *OutData_KeyIndex)
{
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0xe2254b4au), change_endian_long(0x86cd3b8fu), change_endian_long(0x1c4261dfu), change_endian_long(0xcd374b96u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX72M_RX72N_RX66N_func102(change_endian_long(0xf2586c44u), change_endian_long(0x5eca4225u), change_endian_long(0x733c5998u), change_endian_long(0xc5ae4bdeu));
    ...
    {
        RX72M_RX72N_RX66N_func100(change_endian_long(0x1ada9fb9u), change_endian_long(0xb3fe6cb5u), change_endian_long(0x500d9759u), change_endian_long(0xc2cc92bau));
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0xccb3cea4u), change_endian_long(0x7b6aa7ecu), change_endian_long(0x94413ca7u), change_endian_long(0xe86495f1u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0x8d06d5fau), change_endian_long(0x61103bf6u), change_endian_long(0x09825edfu), change_endian_long(0xc92e6842u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0xb94be29bu), change_endian_long(0xbb9a70c8u), change_endian_long(0x02fc2070u), change_endian_long(0xd726d063u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0x27c41332u), change_endian_long(0xdfbe13e8u), change_endian_long(0xc20aca68u), change_endian_long(0xc4576ba7u));
        ...
        TSIP.REG_1CH.WORD = 0x00001800u;
        RX72M_RX72N_RX66N_func100(change_endian_long(0xb1f09692u), change_endian_long(0x7d0bb594u), change_endian_long(0xbae4e42eu), change_endian_long(0x5fdd2958u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0x0b548133u), change_endian_long(0x9f82dd06u), change_endian_long(0x681c936du), change_endian_long(0x571378f1u));
        ...
        TSIP.REG_1CH.WORD = 0x00001800u;
        RX72M_RX72N_RX66N_func100(change_endian_long(0x274780a5u), change_endian_long(0x5cdb0e71u), change_endian_long(0x0645594eu), change_endian_long(0xbc73cca1u));
        TSIP.REG_104H.WORD = 0x00000052u;
        ...
        TSIP.REG_1CH.WORD = 0x00001800u;
        RX72M_RX72N_RX66N_func100(change_endian_long(0x100f23deu), change_endian_long(0x2efaeccdu), change_endian_long(0x88c95b6fu), change_endian_long(0x45d5b8dfu));
        TSIP.REG_1CH.WORD = 0x00400000u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            RX72M_RX72N_RX66N_func102(change_endian_long(0x90790a18u), change_endian_long(0x726b1c97u), change_endian_long(0xa13a63b3u), change_endian_long(0x7c5dff0au));
            TSIP.REG_1BCH.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
        ...
        {
            RX72M_RX72N_RX66N_func100(change_endian_long(0xc6192a1cu), change_endian_long(0x39167f15u), change_endian_long(0xe208429bu), change_endian_long(0x99667bd6u));
            TSIP.REG_E0H.WORD = 0x81040000u;
            ...
            RX72M_RX72N_RX66N_func102(change_endian_long(0xa9fd2843u), change_endian_long(0xbb3a8d7fu), change_endian_long(0xb2bce8ceu), change_endian_long(0xa7efe930u));
            TSIP.REG_1BCH.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_p62.prc
 *********************************************************************************************************************/
