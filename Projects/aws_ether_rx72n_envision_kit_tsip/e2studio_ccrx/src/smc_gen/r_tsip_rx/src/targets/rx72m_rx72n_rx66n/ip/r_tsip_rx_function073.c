...
/***********************************************************************************************************************
* Function Name: RX72M_RX72N_RX66N_func073
*******************************************************************************************************************/ /**
* @details       RX72M func073
* @param[in]     ARG1
* @note          None
*/
void RX72M_RX72N_RX66N_func073(uint32_t *ARG1)
{
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0x72c5b5a3u), change_endian_long(0x00228727u), change_endian_long(0x61b31fb9u), change_endian_long(0xb4fd346du));
    ...
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        ...
        RX72M_RX72N_RX66N_func101(change_endian_long(0xc5532ef1u), change_endian_long(0xd85e9373u), change_endian_long(0x55f40af4u), change_endian_long(0x7ce305c7u));
    }
    else
    {
        RX72M_RX72N_RX66N_func100(change_endian_long(0x39a0b545u), change_endian_long(0xa101ef18u), change_endian_long(0xe04ea987u), change_endian_long(0x004f3eb9u));
        ...
        RX72M_RX72N_RX66N_func061();
        RX72M_RX72N_RX66N_func101(change_endian_long(0xb5d7b3eau), change_endian_long(0xda0f082bu), change_endian_long(0x15ee7e54u), change_endian_long(0xde8be5d0u));
    }
    TSIP.REG_ECH.WORD = 0x00007c1du;
    TSIP.REG_1CH.WORD = 0x00602000u;
}
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_func073.prc
 *********************************************************************************************************************/
