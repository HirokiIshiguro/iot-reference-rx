...
*******************************************************************************************************************/ /**
* @details       RX72M Signature verification of ECDSA-384
...
e_tsip_err_t R_TSIP_EcdsaP384SigunatureVerificationSub(uint32_t *InData_KeyIndex, uint32_t *InData_MsgDgst, uint32_t *InData_Signature, const uint32_t *InData_DomainParam)
{
    ...
    TSIP.REG_1CH.WORD = 0x00001f00u;
    TSIP.REG_1CH.WORD = 0x00210000u;
    RX72M_RX72N_RX66N_func100(change_endian_long(0x38b0b2beu), change_endian_long(0xd2272c3du), change_endian_long(0xc84888ceu), change_endian_long(0x447201b5u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX72M_RX72N_RX66N_func102(change_endian_long(0x2db42cd9u), change_endian_long(0xfe9564f6u), change_endian_long(0x446b8695u), change_endian_long(0x53c363acu));
    ...
    {
        RX72M_RX72N_RX66N_func100(change_endian_long(0xad0250f8u), change_endian_long(0xd394d38au), change_endian_long(0x0a07bc48u), change_endian_long(0xb4f54f24u));
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0xdc1256c2u), change_endian_long(0xe3ff227au), change_endian_long(0x985c610fu), change_endian_long(0xa33d3804u));
        TSIP.REG_34H.WORD = 0x00000002u;
        TSIP.REG_24H.WORD = 0x800009c0u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_24H.BIT.B21)
        ...
        TSIP.REG_1CH.WORD = 0x00001f00u;
        TSIP.REG_1CH.WORD = 0x00210000u;
        RX72M_RX72N_RX66N_func100(change_endian_long(0x77d30bfeu), change_endian_long(0x3fd5a5aeu), change_endian_long(0x2dab99ecu), change_endian_long(0x8c3c18cau));
        TSIP.REG_1CH.WORD = 0x00400000u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            RX72M_RX72N_RX66N_func102(change_endian_long(0xc2f2afdcu), change_endian_long(0x92655636u), change_endian_long(0x6c6cc084u), change_endian_long(0xd67e7294u));
            TSIP.REG_1B8H.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
        ...
        {
            RX72M_RX72N_RX66N_func100(change_endian_long(0xd4be0159u), change_endian_long(0xa2449e59u), change_endian_long(0x73db112du), change_endian_long(0x21425d29u));
            TSIP.REG_ECH.WORD = 0x0000b500u;
            TSIP.REG_ECH.WORD = 0x00000090u;
            TSIP.REG_E0H.WORD = 0x818c0008u;
            TSIP.REG_00H.WORD = 0x00003833u;
            ...
            if (1u == (TSIP.REG_1CH.BIT.B22))
            {
                RX72M_RX72N_RX66N_func102(change_endian_long(0x76c6d4a4u), change_endian_long(0x089b59bdu), change_endian_long(0x19106178u), change_endian_long(0xf54d5df4u));
                TSIP.REG_1B8H.WORD = 0x00000040u;
                /* WAIT_LOOP */
                while (0u != TSIP.REG_18H.BIT.B12)
                {
            ...
            {
                RX72M_RX72N_RX66N_func100(change_endian_long(0x26631575u), change_endian_long(0x2ccc02acu), change_endian_long(0x4502d5bbu), change_endian_long(0x1359fa4du));
                TSIP.REG_24H.WORD = 0x0000880cu;
                /* WAIT_LOOP */
                while (0u != TSIP.REG_24H.BIT.B21)
                {
                ...
                TSIP.REG_1CH.WORD = 0x00001f00u;
                TSIP.REG_1CH.WORD = 0x00210000u;
                RX72M_RX72N_RX66N_func100(change_endian_long(0x83aa552eu), change_endian_long(0x74f30501u), change_endian_long(0x44153381u), change_endian_long(0xbb732efbu));
                TSIP.REG_1CH.WORD = 0x00400000u;
                TSIP.REG_1D0H.WORD = 0x00000000u;
                if (1u == (TSIP.REG_1CH.BIT.B22))
                {
                    RX72M_RX72N_RX66N_func102(change_endian_long(0x2c7e9169u), change_endian_long(0xd19ad6ebu), change_endian_long(0x128b58adu), change_endian_long(0x6beaef19u));
                    TSIP.REG_1B8H.WORD = 0x00000040u;
                    /* WAIT_LOOP */
                    while (0u != TSIP.REG_18H.BIT.B12)
                    {
                ...
                else
                {
                    ...
                    TSIP.REG_1CH.WORD = 0x00001f00u;
                    TSIP.REG_1CH.WORD = 0x00210000u;
                    RX72M_RX72N_RX66N_func100(change_endian_long(0x8b347638u), change_endian_long(0xbf7b3cf4u), change_endian_long(0x4a06a60cu), change_endian_long(0xa7b6349bu));
                    TSIP.REG_1CH.WORD = 0x00400000u;
                    TSIP.REG_1D0H.WORD = 0x00000000u;
                    if (1u == (TSIP.REG_1CH.BIT.B22))
                    {
                        RX72M_RX72N_RX66N_func102(change_endian_long(0x38ece66cu), change_endian_long(0x52c71a57u), change_endian_long(0x07b8ed5fu), change_endian_long(0xb0dc57e8u));
                        TSIP.REG_1B8H.WORD = 0x00000040u;
                        /* WAIT_LOOP */
                        while (0u != TSIP.REG_18H.BIT.B12)
                        {
                    ...
                    {
                        RX72M_RX72N_RX66N_func100(change_endian_long(0x6fcc243cu), change_endian_long(0x1a0cf3f0u), change_endian_long(0x3b58a00cu), change_endian_long(0x63886a36u));
                        TSIP.REG_ECH.WORD = 0x0000b500u;
                        TSIP.REG_ECH.WORD = 0x00000090u;
                        TSIP.REG_E0H.WORD = 0x818c0008u;
                        TSIP.REG_00H.WORD = 0x00003833u;
                        ...
                        TSIP.REG_1CH.WORD = 0x00001f00u;
                        TSIP.REG_1CH.WORD = 0x00210000u;
                        RX72M_RX72N_RX66N_func100(change_endian_long(0x52821031u), change_endian_long(0x55dcb16bu), change_endian_long(0xab3696d8u), change_endian_long(0xead5e646u));
                        TSIP.REG_1CH.WORD = 0x00400000u;
                        TSIP.REG_1D0H.WORD = 0x00000000u;
                        if (1u == (TSIP.REG_1CH.BIT.B22))
                        {
                            RX72M_RX72N_RX66N_func102(change_endian_long(0x578ea0fdu), change_endian_long(0xb021081au), change_endian_long(0x6a6916e5u), change_endian_long(0x613310c6u));
                            TSIP.REG_1B8H.WORD = 0x00000040u;
                            /* WAIT_LOOP */
                            while (0u != TSIP.REG_18H.BIT.B12)
                            {
                        ...
                        {
                            RX72M_RX72N_RX66N_func102(change_endian_long(0x98a73a73u), change_endian_long(0x7165cf4eu), change_endian_long(0xaed2a29au), change_endian_long(0xc52ac147u));
                            TSIP.REG_1B8H.WORD = 0x00000040u;
                            /* WAIT_LOOP */
                            while (0u != TSIP.REG_18H.BIT.B12)
                            {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_pf6_r2.prc
 *********************************************************************************************************************/
