...
*******************************************************************************************************************/ /**
* @details       RX72M RSA-4096 Public Key Install
...
e_tsip_err_t R_TSIP_GenerateRsa4096PublicKeyIndexSub(uint32_t *InData_SharedKeyIndex, uint32_t *InData_SessionKey, uint32_t *InData_IV, uint32_t *InData_InstData, uint32_t *OutData_KeyIndex)
{
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0xe89af21fu), change_endian_long(0xa46484bfu), change_endian_long(0xcc147edeu), change_endian_long(0xf79d9ff6u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX72M_RX72N_RX66N_func102(change_endian_long(0xd3d274e6u), change_endian_long(0x9521123fu), change_endian_long(0x1e470f9bu), change_endian_long(0xa72f96d0u));
    ...
    {
        RX72M_RX72N_RX66N_func100(change_endian_long(0xa5bee402u), change_endian_long(0xda93ff26u), change_endian_long(0x9229bda8u), change_endian_long(0xae2d91c7u));
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0x09c6ab59u), change_endian_long(0xb09a99cdu), change_endian_long(0xf1c8febau), change_endian_long(0x09020584u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0xb1ae3037u), change_endian_long(0x66097b68u), change_endian_long(0xf152a56eu), change_endian_long(0x633885eau));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0xff1ffcb4u), change_endian_long(0x822d283fu), change_endian_long(0x0a9da667u), change_endian_long(0x8fc095beu));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0xf4e65d72u), change_endian_long(0x840fc93eu), change_endian_long(0xa760d61au), change_endian_long(0x42ef633cu));
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0xa9c25ddeu), change_endian_long(0x01576d87u), change_endian_long(0xe0222a9fu), change_endian_long(0xad48c4a3u));
        TSIP.REG_00H.WORD = 0x00012103u;
        TSIP.REG_104H.WORD = 0x00000031u;
        TSIP.REG_B0H.WORD = 0x00000f00u;
        TSIP.REG_A4H.WORD = 0x00d0c9a7u;
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0xa69a3561u), change_endian_long(0x2b2c7315u), change_endian_long(0xeec0848du), change_endian_long(0x47c27e48u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX72M_RX72N_RX66N_func100(change_endian_long(0x2eceb200u), change_endian_long(0x4a0aa885u), change_endian_long(0x3d55189eu), change_endian_long(0xfc7c3761u));
        TSIP.REG_104H.WORD = 0x00000052u;
        ...
        TSIP.REG_1CH.WORD = 0x00001800u;
        RX72M_RX72N_RX66N_func100(change_endian_long(0xf13404abu), change_endian_long(0xa515e094u), change_endian_long(0x684b57bdu), change_endian_long(0xd1d04f6au));
        TSIP.REG_1CH.WORD = 0x00400000u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            RX72M_RX72N_RX66N_func102(change_endian_long(0xf155e0e9u), change_endian_long(0x8a4dac4eu), change_endian_long(0x5a494b09u), change_endian_long(0xa2dee0b0u));
            TSIP.REG_1B4H.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
        ...
        {
            RX72M_RX72N_RX66N_func100(change_endian_long(0x290ef377u), change_endian_long(0x09a024c6u), change_endian_long(0x692dbc2du), change_endian_long(0x96ae6521u));
            TSIP.REG_E0H.WORD = 0x81040000u;
            ...
            RX72M_RX72N_RX66N_func102(change_endian_long(0x4f568e20u), change_endian_long(0xcc095d55u), change_endian_long(0x77948497u), change_endian_long(0xa1fbf2f0u));
            TSIP.REG_1B4H.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_pab.prc
 *********************************************************************************************************************/
