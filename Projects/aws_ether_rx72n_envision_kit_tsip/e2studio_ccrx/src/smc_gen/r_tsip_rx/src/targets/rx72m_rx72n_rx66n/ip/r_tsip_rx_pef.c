...
/***********************************************************************************************************************
* Function Name: R_TSIP_Tls13GeneratePreSharedKeySub
*******************************************************************************************************************/ /**
* @details       RX72M TLS1.3 PreSharedKey Generation
* @param[in]     InData_Cmd
...
* @note          None
*/
e_tsip_err_t R_TSIP_Tls13GeneratePreSharedKeySub(uint32_t *InData_Cmd, uint32_t *InData_Handle, uint32_t *InData_RMaster_SecretKeyIndex, uint32_t *InData_TicketNonceLen, uint32_t *InData_TicketNonce, uint32_t *OutData_PreSharedKeyIndex)
{
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0xd2393a0eu), change_endian_long(0x5ec80f8cu), change_endian_long(0x358d9a2au), change_endian_long(0x98a414bbu));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX72M_RX72N_RX66N_func102(change_endian_long(0x569a0704u), change_endian_long(0x5ce0db1cu), change_endian_long(0x15cda163u), change_endian_long(0x5436be11u));
    ...
    else
    {
        ...
        TSIP.REG_100H.WORD = change_endian_long(0x26d02eceu);
        ...
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            RX72M_RX72N_RX66N_func102(change_endian_long(0x7a8d6a59u), change_endian_long(0x048f7c84u), change_endian_long(0xad95407au), change_endian_long(0xd89769f5u));
            TSIP.REG_1BCH.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
        ...
        else
        {
            ...
            TSIP.REG_100H.WORD = change_endian_long(0x000000efu);
            RX72M_RX72N_RX66N_func101(change_endian_long(0x84a4a60au), change_endian_long(0x903f99cdu), change_endian_long(0xd52235c8u), change_endian_long(0x580901c2u));
            RX72M_RX72N_RX66N_func073(InData_TicketNonce);
            RX72M_RX72N_RX66N_func100(change_endian_long(0x4b0fa22bu), change_endian_long(0x54c110c5u), change_endian_long(0x558dd3c9u), change_endian_long(0xce34e7bcu));
            ...
            RX72M_RX72N_RX66N_func102(change_endian_long(0x9dc70a95u), change_endian_long(0x9c8a5695u), change_endian_long(0xfc94f3dbu), change_endian_long(0xcb3859e7u));
            TSIP.REG_1BCH.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_pef_r2.prc
 *********************************************************************************************************************/
