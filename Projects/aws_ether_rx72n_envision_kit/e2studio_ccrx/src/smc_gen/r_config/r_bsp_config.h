...
*         : 27.11.2024 2.05     Changed comment of BSP_CFG_RTC_ENABLE.
***********************************************************************************************************************/
...
*/
#define BSP_CFG_SCI_UART_TERMINAL_ENABLE         (1)
...
/* Select the priority order for memory bus 1 (RAM) and memory bus 3 (expansion RAM/ECCRAM).
