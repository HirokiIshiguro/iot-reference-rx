...
#ifndef S12AD_PRV_RX671_IF_H
#define S12AD_PRV_RX671_IF_H
...
#define ADC_MASK_TEMP   (1<<12)     /* temperature sensor */
#define ADC_MASK_VOLT   (1<<13)     /* internal reference voltage sensor */
