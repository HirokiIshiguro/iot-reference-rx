...
*******************************************************************************************************************/ /**
* @details       RX671 RSA1024 Decryption with Private Key
...
e_tsip_err_t R_TSIP_Rsa1024ModularExponentDecryptSub(uint32_t *InData_KeyIndex, uint32_t *InData_Text, uint32_t *OutData_Text)
{
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX671_func100(change_endian_long(0xe52e1b13u), change_endian_long(0x623e12cfu), change_endian_long(0xc7f22346u), change_endian_long(0x269e7072u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX671_func102(change_endian_long(0xa66ac690u), change_endian_long(0xc0d58d6eu), change_endian_long(0xc318d1afu), change_endian_long(0xfa2dc2fbu));
    ...
    {
        RX671_func100(change_endian_long(0x7e88a17cu), change_endian_long(0x4538f58du), change_endian_long(0xe0857d57u), change_endian_long(0x3b1671a1u));
        ...
        RX671_func100(change_endian_long(0x4c3ba6bdu), change_endian_long(0x75f22b2eu), change_endian_long(0x1a0737ddu), change_endian_long(0x54f8a1eau));
        ...
        RX671_func102(change_endian_long(0xb0902e64u), change_endian_long(0xfca1a221u), change_endian_long(0x4c127192u), change_endian_long(0x749411b3u));
        TSIP.REG_1BCH.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX671/RX671_p54.prc
 *********************************************************************************************************************/
