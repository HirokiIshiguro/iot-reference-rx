...
*******************************************************************************************************************/ /**
* @details       RX671 ARC4 Encryption/Decryption Update
...
void R_TSIP_Arc4EncryptDecryptUpdateSub(uint32_t *InData_Text, uint32_t *OutData_Text, uint32_t MAX_CNT)
{
    ...
    (void)KEY_ADR;
    (void)OFS_ADR;
    RX671_func100(change_endian_long(0xf6e4020fu), change_endian_long(0x812123b7u), change_endian_long(0x7a92eb0du), change_endian_long(0x93507eb7u));
