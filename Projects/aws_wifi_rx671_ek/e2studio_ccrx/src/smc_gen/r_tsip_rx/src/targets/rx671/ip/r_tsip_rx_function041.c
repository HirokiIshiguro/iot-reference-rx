...
/***********************************************************************************************************************
* Function Name: RX671_func041
*******************************************************************************************************************/ /**
* @details       RX671 func041
* @param[in]     ARG1
* @note          None
*/
void RX671_func041(const uint32_t* ARG1)
{
    ...
    for (iLoop = 0; iLoop < 16; iLoop = iLoop + 4)
    {
        ...
        TSIP.REG_100H.WORD = ARG1[iLoop+1];
        TSIP.REG_100H.WORD = ARG1[iLoop+2];
        TSIP.REG_100H.WORD = ARG1[iLoop+3];
    }
    /* WAIT_LOOP */
...
/**********************************************************************************************************************
 End of function ./input_dir/RX671/RX671_func041_r1.prc
 *********************************************************************************************************************/
