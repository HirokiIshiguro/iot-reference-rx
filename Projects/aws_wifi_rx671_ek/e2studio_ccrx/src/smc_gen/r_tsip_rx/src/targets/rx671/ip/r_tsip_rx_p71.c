...
*******************************************************************************************************************/ /**
* @details       RX671 SHA-1 Message Digest Generation
...
e_tsip_err_t R_TSIP_Sha1GenerateMessageDigestSub(uint32_t *InData_SHA1InitVal, uint32_t *InData_PaddedMsg, uint32_t MAX_CNT, uint32_t *OutData_MsgDigest)
{
    ...
    RX671_func100(change_endian_long(0xbbf574dbu), change_endian_long(0xf8a32c9du), change_endian_long(0x7db79c0eu), change_endian_long(0x9a709a22u));
    ...
    RX671_func102(change_endian_long(0xb7bdac9du), change_endian_long(0xa2ac920eu), change_endian_long(0xd8eca5f8u), change_endian_long(0xfc62db61u));
...
/**********************************************************************************************************************
 End of function ./input_dir/RX671/RX671_p71.prc
 *********************************************************************************************************************/
