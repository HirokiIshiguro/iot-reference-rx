...
/***********************************************************************************************************************
* Function Name: R_TSIP_UpdateTdesKeyIndexSub
*******************************************************************************************************************/ /**
* @details       RX671 Update TDES Key
* @param[in]     InData_IV
...
e_tsip_err_t R_TSIP_UpdateTdesKeyIndexSub(uint32_t *InData_IV, uint32_t *InData_InstData, uint32_t *OutData_KeyIndex)
{
    ...
    TSIP.REG_84H.WORD = 0x00000a01u;
    TSIP.REG_108H.WORD = 0x00000000u;
    RX671_func100(change_endian_long(0xc54f6a58u), change_endian_long(0x0c697f88u), change_endian_long(0x7c0ec57bu), change_endian_long(0xb9b72372u));
    ...
    RX671_func100(change_endian_long(0xe8811525u), change_endian_long(0xfd6d042fu), change_endian_long(0x22d139eeu), change_endian_long(0xe3e47724u));
    ...
    RX671_func100(change_endian_long(0x5d0fc6d7u), change_endian_long(0xb3a35002u), change_endian_long(0x0c164f3eu), change_endian_long(0xc475c927u));
    TSIP.REG_104H.WORD = 0x00000361u;
    ...
    RX671_func103();
    RX671_func100(change_endian_long(0xf0676421u), change_endian_long(0x37da004eu), change_endian_long(0xe28cc202u), change_endian_long(0x350298f7u));
    ...
    RX671_func100(change_endian_long(0x90f4ddd5u), change_endian_long(0x7fc39685u), change_endian_long(0x8b3448d4u), change_endian_long(0xae14946cu));
    TSIP.REG_104H.WORD = 0x00000052u;
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX671_func100(change_endian_long(0x2403e5fau), change_endian_long(0x3d4cd281u), change_endian_long(0x875eabcau), change_endian_long(0xfc0d16e7u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX671_func102(change_endian_long(0xc596d7ecu), change_endian_long(0xcaa15f94u), change_endian_long(0x5842a1b7u), change_endian_long(0x7976aca1u));
    ...
    {
        RX671_func100(change_endian_long(0xfd0c973au), change_endian_long(0xf076dcaeu), change_endian_long(0xdc6ba52du), change_endian_long(0x67a5a1fbu));
        TSIP.REG_E0H.WORD = 0x81040000u;
        ...
        RX671_func102(change_endian_long(0x3f840cc1u), change_endian_long(0x112c3ec3u), change_endian_long(0x33708e5du), change_endian_long(0x994ab313u));
        TSIP.REG_1B4H.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX671/RX671_p0a.prc
 *********************************************************************************************************************/
