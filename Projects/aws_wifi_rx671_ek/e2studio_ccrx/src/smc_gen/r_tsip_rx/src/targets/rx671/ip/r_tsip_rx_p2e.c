...
*******************************************************************************************************************/ /**
* @details       RX671 Update P-384 ECC Public Key
* @param[in]     InData_IV
...
e_tsip_err_t R_TSIP_UpdateEccP384PublicKeyIndexSub(uint32_t *InData_IV, uint32_t *InData_InstData, uint32_t *OutData_KeyIndex)
{
    ...
    RX671_func100(change_endian_long(0x4e6689c4u), change_endian_long(0xebb70af3u), change_endian_long(0xeee7be58u), change_endian_long(0xb3d9bffdu));
    ...
    RX671_func100(change_endian_long(0xa7722eb2u), change_endian_long(0xc4d08995u), change_endian_long(0x65998f73u), change_endian_long(0x2d5a6707u));
    TSIP.REG_104H.WORD = 0x00000361u;
    ...
    RX671_func100(change_endian_long(0x0646c0dbu), change_endian_long(0xd91fee78u), change_endian_long(0x8daccbbcu), change_endian_long(0x6d7b7dadu));
    TSIP.REG_104H.WORD = 0x00000361u;
    ...
    RX671_func103();
    RX671_func100(change_endian_long(0x88c03af0u), change_endian_long(0xb9bd6a28u), change_endian_long(0x352d2c68u), change_endian_long(0x6820354fu));
    ...
    RX671_func100(change_endian_long(0x4039facbu), change_endian_long(0xb4e3906au), change_endian_long(0xb63ba5b4u), change_endian_long(0x0eed6b1du));
    TSIP.REG_104H.WORD = 0x00000052u;
    ...
    RX671_func100(change_endian_long(0x5d7b6adeu), change_endian_long(0xe8b35b80u), change_endian_long(0x40ad419bu), change_endian_long(0xce8793ddu));
    TSIP.REG_104H.WORD = 0x00000052u;
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX671_func100(change_endian_long(0xdb84b8f9u), change_endian_long(0xde8d6fb6u), change_endian_long(0x75d6808eu), change_endian_long(0xf2dca301u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX671_func102(change_endian_long(0x1155c217u), change_endian_long(0x2dfab46fu), change_endian_long(0x8f828296u), change_endian_long(0xcbd72152u));
    ...
    {
        RX671_func100(change_endian_long(0x7b65558du), change_endian_long(0x91b01385u), change_endian_long(0x08610a26u), change_endian_long(0xfead2d9cu));
        TSIP.REG_E0H.WORD = 0x81040000u;
        ...
        RX671_func102(change_endian_long(0x370e1a2du), change_endian_long(0x7df467deu), change_endian_long(0x57466ae6u), change_endian_long(0xee26ac2fu));
        TSIP.REG_1B4H.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX671/RX671_p2e.prc
 *********************************************************************************************************************/
