...
*******************************************************************************************************************/ /**
* @details       RX671 AES-128 Decryption with GCM Mode Update
...
void R_TSIP_Aes128GcmDecryptUpdateSub(uint32_t *InData_Text, uint32_t *OutData_Text, uint32_t MAX_CNT)
{
    ...
    (void)KEY_ADR;
    (void)OFS_ADR;
    RX671_func100(change_endian_long(0x1ee1e395u), change_endian_long(0x2b32190bu), change_endian_long(0xfa5288c7u), change_endian_long(0xc1985840u));
    ...
    RX671_func200();//DisableINTEGRATE_WRRDYBandINTEGRATE_RDRDYBinthisfunction.
    RX671_func101(change_endian_long(0x65806cf0u), change_endian_long(0xfc42cf55u), change_endian_long(0x915000ecu), change_endian_long(0xaf23cd16u));
}
/**********************************************************************************************************************
 End of function ./input_dir/RX671/RX671_p32u_r1.prc
 *********************************************************************************************************************/
