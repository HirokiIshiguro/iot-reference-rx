...
*******************************************************************************************************************/ /**
* @details       RX671 AES-256 CMAC generation/verification Update
...
void R_TSIP_Aes256CmacUpdateSub(uint32_t *InData_Text, uint32_t MAX_CNT)
{
    ...
    RX671_func101(change_endian_long(0xd587eceau), change_endian_long(0x2a587e91u), change_endian_long(0x2a0d083bu), change_endian_long(0x95ee9a57u));
}
/**********************************************************************************************************************
 End of function ./input_dir/RX671/RX671_p44u.prc
 *********************************************************************************************************************/
