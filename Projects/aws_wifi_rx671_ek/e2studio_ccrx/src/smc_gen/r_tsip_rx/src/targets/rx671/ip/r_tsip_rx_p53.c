...
*******************************************************************************************************************/ /**
* @details       RX671 RSA1024 Encryption with Public Key
...
e_tsip_err_t R_TSIP_Rsa1024ModularExponentEncryptSub(uint32_t *InData_KeyIndex, uint32_t *InData_Text, uint32_t *OutData_Text)
{
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX671_func100(change_endian_long(0xa725116du), change_endian_long(0xb86446a6u), change_endian_long(0x53bcc93eu), change_endian_long(0xfbcaac28u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX671_func102(change_endian_long(0x4e94f782u), change_endian_long(0x1681beeeu), change_endian_long(0xf20db5e5u), change_endian_long(0xbf4ff4beu));
    ...
    {
        RX671_func100(change_endian_long(0xa2db3d9fu), change_endian_long(0x0a5c070cu), change_endian_long(0xb4322546u), change_endian_long(0xac67dc6fu));
        ...
        RX671_func100(change_endian_long(0x444da949u), change_endian_long(0x34e3bcf0u), change_endian_long(0x8d655113u), change_endian_long(0x527c0be1u));
        ...
        RX671_func102(change_endian_long(0x5b15d1feu), change_endian_long(0x8e1fa34au), change_endian_long(0x952da314u), change_endian_long(0x3985ed91u));
        TSIP.REG_1BCH.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX671/RX671_p53.prc
 *********************************************************************************************************************/
