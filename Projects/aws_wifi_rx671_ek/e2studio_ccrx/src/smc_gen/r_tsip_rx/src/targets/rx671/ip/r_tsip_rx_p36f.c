...
e_tsip_err_t R_TSIP_Aes256GcmDecryptFinalSub(uint32_t *InData_Text, uint32_t *InData_DataT, uint32_t *InData_DataALen, uint32_t *InData_TextLen, uint32_t *InData_DataTLen, uint32_t *OutData_Text)
{
    ...
    else
    {
        ...
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            ...
            RX671_func100(change_endian_long(0x2b778e7du), change_endian_long(0x79348895u), change_endian_long(0x7f0e7f61u), change_endian_long(0xc23ee8fdu));
            ...
            RX671_func101(change_endian_long(0x4d85259bu), change_endian_long(0xc59f04f3u), change_endian_long(0x324bd811u), change_endian_long(0x1c84eaf8u));
        }
...
/**********************************************************************************************************************
 End of function ./input_dir/RX671/RX671_p36f_r1.prc
 *********************************************************************************************************************/
