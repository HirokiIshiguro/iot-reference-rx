...
/***********************************************************************************************************************
* Function Name: R_TSIP_GenerateRsa2048PrivateKeyIndexSub
*******************************************************************************************************************/ /**
* @details       RX671 Install 2048bit RSA Private Key
...
* @note          None
*/
e_tsip_err_t R_TSIP_GenerateRsa2048PrivateKeyIndexSub(uint32_t *InData_SharedKeyIndex, uint32_t *InData_SessionKey, uint32_t *InData_IV, uint32_t *InData_InstData, uint32_t *OutData_KeyIndex)
{
    ...
    RX671_func100(change_endian_long(0x16f043efu), change_endian_long(0x8aa48cc9u), change_endian_long(0x03de6c4fu), change_endian_long(0x332ebd08u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX671_func102(change_endian_long(0x163b7b82u), change_endian_long(0x292d615cu), change_endian_long(0xeb94b086u), change_endian_long(0x34f6499cu));
    ...
    {
        RX671_func100(change_endian_long(0xc627063fu), change_endian_long(0xb35ece1du), change_endian_long(0xa7ee0113u), change_endian_long(0x94170a92u));
        ...
        RX671_func100(change_endian_long(0x3f41b08au), change_endian_long(0xb5f218d4u), change_endian_long(0x63423d99u), change_endian_long(0x7a50b7c8u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX671_func100(change_endian_long(0xebbee482u), change_endian_long(0x6d6d4ab0u), change_endian_long(0xeacf9a41u), change_endian_long(0xd684cdd8u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX671_func100(change_endian_long(0x3c7d57dbu), change_endian_long(0x62112924u), change_endian_long(0x39ed4b54u), change_endian_long(0x0349583du));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX671_func103();
        RX671_func100(change_endian_long(0x311afb55u), change_endian_long(0xaae54118u), change_endian_long(0x8c28a1fau), change_endian_long(0x8b7e6226u));
        ...
        TSIP.REG_1CH.WORD = 0x00001800u;
        RX671_func100(change_endian_long(0xfa43ee36u), change_endian_long(0x388c88efu), change_endian_long(0x8caf68dcu), change_endian_long(0x8cbcdab5u));
        TSIP.REG_00H.WORD = 0x00013103u;
        ...
        TSIP.REG_1CH.WORD = 0x00001800u;
        RX671_func100(change_endian_long(0x1a8bb376u), change_endian_long(0x45e960a8u), change_endian_long(0xa685dd51u), change_endian_long(0xa1654fcfu));
        ...
        TSIP.REG_1CH.WORD = 0x00001800u;
        RX671_func100(change_endian_long(0x02cbd1a7u), change_endian_long(0x5fc45dbau), change_endian_long(0xb6c4ce3fu), change_endian_long(0x55d73c61u));
        TSIP.REG_104H.WORD = 0x00000052u;
        ...
        TSIP.REG_1CH.WORD = 0x00001800u;
        RX671_func100(change_endian_long(0xf1424725u), change_endian_long(0x9a6543e1u), change_endian_long(0x92e9889eu), change_endian_long(0x0dde8cc3u));
        TSIP.REG_1CH.WORD = 0x00400000u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            RX671_func102(change_endian_long(0x8f6e4746u), change_endian_long(0x542f1b55u), change_endian_long(0xbdb36ab4u), change_endian_long(0x0613b356u));
            TSIP.REG_1BCH.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
        ...
        {
            RX671_func100(change_endian_long(0x728a28e9u), change_endian_long(0x1af8c9a8u), change_endian_long(0xb32f3479u), change_endian_long(0xa1404d6du));
            TSIP.REG_E0H.WORD = 0x81040000u;
            ...
            RX671_func102(change_endian_long(0xfdd2fa4bu), change_endian_long(0x99718496u), change_endian_long(0x54038a3cu), change_endian_long(0x386c1588u));
            TSIP.REG_1BCH.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX671/RX671_p63.prc
 *********************************************************************************************************************/
