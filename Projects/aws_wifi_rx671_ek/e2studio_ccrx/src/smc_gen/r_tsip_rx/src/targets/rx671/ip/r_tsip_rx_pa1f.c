...
*******************************************************************************************************************/ /**
* @details       RX671 AES-256 Encryption with CCM Mode Final
...
e_tsip_err_t R_TSIP_Aes256CcmEncryptFinalSub(uint32_t *InData_TextLen, uint32_t *InData_Text, uint32_t *OutData_Text, uint32_t *OutData_MAC)
{
    ...
    (void)KEY_ADR;
    (void)OFS_ADR;
    RX671_func100(change_endian_long(0x60485081u), change_endian_long(0x9e2213a9u), change_endian_long(0xa0249966u), change_endian_long(0xb0c05400u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX671_func102(change_endian_long(0x5f793ce5u), change_endian_long(0xa5602b70u), change_endian_long(0xc642d4b6u), change_endian_long(0x437a1bedu));
    ...
    else
    {
        ...
        RX671_func100(change_endian_long(0x6a888996u), change_endian_long(0x4191d298u), change_endian_long(0x1f9c5c3fu), change_endian_long(0x1efcf8f6u));
        TSIP.REG_1CH.WORD = 0x00400000u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            ...
            RX671_func100(change_endian_long(0xab711fdbu), change_endian_long(0x74248db3u), change_endian_long(0xb4daacfbu), change_endian_long(0xbd6c9075u));
            TSIP.REG_ECH.WORD = 0x0000b420u;
            TSIP.REG_ECH.WORD = 0x00000080u;
            ...
            RX671_func101(change_endian_long(0xeec3f3deu), change_endian_long(0xedd46f58u), change_endian_long(0x27187bceu), change_endian_long(0xfb317e1cu));
        }
        else
        {
            RX671_func101(change_endian_long(0xebe14abau), change_endian_long(0x476b3df5u), change_endian_long(0xbf746deeu), change_endian_long(0x95f4b145u));
        }
        ...
        RX671_func100(change_endian_long(0xcc07d583u), change_endian_long(0x71c5e64fu), change_endian_long(0x4ae2827cu), change_endian_long(0xb626ac7fu));
        TSIP.REG_B0H.WORD = 0x40000000u;
        ...
        RX671_func102(change_endian_long(0x34e6a6cdu), change_endian_long(0x8a42e399u), change_endian_long(0xa1fcb804u), change_endian_long(0x9ab2c0bcu));
        TSIP.REG_1BCH.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX671/RX671_pa1f.prc
 *********************************************************************************************************************/
