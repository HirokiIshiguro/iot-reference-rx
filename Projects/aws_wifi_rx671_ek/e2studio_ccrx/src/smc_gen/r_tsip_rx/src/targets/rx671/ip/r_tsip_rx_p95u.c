...
*******************************************************************************************************************/ /**
* @details       RX671 AES-128 Encryption with CCM Mode Update
...
void R_TSIP_Aes128CcmEncryptUpdateSub(uint32_t *InData_Text, uint32_t *OutData_Text, uint32_t MAX_CNT)
{
    ...
    (void)KEY_ADR;
    (void)OFS_ADR;
    RX671_func100(change_endian_long(0x85743c0fu), change_endian_long(0xd94c7055u), change_endian_long(0xbe8ccab6u), change_endian_long(0x35d41561u));
    ...
    RX671_func101(change_endian_long(0xc54b213fu), change_endian_long(0x182e6996u), change_endian_long(0x05b857d2u), change_endian_long(0x1dfd04b4u));
}
/**********************************************************************************************************************
 End of function ./input_dir/RX671/RX671_p95u_r1.prc
 *********************************************************************************************************************/
