...
e_tsip_err_t R_TSIP_Sha1HmacInitSub(uint32_t *InData_KeyType, uint32_t *InData_Cmd, uint32_t *InData_KeyIndex)
{
    ...
    else
    {
        ...
        TSIP.REG_1CH.WORD = 0x00001800u;
        RX671_func101(change_endian_long(0x5ab5c15bu), change_endian_long(0x40fc4dc1u), change_endian_long(0xe9132e59u), change_endian_long(0x5555746du));
    }
...
/**********************************************************************************************************************
 End of function ./input_dir/RX671/RX671_p73i_r1.prc
 *********************************************************************************************************************/
