...
*******************************************************************************************************************/ /**
* @details       RX671 Install 2048bit RSA Public Key
...
e_tsip_err_t R_TSIP_GenerateRsa2048PublicKeyIndexSub(uint32_t *InData_SharedKeyIndex, uint32_t *InData_SessionKey, uint32_t *InData_IV, uint32_t *InData_InstData, uint32_t *OutData_KeyIndex)
{
    ...
    RX671_func100(change_endian_long(0x6824c03eu), change_endian_long(0xcf34b77eu), change_endian_long(0x72d89e03u), change_endian_long(0x62a35018u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX671_func102(change_endian_long(0x099a316fu), change_endian_long(0x3ae1a167u), change_endian_long(0xfd4e68c6u), change_endian_long(0x463a7916u));
    ...
    {
        RX671_func100(change_endian_long(0xcc695e8au), change_endian_long(0xc611fefbu), change_endian_long(0xb0e943d2u), change_endian_long(0xa7ba61cbu));
        ...
        RX671_func100(change_endian_long(0x74ed32f4u), change_endian_long(0xe772aae0u), change_endian_long(0x7bd06f52u), change_endian_long(0xd0e3e7b5u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX671_func100(change_endian_long(0xc82d53d2u), change_endian_long(0x9d63b96eu), change_endian_long(0xf847dcdeu), change_endian_long(0x083fe7efu));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX671_func100(change_endian_long(0xe045e70bu), change_endian_long(0x7bcba269u), change_endian_long(0x008ccf9cu), change_endian_long(0xfd5ca3bdu));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX671_func103();
        RX671_func100(change_endian_long(0x77748031u), change_endian_long(0x385f459du), change_endian_long(0x6b01cd56u), change_endian_long(0x31cc6ee2u));
        ...
        TSIP.REG_1CH.WORD = 0x00001800u;
        RX671_func100(change_endian_long(0x86947facu), change_endian_long(0x1fa6e4fau), change_endian_long(0xea562698u), change_endian_long(0xa03de77fu));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX671_func100(change_endian_long(0xad9db22bu), change_endian_long(0x35751ad3u), change_endian_long(0xeb179b85u), change_endian_long(0x5c495b89u));
        ...
        TSIP.REG_1CH.WORD = 0x00001800u;
        RX671_func100(change_endian_long(0xb60b3f64u), change_endian_long(0x1f380de9u), change_endian_long(0x5c82bbceu), change_endian_long(0xfbb0e431u));
        TSIP.REG_104H.WORD = 0x00000052u;
        ...
        TSIP.REG_1CH.WORD = 0x00001800u;
        RX671_func100(change_endian_long(0x8e8796c2u), change_endian_long(0xebfc8d12u), change_endian_long(0xe3fcde29u), change_endian_long(0x9fbaea76u));
        TSIP.REG_1CH.WORD = 0x00400000u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            RX671_func102(change_endian_long(0x9b85913eu), change_endian_long(0x9287700bu), change_endian_long(0x0b5ac72cu), change_endian_long(0xf5d231d9u));
            TSIP.REG_1BCH.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
        ...
        {
            RX671_func100(change_endian_long(0x0d8abc6bu), change_endian_long(0xb1d21829u), change_endian_long(0x247b330bu), change_endian_long(0xec080afau));
            TSIP.REG_E0H.WORD = 0x81040000u;
            ...
            RX671_func102(change_endian_long(0xe068b3f8u), change_endian_long(0x7c60a63du), change_endian_long(0xf4474484u), change_endian_long(0x5e595fc3u));
            TSIP.REG_1BCH.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX671/RX671_p62.prc
 *********************************************************************************************************************/
