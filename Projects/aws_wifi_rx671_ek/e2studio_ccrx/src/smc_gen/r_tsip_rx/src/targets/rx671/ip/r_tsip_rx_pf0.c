...
*******************************************************************************************************************/ /**
* @details       RX671 Signature generation of ECDSA-192/224/256
* @param[in]     InData_Cmd
...
e_tsip_err_t R_TSIP_EcdsaSigunatureGenerateSub(uint32_t *InData_Cmd, uint32_t *InData_KeyIndex, uint32_t *InData_MsgDgst, const uint32_t *InData_DomainParam, uint32_t *OutData_Signature)
{
    ...
    RX671_func100(change_endian_long(0xec67b4a3u), change_endian_long(0x33cde472u), change_endian_long(0x52edf7fdu), change_endian_long(0x7194b66du));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX671_func102(change_endian_long(0x04893651u), change_endian_long(0x4a7e9091u), change_endian_long(0x7e29075du), change_endian_long(0x2a2c6979u));
    ...
    {
        RX671_func100(change_endian_long(0x93e9a5d0u), change_endian_long(0x5e525c8fu), change_endian_long(0xdfbd8dabu), change_endian_long(0x35b84c42u));
        ...
        RX671_func103();
        RX671_func100(change_endian_long(0x46e75aacu), change_endian_long(0x6c43aff4u), change_endian_long(0x68f8c758u), change_endian_long(0x43d34a19u));
        ...
        RX671_func100(change_endian_long(0x1983615du), change_endian_long(0x9cc79dadu), change_endian_long(0x4a8c825au), change_endian_long(0x3c9f85ceu));
        ...
        RX671_func100(change_endian_long(0xd0155f99u), change_endian_long(0x6d65b3b6u), change_endian_long(0x7c2791a2u), change_endian_long(0x72bd1b85u));
        TSIP.REG_1CH.WORD = 0x00400000u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            RX671_func102(change_endian_long(0xf0e4abe1u), change_endian_long(0xd3ed3333u), change_endian_long(0xfc320f54u), change_endian_long(0x7a24abaeu));
            TSIP.REG_1B8H.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
        ...
        {
            RX671_func100(change_endian_long(0xdb8a1568u), change_endian_long(0x550ff3a1u), change_endian_long(0x565c9d66u), change_endian_long(0x225777a9u));
            ...
            TSIP.REG_1CH.WORD = 0x00001f00u;
            TSIP.REG_1CH.WORD = 0x00210000u;
            RX671_func100(change_endian_long(0x5c5a73e7u), change_endian_long(0x78033c1du), change_endian_long(0x990a6584u), change_endian_long(0xb96de22cu));
            TSIP.REG_1CH.WORD = 0x00400000u;
            TSIP.REG_1D0H.WORD = 0x00000000u;
            if (1u == (TSIP.REG_1CH.BIT.B22))
            {
                RX671_func102(change_endian_long(0x54dbe4a4u), change_endian_long(0x8d312faeu), change_endian_long(0xd5a8d73fu), change_endian_long(0x0eec5e35u));
                TSIP.REG_1B8H.WORD = 0x00000040u;
                /* WAIT_LOOP */
                while (0u != TSIP.REG_18H.BIT.B12)
                {
            ...
            {
                RX671_func100(change_endian_long(0x47a31bedu), change_endian_long(0x4a8fd48eu), change_endian_long(0x5fb8d9bfu), change_endian_long(0x0cb70999u));
                TSIP.REG_34H.WORD = 0x00000800u;
                TSIP.REG_24H.WORD = 0x800068d0u;
                /* WAIT_LOOP */
                while (0u != TSIP.REG_24H.BIT.B21)
                ...
                TSIP.REG_1CH.WORD = 0x00001800u;
                RX671_func100(change_endian_long(0x37b7d683u), change_endian_long(0x99ba748fu), change_endian_long(0xa984b28bu), change_endian_long(0x4bc958bfu));
                TSIP.REG_1CH.WORD = 0x00400000u;
                TSIP.REG_1D0H.WORD = 0x00000000u;
                if (1u == (TSIP.REG_1CH.BIT.B22))
                {
                    RX671_func102(change_endian_long(0xccb8a432u), change_endian_long(0x5058f496u), change_endian_long(0x5e7639acu), change_endian_long(0x4a2761d7u));
                    TSIP.REG_1B8H.WORD = 0x00000040u;
                    /* WAIT_LOOP */
                    while (0u != TSIP.REG_18H.BIT.B12)
                    {
                ...
                else
                {
                    ...
                    TSIP.REG_1CH.WORD = 0x00001f00u;
                    TSIP.REG_1CH.WORD = 0x00210000u;
                    RX671_func100(change_endian_long(0x4c0ee5ffu), change_endian_long(0xc739e878u), change_endian_long(0x9ca49c93u), change_endian_long(0xa3bc5820u));
                    TSIP.REG_1CH.WORD = 0x00400000u;
                    TSIP.REG_1D0H.WORD = 0x00000000u;
                    if (1u == (TSIP.REG_1CH.BIT.B22))
                    {
                        RX671_func102(change_endian_long(0x1b344a22u), change_endian_long(0x9200d7adu), change_endian_long(0xeb2ef0a9u), change_endian_long(0x3601a373u));
                        TSIP.REG_1B8H.WORD = 0x00000040u;
                        /* WAIT_LOOP */
                        while (0u != TSIP.REG_18H.BIT.B12)
                        {
                    ...
                    {
                        RX671_func100(change_endian_long(0xf6a2c2cdu), change_endian_long(0xcbd2212eu), change_endian_long(0x3fb6ae6du), change_endian_long(0x85bbe001u));
                        ...
                        RX671_func100(change_endian_long(0xecbf5203u), change_endian_long(0xad8a7b1bu), change_endian_long(0x7c97e5a4u), change_endian_long(0x7ddb0c89u));
                        ...
                        RX671_func102(change_endian_long(0x6ab4b082u), change_endian_long(0x51bf3e5au), change_endian_long(0x7cc95b1au), change_endian_long(0x6dcac2a4u));
                        TSIP.REG_1B8H.WORD = 0x00000040u;
                        /* WAIT_LOOP */
                        while (0u != TSIP.REG_18H.BIT.B12)
                        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX671/RX671_pf0_r1.prc
 *********************************************************************************************************************/
