...
*******************************************************************************************************************/ /**
* @details       RX671 RSA-4096 Public Key Install
...
e_tsip_err_t R_TSIP_GenerateRsa4096PublicKeyIndexSub(uint32_t *InData_SharedKeyIndex, uint32_t *InData_SessionKey, uint32_t *InData_IV, uint32_t *InData_InstData, uint32_t *OutData_KeyIndex)
{
    ...
    RX671_func100(change_endian_long(0x13399eb8u), change_endian_long(0xe99f326cu), change_endian_long(0x68e59effu), change_endian_long(0x01c1ccb0u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX671_func102(change_endian_long(0x497fa6f3u), change_endian_long(0x7b9852f9u), change_endian_long(0xb269fd95u), change_endian_long(0x85bcae44u));
    ...
    {
        RX671_func100(change_endian_long(0xebec8a17u), change_endian_long(0x97f7b5bcu), change_endian_long(0xbfe4b167u), change_endian_long(0x04475fa4u));
        ...
        RX671_func100(change_endian_long(0x53083324u), change_endian_long(0x9e12a284u), change_endian_long(0xafa65c4bu), change_endian_long(0x0f15b9b3u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX671_func100(change_endian_long(0x3bf1feabu), change_endian_long(0x36daa3acu), change_endian_long(0xe156f134u), change_endian_long(0x91c03f6bu));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX671_func100(change_endian_long(0x8a184eabu), change_endian_long(0x152c095bu), change_endian_long(0x28a501a2u), change_endian_long(0xe7e6f705u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX671_func103();
        RX671_func100(change_endian_long(0x8921dd3eu), change_endian_long(0x67339bcfu), change_endian_long(0xb3bcbc63u), change_endian_long(0x7b9b75beu));
        ...
        RX671_func100(change_endian_long(0x47e4f86cu), change_endian_long(0x02cfa0ddu), change_endian_long(0x7973f6c0u), change_endian_long(0xf49d4caau));
        TSIP.REG_00H.WORD = 0x00012103u;
        TSIP.REG_104H.WORD = 0x00000031u;
        TSIP.REG_B0H.WORD = 0x00000f00u;
        TSIP.REG_A4H.WORD = 0x00d0c9a7u;
        ...
        RX671_func100(change_endian_long(0x173e6342u), change_endian_long(0xc069e99bu), change_endian_long(0x609558c5u), change_endian_long(0x9cf45789u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX671_func100(change_endian_long(0x2d860e14u), change_endian_long(0x4d9fd61eu), change_endian_long(0x080de2dau), change_endian_long(0x491a8678u));
        TSIP.REG_104H.WORD = 0x00000052u;
        ...
        TSIP.REG_1CH.WORD = 0x00001800u;
        RX671_func100(change_endian_long(0xe32786b2u), change_endian_long(0x2364f9dbu), change_endian_long(0x5149e146u), change_endian_long(0x9f15c504u));
        TSIP.REG_1CH.WORD = 0x00400000u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            RX671_func102(change_endian_long(0xda720f1du), change_endian_long(0x97465f90u), change_endian_long(0x2a43330du), change_endian_long(0x789bdd04u));
            TSIP.REG_1B4H.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
        ...
        {
            RX671_func100(change_endian_long(0x89f9b946u), change_endian_long(0xe04d3ea5u), change_endian_long(0xd9213ce6u), change_endian_long(0xc5e85531u));
            TSIP.REG_E0H.WORD = 0x81040000u;
            ...
            RX671_func102(change_endian_long(0x2b2929b1u), change_endian_long(0x3374d5dcu), change_endian_long(0x68655d15u), change_endian_long(0x052a1f93u));
            TSIP.REG_1B4H.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX671/RX671_pab.prc
 *********************************************************************************************************************/
