...
*******************************************************************************************************************/ /**
* @details       RX671 Update 256bit AES Key
* @param[in]     InData_IV
...
e_tsip_err_t R_TSIP_UpdateAes256KeyIndexSub(uint32_t *InData_IV, uint32_t *InData_InstData, uint32_t *OutData_KeyIndex)
{
    ...
    RX671_func100(change_endian_long(0xd4482975u), change_endian_long(0x30b18bf9u), change_endian_long(0x56875b76u), change_endian_long(0x0021f657u));
    ...
    RX671_func100(change_endian_long(0x3d201bc9u), change_endian_long(0xb31ae43eu), change_endian_long(0xd2524a7du), change_endian_long(0xbe310cecu));
    ...
    RX671_func100(change_endian_long(0xec946bf0u), change_endian_long(0xa8ae22bau), change_endian_long(0x54ce3003u), change_endian_long(0x1f9fab20u));
    TSIP.REG_104H.WORD = 0x00000361u;
    ...
    RX671_func103();
    RX671_func100(change_endian_long(0x37c685f9u), change_endian_long(0x3b107ff9u), change_endian_long(0xbfb0b07bu), change_endian_long(0x4dca3f38u));
    ...
    RX671_func100(change_endian_long(0x04ba720cu), change_endian_long(0x1b59d4beu), change_endian_long(0xdf879130u), change_endian_long(0x4bee4368u));
    TSIP.REG_104H.WORD = 0x00000052u;
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX671_func100(change_endian_long(0x26cc28d3u), change_endian_long(0xb03d5af7u), change_endian_long(0x4d642033u), change_endian_long(0x8a32eae9u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX671_func102(change_endian_long(0xc441dbf0u), change_endian_long(0x0521127fu), change_endian_long(0xa7fcd8c9u), change_endian_long(0xf399c2acu));
    ...
    {
        RX671_func100(change_endian_long(0x163758d9u), change_endian_long(0x43f2ae6fu), change_endian_long(0x903d464du), change_endian_long(0x764b9415u));
        TSIP.REG_E0H.WORD = 0x81040000u;
        ...
        RX671_func102(change_endian_long(0x8e024f84u), change_endian_long(0x54fc233du), change_endian_long(0xdeef3e01u), change_endian_long(0xb3d9e6d7u));
        TSIP.REG_1B4H.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX671/RX671_p06.prc
 *********************************************************************************************************************/
