...
/***********************************************************************************************************************
* Function Name: RX671_func040
*******************************************************************************************************************/ /**
* @details       RX671 func040
* @param[in]     ARG1
* @note          None
*/
void RX671_func040(const uint32_t* ARG1)
{
    ...
    for (iLoop = 0; iLoop < 16; iLoop = iLoop + 4)
    {
        ...
        TSIP.REG_100H.WORD = ARG1[iLoop+36];
        TSIP.REG_100H.WORD = ARG1[iLoop+37];
        TSIP.REG_100H.WORD = ARG1[iLoop+38];
        TSIP.REG_100H.WORD = ARG1[iLoop+39];
    }
    /* WAIT_LOOP */
    ...
    for (iLoop = 32; iLoop < 48; iLoop = iLoop + 4)
    {
        /* WAIT_LOOP */
        while (1u != TSIP.REG_104H.BIT.B31)
        {
    ...
    for (iLoop = 48; iLoop < 64; iLoop = iLoop + 4)
    {
        /* WAIT_LOOP */
        while (1u != TSIP.REG_104H.BIT.B31)
        {
    ...
    for (iLoop = 64; iLoop < 80; iLoop = iLoop + 4)
    {
        /* WAIT_LOOP */
        while (1u != TSIP.REG_104H.BIT.B31)
        {
    ...
    for (iLoop = 80; iLoop < 96; iLoop = iLoop + 4)
    {
        /* WAIT_LOOP */
        while (1u != TSIP.REG_104H.BIT.B31)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX671/RX671_func040_r1.prc
 *********************************************************************************************************************/
