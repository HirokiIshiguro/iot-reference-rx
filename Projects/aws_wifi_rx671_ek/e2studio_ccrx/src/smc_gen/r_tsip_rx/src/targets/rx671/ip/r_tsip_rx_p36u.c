...
*******************************************************************************************************************/ /**
* @details       RX671 AES-256 Decryption with GCM Mode Update
...
void R_TSIP_Aes256GcmDecryptUpdateSub(uint32_t *InData_Text, uint32_t *OutData_Text, uint32_t MAX_CNT)
{
    ...
    (void)KEY_ADR;
    (void)OFS_ADR;
    RX671_func100(change_endian_long(0xf45ddc02u), change_endian_long(0xca71fb89u), change_endian_long(0xd7c53743u), change_endian_long(0x45e90871u));
    ...
    RX671_func101(change_endian_long(0x75ab48b7u), change_endian_long(0x10acd9c6u), change_endian_long(0x63a5dec8u), change_endian_long(0x29b6282bu));
}
/**********************************************************************************************************************
 End of function ./input_dir/RX671/RX671_p36u_r1.prc
 *********************************************************************************************************************/
