...
*******************************************************************************************************************/ /**
* @details       RX671 Create 128bit AES Key
...
e_tsip_err_t R_TSIP_GenerateAes128RandomKeyIndexSub(uint32_t *OutData_KeyIndex)
{
    ...
    RX671_func100(change_endian_long(0xd6a5fd6cu), change_endian_long(0xab8d49f1u), change_endian_long(0xebbf39d4u), change_endian_long(0x4d163a2au));
    RX671_func103();
    ...
    RX671_func100(change_endian_long(0xd37f4289u), change_endian_long(0x9aafe43du), change_endian_long(0xa00867edu), change_endian_long(0x639a9107u));
    ...
    RX671_func100(change_endian_long(0x836d9a30u), change_endian_long(0xd16a92cfu), change_endian_long(0x0a1315a7u), change_endian_long(0x4d4bac51u));
    RX671_func103();
    TSIP.REG_104H.WORD = 0x00000052u;
    TSIP.REG_C4H.WORD = 0x01000c84u;
    /* WAIT_LOOP */
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX671_func100(change_endian_long(0xd3e0215fu), change_endian_long(0xa02b0f1au), change_endian_long(0xaf2a8d08u), change_endian_long(0xe1918d38u));
    ...
    RX671_func102(change_endian_long(0x3c6c9677u), change_endian_long(0xd6df0258u), change_endian_long(0x285e18b7u), change_endian_long(0x889788c0u));
...
/**********************************************************************************************************************
 End of function ./input_dir/RX671/RX671_p07.prc
 *********************************************************************************************************************/
