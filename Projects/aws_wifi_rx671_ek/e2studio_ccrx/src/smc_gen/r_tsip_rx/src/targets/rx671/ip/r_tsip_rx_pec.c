...
*******************************************************************************************************************/ /**
* @details       RX671 TLS1.3 Handshake Secret Generation
...
e_tsip_err_t R_TSIP_Tls13GenerateHandshakeSecretSub(uint32_t *InData_SharedSecretKeyIndex, uint32_t *OutData_Handshake_SecretKeyIndex)
{
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX671_func100(change_endian_long(0xc6f08067u), change_endian_long(0xf4a07cd0u), change_endian_long(0x23ea85aau), change_endian_long(0xbd319f13u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX671_func102(change_endian_long(0x1378e06au), change_endian_long(0x2b39dc95u), change_endian_long(0xcb790592u), change_endian_long(0x6ad1689bu));
    ...
    else
    {
        ...
        RX671_func070();
        RX671_func100(change_endian_long(0xd43d0552u), change_endian_long(0xd3aaeef8u), change_endian_long(0x8623cf02u), change_endian_long(0xe55ff24bu));
        ...
        RX671_func100(change_endian_long(0x4b0dab41u), change_endian_long(0xfe01f127u), change_endian_long(0xdf0ad287u), change_endian_long(0x56e5337au));
        TSIP.REG_E0H.WORD = 0x81040280u;
        ...
        RX671_func102(change_endian_long(0xaa12f0e6u), change_endian_long(0x8e9d81ffu), change_endian_long(0x3062f114u), change_endian_long(0xd5285c89u));
        TSIP.REG_1BCH.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX671/RX671_pec.prc
 *********************************************************************************************************************/
