...
*******************************************************************************************************************/ /**
* @details       RX671 AES-256 Encryption with CCM Mode Update
...
void R_TSIP_Aes256CcmEncryptUpdateSub(uint32_t *InData_Text, uint32_t *OutData_Text, uint32_t MAX_CNT)
{
    ...
    (void)KEY_ADR;
    (void)OFS_ADR;
    RX671_func100(change_endian_long(0xf553c111u), change_endian_long(0xdf421e0fu), change_endian_long(0xd988036cu), change_endian_long(0x37fd55acu));
    ...
    RX671_func101(change_endian_long(0x5efa7a96u), change_endian_long(0xc99e9b81u), change_endian_long(0x8b84af15u), change_endian_long(0xce8e5fd4u));
}
/**********************************************************************************************************************
 End of function ./input_dir/RX671/RX671_pa1u_r1.prc
 *********************************************************************************************************************/
