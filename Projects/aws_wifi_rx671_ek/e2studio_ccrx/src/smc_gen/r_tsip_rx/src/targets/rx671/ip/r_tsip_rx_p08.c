...
*******************************************************************************************************************/ /**
* @details       RX671 Create 256bit AES Key
...
e_tsip_err_t R_TSIP_GenerateAes256RandomKeyIndexSub(uint32_t *OutData_KeyIndex)
{
    ...
    RX671_func100(change_endian_long(0x508dfa3au), change_endian_long(0xcdcb635bu), change_endian_long(0x5aee7fa0u), change_endian_long(0x3e68cdd2u));
    RX671_func103();
    ...
    RX671_func100(change_endian_long(0x13cc6cacu), change_endian_long(0x71a99af7u), change_endian_long(0xf88e4d9fu), change_endian_long(0x2182f20cu));
    ...
    RX671_func100(change_endian_long(0x33462060u), change_endian_long(0x46add175u), change_endian_long(0x1678404bu), change_endian_long(0x8dd67981u));
    RX671_func103();
    TSIP.REG_104H.WORD = 0x00000052u;
    TSIP.REG_C4H.WORD = 0x01000c84u;
    /* WAIT_LOOP */
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX671_func100(change_endian_long(0x78b56dacu), change_endian_long(0xa086264au), change_endian_long(0xe9f6d14fu), change_endian_long(0xe357e5d1u));
    RX671_func103();
    TSIP.REG_104H.WORD = 0x00000052u;
    TSIP.REG_C4H.WORD = 0x01000c84u;
    /* WAIT_LOOP */
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX671_func100(change_endian_long(0xb97f93d4u), change_endian_long(0x94a133f1u), change_endian_long(0xe6ac5489u), change_endian_long(0x7c5ce0afu));
    ...
    RX671_func102(change_endian_long(0x72bc2150u), change_endian_long(0x04688492u), change_endian_long(0xffd09775u), change_endian_long(0xb8a1623bu));
...
/**********************************************************************************************************************
 End of function ./input_dir/RX671/RX671_p08.prc
 *********************************************************************************************************************/
