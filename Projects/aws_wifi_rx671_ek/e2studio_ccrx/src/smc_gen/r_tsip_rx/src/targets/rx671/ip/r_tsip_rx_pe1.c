...
e_tsip_err_t R_TSIP_TlsCertificateVerificationSub(uint32_t *InData_Sel_InDataPubKeyType, uint32_t *InData_Sel_OutDataPubKeyType, uint32_t *InData_PubKey, uint32_t *InData_TBSCertificate, uint32_t *InData_TBSCertificateLength, uint32_t *InData_Signature, uint32_t *InData_TBSCertificateInfo, const uint32_t *InData_DomainParam, uint32_t *OutData_PubKey)
{
    ...
    RX671_func101(change_endian_long(0x3c862ca3u), change_endian_long(0xd92808bbu), change_endian_long(0x3f00cc8eu), change_endian_long(0x99b206c8u));
    RX671_func403(InData_Sel_InDataPubKeyType, InData_Sel_OutDataPubKeyType, InData_PubKey, InData_TBSCertificate, InData_TBSCertificateLength, InData_Signature, InData_TBSCertificateInfo, InData_DomainParam, OutData_PubKey);
    TSIP.REG_ECH.WORD = 0x38000c00u;
    TSIP.REG_E0H.WORD = 0x00000080u;
    TSIP.REG_1CH.WORD = 0x00A60000u;
    RX671_func100(change_endian_long(0x894a6346u), change_endian_long(0x23e29021u), change_endian_long(0xc465ed0eu), change_endian_long(0x42ae7e01u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX671_func102(change_endian_long(0xbfffec5bu), change_endian_long(0xf197f1c0u), change_endian_long(0x5f41067eu), change_endian_long(0x41adecaau));
    ...
    {
        RX671_func102(change_endian_long(0xf9ef156bu), change_endian_long(0x0224d87eu), change_endian_long(0x6c0884a9u), change_endian_long(0x3eae79f7u));
        TSIP.REG_1B8H.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX671/RX671_pe1_r4.prc
 *********************************************************************************************************************/
#endif /* #if TSIP_TLS == 1 */
