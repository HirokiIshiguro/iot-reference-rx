...
/***********************************************************************************************************************
* Function Name: RX671_func006
*******************************************************************************************************************/ /**
* @details       RX671 func006
* @note          None
*/
void RX671_func006(void)
{
    ...
    (void)KEY_ADR;
    (void)OFS_ADR;
    RX671_func100(change_endian_long(0x0c7821beu), change_endian_long(0x664cca89u), change_endian_long(0xa8bb7497u), change_endian_long(0x3fdedddau));
    ...
    RX671_func100(change_endian_long(0x96621d66u), change_endian_long(0x5b48710fu), change_endian_long(0x28270d66u), change_endian_long(0xf5e66ce9u));
    TSIP.REG_24H.WORD = 0x00001dc0u;
    /* WAIT_LOOP */
    while (0u != TSIP.REG_24H.BIT.B21)
    {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX671/RX671_func006.prc
 *********************************************************************************************************************/
