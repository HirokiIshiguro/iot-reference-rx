...
e_tsip_err_t R_TSIP_TlsGenerateSessionKeySub(uint32_t *InData_Sel_CipherSuite, uint32_t *InData_MasterSecret, uint32_t *InData_ClientRandom, uint32_t *InData_ServerRandom, uint32_t *InData_NonceExplicit, uint32_t *OutData_ClientMACKeyOperationCode, uint32_t *OutData_ServerMACKeyOperationCode, uint32_t *OutData_ClientEncKeyOperationCode, uint32_t *OutData_ServerEncKeyOperationCode, uint32_t* OutData_ClientIV, uint32_t* OutData_ServerIV)
{
    ...
    RX671_func101(change_endian_long(0xba612ad1u), change_endian_long(0xc393de34u), change_endian_long(0xf6f9232au), change_endian_long(0xcbbfc53au));
    RX671_func404(InData_Sel_CipherSuite, InData_MasterSecret, InData_ClientRandom, InData_NonceExplicit, OutData_ClientMACKeyOperationCode, OutData_ServerMACKeyOperationCode, OutData_ClientEncKeyOperationCode, OutData_ServerEncKeyOperationCode, OutData_ClientIV, OutData_ServerIV);
    TSIP.REG_ECH.WORD = 0x38000c00u;
    TSIP.REG_E0H.WORD = 0x00000080u;
    TSIP.REG_1CH.WORD = 0x00A60000u;
    RX671_func100(change_endian_long(0xf1c91bbcu), change_endian_long(0x1eeadebdu), change_endian_long(0x91d17925u), change_endian_long(0x49102244u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX671_func102(change_endian_long(0x835088fdu), change_endian_long(0xf1cc2200u), change_endian_long(0x073e4557u), change_endian_long(0x08746b78u));
    ...
    {
        RX671_func102(change_endian_long(0x93b798cdu), change_endian_long(0x20eedb6au), change_endian_long(0x17556e3du), change_endian_long(0x1d79aa83u));
        TSIP.REG_1BCH.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX671/RX671_pe5_r2.prc
 *********************************************************************************************************************/
#endif /* #if TSIP_TLS == 1 */
