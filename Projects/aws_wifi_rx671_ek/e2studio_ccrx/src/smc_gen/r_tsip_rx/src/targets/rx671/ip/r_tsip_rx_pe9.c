...
*******************************************************************************************************************/ /**
* @details       RX671 TLS P-256 ECC Key Generation
...
e_tsip_err_t R_TSIP_GenerateTlsP256EccKeyIndexSub(const uint32_t *InData_DomainParam, uint32_t *OutData_KeyIndex, uint32_t *OutData_PubKey)
{
    ...
    RX671_func100(change_endian_long(0x00cec2d2u), change_endian_long(0x75fe854cu), change_endian_long(0x54b65af8u), change_endian_long(0xc66883c3u));
    RX671_func103();
    ...
    RX671_func100(change_endian_long(0x612e887eu), change_endian_long(0xddf6ca0cu), change_endian_long(0x22df9008u), change_endian_long(0x141643a9u));
    RX671_func103();
    TSIP.REG_104H.WORD = 0x00000052u;
    TSIP.REG_C4H.WORD = 0x01000c84u;
    /* WAIT_LOOP */
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX671_func100(change_endian_long(0xff220f2du), change_endian_long(0x7f947512u), change_endian_long(0xa7b76a36u), change_endian_long(0xa0be32b6u));
    RX671_func103();
    TSIP.REG_104H.WORD = 0x00000052u;
    TSIP.REG_C4H.WORD = 0x01000c84u;
    /* WAIT_LOOP */
    ...
    RX671_func100(change_endian_long(0x11880c26u), change_endian_long(0x80f1da73u), change_endian_long(0x97b2245fu), change_endian_long(0x4a23ff77u));
    ...
    RX671_func100(change_endian_long(0x4ea11667u), change_endian_long(0x857aa572u), change_endian_long(0xd131b7e6u), change_endian_long(0x69d8ae83u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX671_func102(change_endian_long(0xc8852f82u), change_endian_long(0xd327222eu), change_endian_long(0xc163d5fbu), change_endian_long(0x261ef97cu));
    ...
    {
        RX671_func100(change_endian_long(0x7c674922u), change_endian_long(0x98351537u), change_endian_long(0xf3cf8531u), change_endian_long(0x1c531feeu));
        ...
        RX671_func100(change_endian_long(0x39d95814u), change_endian_long(0xe62d9f9cu), change_endian_long(0x21ad26cfu), change_endian_long(0xb91f5369u));
        RX671_func103();
        RX671_func100(change_endian_long(0xabf05631u), change_endian_long(0xb5f3aee2u), change_endian_long(0x70143a8fu), change_endian_long(0x77a002b7u));
        TSIP.REG_104H.WORD = 0x00000052u;
        TSIP.REG_C4H.WORD = 0x01000c84u;
        /* WAIT_LOOP */
        while (1u != TSIP.REG_104H.BIT.B31)
        ...
        RX671_func100(change_endian_long(0xff6cd027u), change_endian_long(0x6b81e1f0u), change_endian_long(0xf6262977u), change_endian_long(0x40f7c98fu));
        TSIP.REG_104H.WORD = 0x00000052u;
        ...
        RX671_func100(change_endian_long(0x291b4d0cu), change_endian_long(0xf3bbbe17u), change_endian_long(0x2f5a28b3u), change_endian_long(0x5be91be2u));
        TSIP.REG_E0H.WORD = 0x81040000u;
        ...
        RX671_func100(change_endian_long(0x79ce21dau), change_endian_long(0x21d00058u), change_endian_long(0xb5364a7fu), change_endian_long(0x602876f1u));
        ...
        RX671_func100(change_endian_long(0xbe4e170eu), change_endian_long(0xfbccd3f4u), change_endian_long(0x224acf33u), change_endian_long(0x6fd45578u));
        ...
        RX671_func102(change_endian_long(0x55d6cbefu), change_endian_long(0xbacfbd93u), change_endian_long(0x2253fca8u), change_endian_long(0x2d5b176cu));
        TSIP.REG_1B8H.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX671/RX671_pe9_r1.prc
 *********************************************************************************************************************/
