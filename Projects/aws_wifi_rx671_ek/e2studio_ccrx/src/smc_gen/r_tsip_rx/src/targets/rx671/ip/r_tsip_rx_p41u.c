...
*******************************************************************************************************************/ /**
* @details       RX671 AES-128 CMAC generation/verification Update
...
void R_TSIP_Aes128CmacUpdateSub(uint32_t *InData_Text, uint32_t MAX_CNT)
{
    ...
    RX671_func101(change_endian_long(0xcfcc0dd9u), change_endian_long(0x23201695u), change_endian_long(0x3966fe77u), change_endian_long(0x07e95d3fu));
}
/**********************************************************************************************************************
 End of function ./input_dir/RX671/RX671_p41u.prc
 *********************************************************************************************************************/
