...
*******************************************************************************************************************/ /**
* @details       RX671 RSA-2048 DH Key Exchange
...
e_tsip_err_t R_TSIP_Rsa2048DhKeyAgreementSub(uint32_t *InData_KeyIndex, uint32_t *InData_PrimNumIndex, uint32_t *InData_Message, uint32_t *InData_ModExp, uint32_t *OutData_ModExp)
{
    ...
    RX671_func100(change_endian_long(0xdc184f14u), change_endian_long(0x058598bfu), change_endian_long(0x5d737b86u), change_endian_long(0x5b5ddf2fu));
    ...
    RX671_func100(change_endian_long(0x8b4fda61u), change_endian_long(0x5781f923u), change_endian_long(0x62fd362fu), change_endian_long(0x07eb04aau));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX671_func102(change_endian_long(0xfdd9d2a6u), change_endian_long(0x5f305c13u), change_endian_long(0x8c8d520fu), change_endian_long(0x30a50f62u));
    ...
    else
    {
        ...
        TSIP.REG_1CH.WORD = 0x00001800u;
        RX671_func100(change_endian_long(0x4c1d7f70u), change_endian_long(0xd16a7b96u), change_endian_long(0xa19c73acu), change_endian_long(0x85601e5cu));
        TSIP.REG_1CH.WORD = 0x00400000u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            RX671_func102(change_endian_long(0x2751482cu), change_endian_long(0xbcabffbdu), change_endian_long(0x3fe9c725u), change_endian_long(0x10f0cb40u));
            TSIP.REG_1B8H.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
        ...
        else
        {
            ...
            {
                RX671_func100(change_endian_long(0x2b21ddc3u), change_endian_long(0x8c561b03u), change_endian_long(0xa6aa141eu), change_endian_long(0xa078104au));
                RX671_func103();
                ...
                TSIP.REG_1CH.WORD = 0x00001800u;
                RX671_func101(change_endian_long(0xf4f9427fu), change_endian_long(0x4bbe2c2cu), change_endian_long(0xf378d7cfu), change_endian_long(0x961221a4u));
            }
            ...
            RX671_func100(change_endian_long(0x2cf55607u), change_endian_long(0x9198404eu), change_endian_long(0x9f72f2deu), change_endian_long(0xeb44603bu));
            ...
            RX671_func100(change_endian_long(0xd716b587u), change_endian_long(0xf9664191u), change_endian_long(0x63a9f49cu), change_endian_long(0x0efca672u));
            ...
            TSIP.REG_1CH.WORD = 0x00001800u;
            RX671_func100(change_endian_long(0x2e32ec22u), change_endian_long(0x5f201fe9u), change_endian_long(0x9542f1b7u), change_endian_long(0x4448c450u));
            TSIP.REG_104H.WORD = 0x00000052u;
            ...
            OutData_ModExp[iLoop + 2] = TSIP.REG_100H.WORD;
            OutData_ModExp[iLoop + 3] = TSIP.REG_100H.WORD;
            RX671_func100(change_endian_long(0xbadfd106u), change_endian_long(0x6ea73b40u), change_endian_long(0x53031ab2u), change_endian_long(0xa2346ba5u));
            TSIP.REG_104H.WORD = 0x00000052u;
            ...
            TSIP.REG_1CH.WORD = 0x00001800u;
            RX671_func100(change_endian_long(0xaea4193cu), change_endian_long(0x34568691u), change_endian_long(0x10c8cef9u), change_endian_long(0x46e61543u));
            TSIP.REG_1CH.WORD = 0x00400000u;
            TSIP.REG_1D0H.WORD = 0x00000000u;
            if (1u == (TSIP.REG_1CH.BIT.B22))
            {
                RX671_func102(change_endian_long(0x0aa750d1u), change_endian_long(0x5b33a6b6u), change_endian_long(0xa9b2f5c1u), change_endian_long(0xc4617478u));
                TSIP.REG_1B8H.WORD = 0x00000040u;
                /* WAIT_LOOP */
                while (0u != TSIP.REG_18H.BIT.B12)
                {
            ...
            else
            {
                ...
                TSIP.REG_18H.WORD = 0x00000000u;
                RX671_func100(change_endian_long(0x59151f44u), change_endian_long(0x022ced95u), change_endian_long(0x64dd06d4u), change_endian_long(0x98ec261du));
                TSIP.REG_E0H.WORD = 0x00000100u;
                TSIP.REG_ECH.WORD = 0x0000b7e0u;
                TSIP.REG_ECH.WORD = 0x000000fcu;
                TSIP.REG_18H.WORD = 0x00000004u;
                ...
                TSIP.REG_18H.WORD = 0x00000000u;
                TSIP.REG_E0H.WORD = 0x00000000u;
                RX671_func102(change_endian_long(0xeddef598u), change_endian_long(0x5dd28e55u), change_endian_long(0x3e253d0fu), change_endian_long(0xa19dc7f0u));
                TSIP.REG_1B8H.WORD = 0x00000040u;
                /* WAIT_LOOP */
                while (0u != TSIP.REG_18H.BIT.B12)
                {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX671/RX671_p94.prc
 *********************************************************************************************************************/
