...
*******************************************************************************************************************/ /**
* @details       RX671 Update 128bit AES Key
* @param[in]     InData_IV
...
e_tsip_err_t R_TSIP_UpdateAes128KeyIndexSub(uint32_t *InData_IV, uint32_t *InData_InstData, uint32_t *OutData_KeyIndex)
{
    ...
    RX671_func100(change_endian_long(0x5e9a62dau), change_endian_long(0x43ef160cu), change_endian_long(0x205d1057u), change_endian_long(0xeaa808a7u));
    ...
    RX671_func100(change_endian_long(0x68b654c4u), change_endian_long(0x733b46cdu), change_endian_long(0x6785617bu), change_endian_long(0xe89e0a90u));
    ...
    RX671_func100(change_endian_long(0x06beb21bu), change_endian_long(0xb7c47e00u), change_endian_long(0x8c4cec68u), change_endian_long(0xd25e2f3cu));
    TSIP.REG_104H.WORD = 0x00000361u;
    ...
    RX671_func103();
    RX671_func100(change_endian_long(0xa308d38du), change_endian_long(0x5e5b171eu), change_endian_long(0x4db236ddu), change_endian_long(0x0f024186u));
    ...
    RX671_func100(change_endian_long(0xc514a1d2u), change_endian_long(0x6060e51du), change_endian_long(0xd821f2ccu), change_endian_long(0xdc5699b0u));
    TSIP.REG_104H.WORD = 0x00000052u;
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX671_func100(change_endian_long(0x47abde6du), change_endian_long(0x039c903bu), change_endian_long(0xe5c576ccu), change_endian_long(0x13ca9c89u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX671_func102(change_endian_long(0xb80430e2u), change_endian_long(0xc916eee5u), change_endian_long(0xb3c71f13u), change_endian_long(0x833522cfu));
    ...
    {
        RX671_func100(change_endian_long(0xcfd38085u), change_endian_long(0xf2bc2bf3u), change_endian_long(0xe8d487cau), change_endian_long(0x6f4ef9afu));
        TSIP.REG_E0H.WORD = 0x81040000u;
        ...
        RX671_func102(change_endian_long(0x7c31d0c9u), change_endian_long(0x3b7242ebu), change_endian_long(0x7c735ad2u), change_endian_long(0x73599f8cu));
        TSIP.REG_1B4H.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX671/RX671_p05.prc
 *********************************************************************************************************************/
