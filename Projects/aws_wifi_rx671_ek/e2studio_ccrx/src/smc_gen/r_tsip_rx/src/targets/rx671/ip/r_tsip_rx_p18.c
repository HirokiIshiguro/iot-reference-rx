...
*******************************************************************************************************************/ /**
* @details       RX671 Generate key for TDES
...
e_tsip_err_t R_TSIP_GenerateTdesRandomKeyIndexSub(uint32_t *OutData_KeyIndex)
{
    ...
    RX671_func100(change_endian_long(0xb9168710u), change_endian_long(0xe6df49c3u), change_endian_long(0x6dd0c5b8u), change_endian_long(0x4174a079u));
    RX671_func103();
    ...
    RX671_func100(change_endian_long(0x5f0f9df8u), change_endian_long(0xed123b67u), change_endian_long(0x2cbb1eaeu), change_endian_long(0xb3c5f174u));
    ...
    RX671_func100(change_endian_long(0x8737f9c8u), change_endian_long(0x1b97e3adu), change_endian_long(0xe016c7c9u), change_endian_long(0xb8b21acdu));
    RX671_func103();
    TSIP.REG_104H.WORD = 0x00000052u;
    TSIP.REG_C4H.WORD = 0x01000c84u;
    /* WAIT_LOOP */
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX671_func100(change_endian_long(0x3a3df1a3u), change_endian_long(0xaafec043u), change_endian_long(0x87fbafd4u), change_endian_long(0xa93881ddu));
    RX671_func103();
    TSIP.REG_104H.WORD = 0x00000052u;
    TSIP.REG_C4H.WORD = 0x01000c84u;
    /* WAIT_LOOP */
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX671_func100(change_endian_long(0xb313a826u), change_endian_long(0x0c6e8e42u), change_endian_long(0x7f24d2c4u), change_endian_long(0xb98c1e0fu));
    ...
    RX671_func102(change_endian_long(0xe0c9a419u), change_endian_long(0x90c182d1u), change_endian_long(0xcc481204u), change_endian_long(0x2ff58801u));
...
/**********************************************************************************************************************
 End of function ./input_dir/RX671/RX671_p18.prc
 *********************************************************************************************************************/
