...
*******************************************************************************************************************/ /**
* @details       RX671 TLS PreMasterSecret Generation with ECC P-256 Key
...
* @note          None
*/
e_tsip_err_t R_TSIP_TlsGeneratePreMasterSecretWithEccP256KeySub(uint32_t *InData_PubKey, uint32_t *InData_KeyIndex, const uint32_t *InData_DomainParam, uint32_t *OutData_PreMasterSecretIndex)
{
    ...
    RX671_func100(change_endian_long(0x875058e7u), change_endian_long(0xd913e9f9u), change_endian_long(0x3e58623au), change_endian_long(0xb58fb4edu));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX671_func102(change_endian_long(0x24f1f0bau), change_endian_long(0x3bad7b30u), change_endian_long(0x2aafcc79u), change_endian_long(0xec24b9fbu));
    ...
    else
    {
        ...
        TSIP.REG_1CH.WORD = 0x00001800u;
        RX671_func100(change_endian_long(0x85abc3f3u), change_endian_long(0x698a223bu), change_endian_long(0xde485c34u), change_endian_long(0x6a6907f5u));
        TSIP.REG_1CH.WORD = 0x00400000u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            RX671_func102(change_endian_long(0x18a2bad2u), change_endian_long(0xfd1c150eu), change_endian_long(0x40f00f9eu), change_endian_long(0xc67f101eu));
            TSIP.REG_1B8H.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
        ...
        else
        {
            ...
            TSIP.REG_E0H.WORD = 0x00000080u;
            TSIP.REG_1CH.WORD = 0x00A60000u;
            RX671_func100(change_endian_long(0x3ea2e5bcu), change_endian_long(0x89c43d81u), change_endian_long(0xd106a9a2u), change_endian_long(0x8bed31bcu));
            TSIP.REG_1CH.WORD = 0x00400000u;
            TSIP.REG_1D0H.WORD = 0x00000000u;
            if (1u == (TSIP.REG_1CH.BIT.B22))
            {
                RX671_func102(change_endian_long(0x84189392u), change_endian_long(0x42523b02u), change_endian_long(0xaa634e8cu), change_endian_long(0x6987a922u));
                TSIP.REG_1B8H.WORD = 0x00000040u;
                /* WAIT_LOOP */
                while (0u != TSIP.REG_18H.BIT.B12)
                {
            ...
            else
            {
                ...
                TSIP.REG_1CH.WORD = 0x00001800u;
                RX671_func100(change_endian_long(0x5bafb4ddu), change_endian_long(0x7d5a12adu), change_endian_long(0xb9c00397u), change_endian_long(0xa8b20aa0u));
                TSIP.REG_1CH.WORD = 0x00400000u;
                TSIP.REG_1D0H.WORD = 0x00000000u;
                if (1u == (TSIP.REG_1CH.BIT.B22))
                {
                    RX671_func102(change_endian_long(0x3c21e15au), change_endian_long(0xc766450bu), change_endian_long(0xf7cf2794u), change_endian_long(0x4b04a147u));
                    TSIP.REG_1B8H.WORD = 0x00000040u;
                    /* WAIT_LOOP */
                    while (0u != TSIP.REG_18H.BIT.B12)
                    {
                ...
                {
                    RX671_func100(change_endian_long(0x4c2e7351u), change_endian_long(0xca9c1671u), change_endian_long(0xa700feddu), change_endian_long(0xb2f43a8au));
                    ...
                    RX671_func100(change_endian_long(0x8020a359u), change_endian_long(0xbe1fb861u), change_endian_long(0x8da4a3cbu), change_endian_long(0x8ea09adeu));
                    TSIP.REG_1CH.WORD = 0x00400000u;
                    TSIP.REG_1D0H.WORD = 0x00000000u;
                    if (1u == (TSIP.REG_1CH.BIT.B22))
                    {
                        RX671_func102(change_endian_long(0xc1989b08u), change_endian_long(0x91a48cabu), change_endian_long(0x3333c7b9u), change_endian_long(0xd96ca1c0u));
                        TSIP.REG_1B8H.WORD = 0x00000040u;
                        /* WAIT_LOOP */
                        while (0u != TSIP.REG_18H.BIT.B12)
                        {
                    ...
                    {
                        RX671_func100(change_endian_long(0x3a90ce00u), change_endian_long(0x08c3c01au), change_endian_long(0x4d324843u), change_endian_long(0xa06d5a20u));
                        ...
                        TSIP.REG_18H.WORD = 0x00000000u;
                        RX671_func100(change_endian_long(0xcb06a5e1u), change_endian_long(0xdf4b3929u), change_endian_long(0x7c8413e9u), change_endian_long(0x62393912u));
                        TSIP.REG_34H.WORD = 0x00000003u;
                        TSIP.REG_24H.WORD = 0x800048d0u;
                        /* WAIT_LOOP */
                        while (0u != TSIP.REG_24H.BIT.B21)
                        ...
                        RX671_func103();
                        RX671_func100(change_endian_long(0x2cdfd314u), change_endian_long(0x6858a603u), change_endian_long(0xf1c20f5eu), change_endian_long(0xa171cc4au));
                        ...
                        RX671_func100(change_endian_long(0x48a5e94bu), change_endian_long(0xf3b643c2u), change_endian_long(0x7d0ba941u), change_endian_long(0x76b5fa83u));
                        TSIP.REG_104H.WORD = 0x00000052u;
                        ...
                        RX671_func100(change_endian_long(0x19157273u), change_endian_long(0xa76b2a7cu), change_endian_long(0x62415c80u), change_endian_long(0xe0eb3a6fu));
                        TSIP.REG_E0H.WORD = 0x81040000u;
                        ...
                        RX671_func102(change_endian_long(0x15e06967u), change_endian_long(0x837fda67u), change_endian_long(0x257eb18au), change_endian_long(0xbab8d8e6u));
                        TSIP.REG_1B8H.WORD = 0x00000040u;
                        /* WAIT_LOOP */
                        while (0u != TSIP.REG_18H.BIT.B12)
                        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX671/RX671_pe8_r1.prc
 *********************************************************************************************************************/
#endif /* #if TSIP_TLS == 1 */
