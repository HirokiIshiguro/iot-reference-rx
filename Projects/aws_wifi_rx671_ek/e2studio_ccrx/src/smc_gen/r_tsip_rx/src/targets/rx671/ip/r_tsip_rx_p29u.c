...
*******************************************************************************************************************/ /**
* @details       RX671 AES-128 Encryption with GCM Mode Update
...
void R_TSIP_Aes128GcmEncryptUpdateSub(uint32_t *InData_Text, uint32_t *OutData_Text, uint32_t MAX_CNT)
{
    ...
    (void)KEY_ADR;
    (void)OFS_ADR;
    RX671_func100(change_endian_long(0xad3b8406u), change_endian_long(0x98def2a5u), change_endian_long(0xad3eb052u), change_endian_long(0x6f49e6cdu));
    ...
    RX671_func101(change_endian_long(0x62420c40u), change_endian_long(0x6dd384fbu), change_endian_long(0xc968a57bu), change_endian_long(0x3e1a5e0eu));
}
/**********************************************************************************************************************
 End of function ./input_dir/RX671/RX671_p29u_r1.prc
 *********************************************************************************************************************/
