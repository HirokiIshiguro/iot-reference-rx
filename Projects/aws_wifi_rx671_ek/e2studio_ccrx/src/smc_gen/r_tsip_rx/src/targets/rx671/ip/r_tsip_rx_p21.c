...
*******************************************************************************************************************/ /**
* @details       RX671 GHASH calculation
* @param[in]     InData_HV
* @param[in]     InData_IV
...
e_tsip_err_t R_TSIP_Ghash(uint32_t *InData_HV, uint32_t *InData_IV, uint32_t *InData_Text, uint32_t *OutData_DataT, uint32_t MAX_CNT)
{
    ...
    RX671_func100(change_endian_long(0x158d9368u), change_endian_long(0x5764f636u), change_endian_long(0xa4ed73ebu), change_endian_long(0x9dbdd4dbu));
    ...
    RX671_func102(change_endian_long(0x044c4c2du), change_endian_long(0xac3960f7u), change_endian_long(0x850f80c1u), change_endian_long(0x3bd3e428u));
...
/**********************************************************************************************************************
 End of function ./input_dir/RX671/RX671_p21.prc
 *********************************************************************************************************************/
