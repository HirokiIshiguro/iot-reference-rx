...
*******************************************************************************************************************/ /**
* @details       RX671 SHA-224/256 Message Digest Generation
...
e_tsip_err_t R_TSIP_Sha224256GenerateMessageDigestSub(uint32_t *InData_SHA_InitVal, uint32_t *InData_PaddedMsg, uint32_t MAX_CNT, uint32_t *OutData_MsgDigest)
{
    ...
    RX671_func100(change_endian_long(0x4c5b2f63u), change_endian_long(0x0c6fc14fu), change_endian_long(0x4e6f45a9u), change_endian_long(0xe662791du));
    ...
    RX671_func102(change_endian_long(0x44ca884au), change_endian_long(0xa7ed13e8u), change_endian_long(0x540e80d8u), change_endian_long(0xb7a6e681u));
...
/**********************************************************************************************************************
 End of function ./input_dir/RX671/RX671_p72.prc
 *********************************************************************************************************************/
