...
/***********************************************************************************************************************
* Function Name: R_TSIP_GenerateTls13P256EccKeyIndexSub
*******************************************************************************************************************/ /**
* @details       RX671 TLS1.3 P-256 Key Generation
* @param[in]     InData_Cmd
...
* @note          None
*/
e_tsip_err_t R_TSIP_GenerateTls13P256EccKeyIndexSub(uint32_t *InData_Cmd, uint32_t *InData_Handle, const uint32_t *InData_DomainParam, uint32_t *OutData_KeyIndex, uint32_t *OutData_PubKey)
{
    ...
    RX671_func100(change_endian_long(0xcedc7e44u), change_endian_long(0x427710fdu), change_endian_long(0xf34f497fu), change_endian_long(0x0d6f614bu));
    RX671_func103();
    ...
    RX671_func100(change_endian_long(0x41474093u), change_endian_long(0x804e90c7u), change_endian_long(0xacfbc22au), change_endian_long(0x8f6bd769u));
    RX671_func103();
    TSIP.REG_104H.WORD = 0x00000052u;
    TSIP.REG_C4H.WORD = 0x01000c84u;
    /* WAIT_LOOP */
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX671_func100(change_endian_long(0x780e9c7bu), change_endian_long(0xaad2287fu), change_endian_long(0xcdda78e9u), change_endian_long(0xe329e857u));
    RX671_func103();
    TSIP.REG_104H.WORD = 0x00000052u;
    TSIP.REG_C4H.WORD = 0x01000c84u;
    /* WAIT_LOOP */
    ...
    RX671_func100(change_endian_long(0xecd5e24eu), change_endian_long(0xcf5f57eau), change_endian_long(0xcd02b36cu), change_endian_long(0x7329b5f2u));
    ...
    RX671_func100(change_endian_long(0xb70c9db9u), change_endian_long(0x92c3535bu), change_endian_long(0x1f262c54u), change_endian_long(0x69cc3319u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX671_func102(change_endian_long(0x75f488ecu), change_endian_long(0x8f4d341bu), change_endian_long(0xb4f8de0du), change_endian_long(0xb40ea84du));
    ...
    {
        RX671_func100(change_endian_long(0xc881fa04u), change_endian_long(0x1fc2204au), change_endian_long(0x1d8e2ec6u), change_endian_long(0xb6eff017u));
        ...
        RX671_func100(change_endian_long(0xd2176f36u), change_endian_long(0xfa8733f5u), change_endian_long(0xd06feaafu), change_endian_long(0xabc73e14u));
        ...
        RX671_func100(change_endian_long(0x230899bcu), change_endian_long(0x24986ce4u), change_endian_long(0xf1395853u), change_endian_long(0xb3194de1u));
        TSIP.REG_1CH.WORD = 0x00400000u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            ...
            RX671_func101(change_endian_long(0xb2dbef0au), change_endian_long(0xd5edab9au), change_endian_long(0x3ca6a884u), change_endian_long(0x6c0fd6c8u));
        }
        RX671_func100(change_endian_long(0xd5042d21u), change_endian_long(0xb562f3b8u), change_endian_long(0xc2fa6178u), change_endian_long(0x140b36deu));
        RX671_func072();
        ...
        RX671_func100(change_endian_long(0xb952af7cu), change_endian_long(0xc859ca89u), change_endian_long(0xe45edef9u), change_endian_long(0xb8b65a89u));
        TSIP.REG_104H.WORD = 0x00000052u;
        ...
        RX671_func100(change_endian_long(0x756622a1u), change_endian_long(0x1794363cu), change_endian_long(0xb18f3148u), change_endian_long(0x2346f0dcu));
        ...
        RX671_func100(change_endian_long(0xd4b94219u), change_endian_long(0x8cdcbac2u), change_endian_long(0x5ff6eb7du), change_endian_long(0xd899a822u));
        ...
        RX671_func100(change_endian_long(0x16b8aaf9u), change_endian_long(0x769a1decu), change_endian_long(0xd068819eu), change_endian_long(0x3d267bf7u));
        ...
        RX671_func102(change_endian_long(0x9b6688ecu), change_endian_long(0xa78b81e8u), change_endian_long(0x79b23bddu), change_endian_long(0x0e352396u));
        TSIP.REG_1B8H.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX671/RX671_pea_r1.prc
 *********************************************************************************************************************/
