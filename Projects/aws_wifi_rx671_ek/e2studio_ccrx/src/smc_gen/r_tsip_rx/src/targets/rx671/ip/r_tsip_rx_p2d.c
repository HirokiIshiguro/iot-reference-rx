...
*******************************************************************************************************************/ /**
* @details       RX671 Update P-384 ECC Private Key
* @param[in]     InData_IV
...
e_tsip_err_t R_TSIP_UpdateEccP384PrivateKeyIndexSub(uint32_t *InData_IV, uint32_t *InData_InstData, uint32_t *OutData_KeyIndex)
{
    ...
    RX671_func100(change_endian_long(0xb9079c10u), change_endian_long(0x16b53159u), change_endian_long(0x9dc1a76fu), change_endian_long(0x497e5839u));
    ...
    RX671_func100(change_endian_long(0xfc1010feu), change_endian_long(0x3ca1061eu), change_endian_long(0x921abc30u), change_endian_long(0xce732853u));
    TSIP.REG_104H.WORD = 0x00000361u;
    ...
    RX671_func100(change_endian_long(0x9fd79812u), change_endian_long(0xc3f3b67fu), change_endian_long(0x77680d7du), change_endian_long(0x808fa433u));
    TSIP.REG_104H.WORD = 0x00000361u;
    ...
    RX671_func103();
    RX671_func100(change_endian_long(0x2468b228u), change_endian_long(0x301dc208u), change_endian_long(0xc8444476u), change_endian_long(0x44eaeb1du));
    ...
    RX671_func100(change_endian_long(0x222c370au), change_endian_long(0x95b1dec8u), change_endian_long(0xdb2541a7u), change_endian_long(0xd51bb126u));
    TSIP.REG_104H.WORD = 0x00000052u;
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX671_func100(change_endian_long(0xbd5cc3ecu), change_endian_long(0x747a14a2u), change_endian_long(0x6925f550u), change_endian_long(0x402f859du));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX671_func102(change_endian_long(0xe5a86cc4u), change_endian_long(0x088f385fu), change_endian_long(0x85fc2a21u), change_endian_long(0xb70c03f0u));
    ...
    {
        RX671_func100(change_endian_long(0xcd32da48u), change_endian_long(0x93cb8467u), change_endian_long(0xee4a63c1u), change_endian_long(0x956c6064u));
        TSIP.REG_E0H.WORD = 0x81040000u;
        ...
        RX671_func102(change_endian_long(0x842ddd6du), change_endian_long(0x13face3eu), change_endian_long(0xb152e1f2u), change_endian_long(0xa418575bu));
        TSIP.REG_1B4H.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX671/RX671_p2d.prc
 *********************************************************************************************************************/
