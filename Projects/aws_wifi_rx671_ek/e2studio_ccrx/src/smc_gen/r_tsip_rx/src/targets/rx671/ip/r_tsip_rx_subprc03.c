...
*******************************************************************************************************************/ /**
* @details       RX671 TSIP RSA2048 PSS Signature Verification subprocedure 03
* @note          None
*/
void R_TSIP_TlsRootCertificateVerificationSubSub(void)
{
    ...
    RX671_func100(change_endian_long(0x7330cfd4u), change_endian_long(0x11f85697u), change_endian_long(0x94a75b2au), change_endian_long(0x21793c7du));
    ...
    TSIP.REG_ECH.WORD = 0x00002862u;
    RX671_func100(change_endian_long(0x2146df64u), change_endian_long(0xd6c3eb5au), change_endian_long(0xd329a685u), change_endian_long(0xf780a7e8u));
    TSIP.REG_E0H.WORD = 0x81010020u;
    ...
    for (iLoop = 0; iLoop < S_RAM[0]; iLoop = iLoop + 1)
    {
        ...
        RX671_func101(change_endian_long(0x3efcc510u), change_endian_long(0xf3c9a979u), change_endian_long(0x982f233eu), change_endian_long(0x43fca618u));
    }
    ...
    TSIP.REG_ECH.WORD = 0x0000b460u;
    TSIP.REG_ECH.WORD = 0x80000000u;
    RX671_func100(change_endian_long(0x63982d00u), change_endian_long(0xcdde3e60u), change_endian_long(0x34b43db2u), change_endian_long(0x755d85fbu));
    TSIP.REG_E0H.WORD = 0x81010020u;
    TSIP.REG_04H.WORD = 0x00000707u;
    /* WAIT_LOOP */
    while (1u != TSIP.REG_04H.BIT.B30)
    ...
    for (iLoop = 0; iLoop < S_RAM[0]; iLoop = iLoop + 1)
    {
        ...
        RX671_func101(change_endian_long(0xc4312376u), change_endian_long(0x80d877e6u), change_endian_long(0x3fb5c985u), change_endian_long(0xfd32a9b7u));
    }
    TSIP.REG_ECH.WORD = 0x00007c01u;
    TSIP.REG_1CH.WORD = 0x00602000u;
    TSIP.REG_F8H.WORD = 0x00000040u;
...
/**********************************************************************************************************************
 End of function ./input_dir/RX671/RX671_subprc03.prc
 *********************************************************************************************************************/
