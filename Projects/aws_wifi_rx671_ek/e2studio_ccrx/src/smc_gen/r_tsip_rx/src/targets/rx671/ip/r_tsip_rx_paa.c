...
*******************************************************************************************************************/ /**
* @details       RX671 RSA-3072 Public Key Install
...
e_tsip_err_t R_TSIP_GenerateRsa3072PublicKeyIndexSub(uint32_t *InData_SharedKeyIndex, uint32_t *InData_SessionKey, uint32_t *InData_IV, uint32_t *InData_InstData, uint32_t *OutData_KeyIndex)
{
    ...
    RX671_func100(change_endian_long(0xa0b0805bu), change_endian_long(0x3658c77cu), change_endian_long(0xc15d411au), change_endian_long(0x3853d2a4u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX671_func102(change_endian_long(0xe39296d1u), change_endian_long(0x3768208au), change_endian_long(0xbea49548u), change_endian_long(0xe7bde917u));
    ...
    {
        RX671_func100(change_endian_long(0xdfc1b014u), change_endian_long(0x2f81da7bu), change_endian_long(0x3eb8bbf2u), change_endian_long(0x07311373u));
        ...
        RX671_func100(change_endian_long(0x1f0db41du), change_endian_long(0x85375dfcu), change_endian_long(0x356e581eu), change_endian_long(0xceaa40b9u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX671_func100(change_endian_long(0xc71e5fb7u), change_endian_long(0x606129bdu), change_endian_long(0x699c08dcu), change_endian_long(0x470a5927u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX671_func100(change_endian_long(0x4298fc1fu), change_endian_long(0x41046cceu), change_endian_long(0x463060f2u), change_endian_long(0x415eccb9u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX671_func103();
        RX671_func100(change_endian_long(0xc5e05693u), change_endian_long(0xd0f846e0u), change_endian_long(0x2c68d707u), change_endian_long(0x9b72e4beu));
        ...
        RX671_func100(change_endian_long(0xdaa62c2du), change_endian_long(0x33c01768u), change_endian_long(0x74769391u), change_endian_long(0xadbfb7ceu));
        ...
        RX671_func100(change_endian_long(0x5bc70cbbu), change_endian_long(0xc925d616u), change_endian_long(0x11bb82bau), change_endian_long(0x6c7a108du));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX671_func100(change_endian_long(0x016b45e1u), change_endian_long(0x13097508u), change_endian_long(0x42a1a71fu), change_endian_long(0x55f7ec28u));
        TSIP.REG_104H.WORD = 0x00000052u;
        ...
        TSIP.REG_1CH.WORD = 0x00001800u;
        RX671_func100(change_endian_long(0xd9c65336u), change_endian_long(0x5682aa5cu), change_endian_long(0xe4dfc797u), change_endian_long(0x7a508345u));
        TSIP.REG_1CH.WORD = 0x00400000u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            RX671_func102(change_endian_long(0x587832ccu), change_endian_long(0x503df19bu), change_endian_long(0x1cecf3e5u), change_endian_long(0xbf27471cu));
            TSIP.REG_1B4H.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
        ...
        {
            RX671_func100(change_endian_long(0xf1200ddau), change_endian_long(0x943be554u), change_endian_long(0x591072f5u), change_endian_long(0x81645a0eu));
            TSIP.REG_E0H.WORD = 0x81040000u;
            ...
            RX671_func102(change_endian_long(0x29909b43u), change_endian_long(0x29243a47u), change_endian_long(0x2ff0f745u), change_endian_long(0x1eba1f0du));
            TSIP.REG_1B4H.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX671/RX671_paa.prc
 *********************************************************************************************************************/
