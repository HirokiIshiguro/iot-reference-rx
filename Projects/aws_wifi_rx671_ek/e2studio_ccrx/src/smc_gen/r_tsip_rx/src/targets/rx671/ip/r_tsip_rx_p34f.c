...
*******************************************************************************************************************/ /**
* @details       RX671 AES-256 Encryption with GCM Mode Final
...
e_tsip_err_t R_TSIP_Aes256GcmEncryptFinalSub(uint32_t *InData_Text, uint32_t *InData_DataALen, uint32_t *InData_TextLen, uint32_t *OutData_Text, uint32_t *OutData_DataT)
{
    ...
    RX671_func100(change_endian_long(0x8746d236u), change_endian_long(0x4fc3a8b3u), change_endian_long(0x353b3fb0u), change_endian_long(0x7148e4e2u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX671_func102(change_endian_long(0xb3ed52fau), change_endian_long(0xe29514afu), change_endian_long(0xd32ec799u), change_endian_long(0xf2060c45u));
    ...
    else
    {
        ...
        RX671_func100(change_endian_long(0x49dc842eu), change_endian_long(0xbc22c8f0u), change_endian_long(0x2fe691f2u), change_endian_long(0xbeae44f6u));
        TSIP.REG_1CH.WORD = 0x00400000u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            ...
            RX671_func100(change_endian_long(0x39c22887u), change_endian_long(0x41bd60eeu), change_endian_long(0x4336c139u), change_endian_long(0x64706a9eu));
            ...
            RX671_func101(change_endian_long(0x0d5181d5u), change_endian_long(0x1b519829u), change_endian_long(0x14617279u), change_endian_long(0x1b89893du));
        }
        ...
        TSIP.REG_1CH.WORD = 0x00001800u;
        RX671_func100(change_endian_long(0xee576edcu), change_endian_long(0x9eec0b45u), change_endian_long(0x3a0e582fu), change_endian_long(0x3a7c45aau));
        TSIP.REG_B0H.WORD = 0x40000020u;
        TSIP.REG_A4H.WORD = 0x000087b5u;
        ...
        RX671_func102(change_endian_long(0xa5656e2eu), change_endian_long(0xfe65e2d1u), change_endian_long(0x87ef4fc9u), change_endian_long(0x9311c1d8u));
        TSIP.REG_1BCH.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX671/RX671_p34f_r1.prc
 *********************************************************************************************************************/
