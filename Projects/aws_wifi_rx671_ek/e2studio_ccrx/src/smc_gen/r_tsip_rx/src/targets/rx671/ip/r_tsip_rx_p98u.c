...
*******************************************************************************************************************/ /**
* @details       RX671 AES-128 Decryption and MAC verification with CCM Mode Update
...
void R_TSIP_Aes128CcmDecryptUpdateSub(uint32_t *InData_Text, uint32_t *OutData_Text, uint32_t MAX_CNT)
{
    ...
    (void)KEY_ADR;
    (void)OFS_ADR;
    RX671_func100(change_endian_long(0x4d126811u), change_endian_long(0xe09c05d3u), change_endian_long(0x4efe6d9eu), change_endian_long(0x239687d2u));
    ...
    RX671_func101(change_endian_long(0x53666be6u), change_endian_long(0x142622c1u), change_endian_long(0xb8a1ba0eu), change_endian_long(0x9f146deau));
}
/**********************************************************************************************************************
 End of function ./input_dir/RX671/RX671_p98u_r1.prc
 *********************************************************************************************************************/
