...
*******************************************************************************************************************/ /**
* @details       RX671 MD5 Message Digest Generation
...
e_tsip_err_t R_TSIP_Md5GenerateMessageDigestSub(uint32_t *InData_MD5InitVal, uint32_t *InData_PaddedMsg, uint32_t MAX_CNT, uint32_t *OutData_MsgDigest)
{
    ...
    RX671_func100(change_endian_long(0x9cd0f4bdu), change_endian_long(0x3c29b072u), change_endian_long(0xb9625034u), change_endian_long(0x5ec28a82u));
    ...
    RX671_func102(change_endian_long(0x446e7013u), change_endian_long(0x493a4e7au), change_endian_long(0x4d888a7cu), change_endian_long(0x2c5d5632u));
...
/**********************************************************************************************************************
 End of function ./input_dir/RX671/RX671_pd5.prc
 *********************************************************************************************************************/
#endif /* #if TSIP_MD5 == 1 */
