...
e_tsip_err_t R_TSIP_Rsa2048ModularExponentEncryptSub(uint32_t *InData_KeyIndex, uint32_t *InData_Text, uint32_t *OutData_Text)
{
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX671_func100(change_endian_long(0x1b01c859u), change_endian_long(0x9de65b9cu), change_endian_long(0xc059fd2fu), change_endian_long(0xe5f21e8eu));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX671_func102(change_endian_long(0x3c735e69u), change_endian_long(0x302cf94eu), change_endian_long(0x27528b5au), change_endian_long(0x83bb3935u));
    ...
    {
        RX671_func100(change_endian_long(0xa5901969u), change_endian_long(0xf795e81eu), change_endian_long(0x627e27c6u), change_endian_long(0x37432f1du));
        ...
        RX671_func100(change_endian_long(0x9f115439u), change_endian_long(0xf30a71dcu), change_endian_long(0x45f3a8fdu), change_endian_long(0xb3f6076eu));
        ...
        RX671_func102(change_endian_long(0x9f319439u), change_endian_long(0xad9df680u), change_endian_long(0x71fc6985u), change_endian_long(0x3bfd04e3u));
        TSIP.REG_1BCH.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX671/RX671_p56.prc
 *********************************************************************************************************************/
