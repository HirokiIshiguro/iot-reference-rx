...
e_tsip_err_t R_TSIP_UpdateArc4KeyIndexSub(uint32_t *InData_IV, uint32_t *InData_InstData, uint32_t *OutData_KeyIndex)
{
    ...
    RX671_func100(change_endian_long(0x1d29bdbeu), change_endian_long(0x27a5a04eu), change_endian_long(0xf66a237eu), change_endian_long(0xe7f23a10u));
    ...
    RX671_func100(change_endian_long(0x69566af6u), change_endian_long(0x9b84df58u), change_endian_long(0x93e8af4fu), change_endian_long(0xe54b3c43u));
    ...
    RX671_func100(change_endian_long(0x57832acbu), change_endian_long(0x76e66f54u), change_endian_long(0xad88f448u), change_endian_long(0xa0a71d7cu));
    TSIP.REG_104H.WORD = 0x00000361u;
    ...
    RX671_func103();
    RX671_func100(change_endian_long(0x5f8f27d1u), change_endian_long(0x1187d6c5u), change_endian_long(0xea8d5d4au), change_endian_long(0xcd752fceu));
    ...
    RX671_func100(change_endian_long(0xda466829u), change_endian_long(0x67992251u), change_endian_long(0x232f043cu), change_endian_long(0x063acc1fu));
    TSIP.REG_104H.WORD = 0x00000052u;
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX671_func100(change_endian_long(0xcaf0006fu), change_endian_long(0xc3ff662fu), change_endian_long(0x7b11775au), change_endian_long(0x1bef3019u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX671_func102(change_endian_long(0x2e210830u), change_endian_long(0x2e2dbaf1u), change_endian_long(0x83349142u), change_endian_long(0xd9c0ad60u));
    ...
    {
        RX671_func100(change_endian_long(0x3454dc27u), change_endian_long(0xadfd0213u), change_endian_long(0xee15655au), change_endian_long(0x7a783d51u));
        TSIP.REG_E0H.WORD = 0x81040000u;
        ...
        RX671_func102(change_endian_long(0xef5875e2u), change_endian_long(0xc2637473u), change_endian_long(0x85e7d50cu), change_endian_long(0x3ee620ccu));
        TSIP.REG_1B4H.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX671/RX671_p1d.prc
 *********************************************************************************************************************/
