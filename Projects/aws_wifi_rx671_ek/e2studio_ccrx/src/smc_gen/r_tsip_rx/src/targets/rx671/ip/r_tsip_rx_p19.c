...
*******************************************************************************************************************/ /**
* @details       RX671 Generate key for ARC4
...
e_tsip_err_t R_TSIP_GenerateArc4RandomKeyIndexSub(uint32_t *OutData_KeyIndex)
{
    ...
    RX671_func100(change_endian_long(0x4d40efc1u), change_endian_long(0xb0232aa0u), change_endian_long(0xc4756493u), change_endian_long(0x1148a6e5u));
    RX671_func103();
    ...
    RX671_func100(change_endian_long(0xa9206ac1u), change_endian_long(0xfb3a2ab2u), change_endian_long(0xbe1840a7u), change_endian_long(0x79c7074fu));
    ...
    {
        RX671_func100(change_endian_long(0x95585f63u), change_endian_long(0xf5f9c0a3u), change_endian_long(0x66e22b81u), change_endian_long(0xc030f31cu));
        RX671_func103();
        TSIP.REG_104H.WORD = 0x00000052u;
        TSIP.REG_C4H.WORD = 0x01000c84u;
        /* WAIT_LOOP */
        ...
        TSIP.REG_1CH.WORD = 0x00001800u;
        RX671_func101(change_endian_long(0x0a40702fu), change_endian_long(0xd56c6b5du), change_endian_long(0xc1db360du), change_endian_long(0x63f16920u));
    }
    RX671_func100(change_endian_long(0x8d65de6eu), change_endian_long(0x7e0f514au), change_endian_long(0xb160ff32u), change_endian_long(0xb186eafbu));
    ...
    RX671_func100(change_endian_long(0xfdc8ee7au), change_endian_long(0x1365dc6eu), change_endian_long(0x9b0a5fa0u), change_endian_long(0x1979e635u));
    ...
    RX671_func102(change_endian_long(0x93951043u), change_endian_long(0x7e2a2c4au), change_endian_long(0xb5d7932eu), change_endian_long(0x1b592a3au));
...
/**********************************************************************************************************************
 End of function ./input_dir/RX671/RX671_p19.prc
 *********************************************************************************************************************/
