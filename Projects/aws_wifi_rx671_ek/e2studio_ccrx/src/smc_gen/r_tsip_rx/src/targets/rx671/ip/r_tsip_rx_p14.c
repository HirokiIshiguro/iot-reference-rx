...
*******************************************************************************************************************/ /**
* @details       RX671 Install TDES Key
...
e_tsip_err_t R_TSIP_GenerateTdesKeyIndexSub(uint32_t *InData_SharedKeyIndex, uint32_t *InData_SessionKey, uint32_t *InData_IV, uint32_t *InData_InstData, uint32_t *OutData_KeyIndex)
{
    ...
    RX671_func100(change_endian_long(0x7d2e79ebu), change_endian_long(0x9a6d6963u), change_endian_long(0xd569aa10u), change_endian_long(0x0f0735f5u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX671_func102(change_endian_long(0x6ebb76e4u), change_endian_long(0x1a1be308u), change_endian_long(0x14819c49u), change_endian_long(0x270e65b8u));
    ...
    {
        RX671_func100(change_endian_long(0x4717ee98u), change_endian_long(0xf2a3809bu), change_endian_long(0x71dd6b52u), change_endian_long(0x1a6de815u));
        ...
        RX671_func100(change_endian_long(0xca288414u), change_endian_long(0xfe2bc174u), change_endian_long(0xbaffd6f5u), change_endian_long(0x4c8939f9u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX671_func100(change_endian_long(0xbaf79a6eu), change_endian_long(0x8f496134u), change_endian_long(0xe36d360cu), change_endian_long(0xfbe4aeb2u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX671_func100(change_endian_long(0xb4c86fd1u), change_endian_long(0xaae37d4au), change_endian_long(0xb155bfefu), change_endian_long(0xcd08980du));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX671_func103();
        RX671_func100(change_endian_long(0xb5796fb1u), change_endian_long(0x598a35adu), change_endian_long(0xc9646452u), change_endian_long(0x2b6bb7b7u));
        ...
        RX671_func100(change_endian_long(0x69e651bdu), change_endian_long(0x2840d619u), change_endian_long(0xc44b7fdfu), change_endian_long(0x3d3d1b9fu));
        TSIP.REG_104H.WORD = 0x00000052u;
        ...
        TSIP.REG_1CH.WORD = 0x00001800u;
        RX671_func100(change_endian_long(0xea2d2caeu), change_endian_long(0xa85957dfu), change_endian_long(0xfa975de1u), change_endian_long(0x6c9946dbu));
        TSIP.REG_1CH.WORD = 0x00400000u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            RX671_func102(change_endian_long(0x5860588bu), change_endian_long(0x0f9d4860u), change_endian_long(0x2fab41bcu), change_endian_long(0x6e54533au));
            TSIP.REG_1BCH.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
        ...
        {
            RX671_func100(change_endian_long(0x71c4c0e9u), change_endian_long(0x9ff5a096u), change_endian_long(0x1b762df2u), change_endian_long(0x5721e5fdu));
            TSIP.REG_E0H.WORD = 0x81040000u;
            ...
            RX671_func102(change_endian_long(0xa7fac05du), change_endian_long(0x9f930c29u), change_endian_long(0x2fe5c8adu), change_endian_long(0x371eaa2eu));
            TSIP.REG_1BCH.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX671/RX671_p14.prc
 *********************************************************************************************************************/
