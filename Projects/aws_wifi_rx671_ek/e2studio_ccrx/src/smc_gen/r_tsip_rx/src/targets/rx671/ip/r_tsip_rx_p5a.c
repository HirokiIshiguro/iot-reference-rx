...
e_tsip_err_t R_TSIP_DlmsCosemQeuSignatureVerificationSub(uint32_t *InData_Cmd, uint32_t *InData_KeyIndex, uint32_t *InData_data, uint32_t *InData_Signature, const uint32_t *InData_DomainParam, uint32_t *OutData_KeyIndex)
{
    ...
    else
    {
        ...
        RX671_func101(change_endian_long(0xe8a34bd3u), change_endian_long(0x6d685720u), change_endian_long(0xb752229bu), change_endian_long(0x641ffc57u));
        RX671_func010(InData_DomainParam);
        RX671_func100(change_endian_long(0x87e7ddb3u), change_endian_long(0x01c0a56au), change_endian_long(0x9ef239acu), change_endian_long(0x420659e4u));
        TSIP.REG_1CH.WORD = 0x00400000u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            RX671_func102(change_endian_long(0x54256b47u), change_endian_long(0x7f222a6bu), change_endian_long(0x374fc92du), change_endian_long(0x1b19411au));
            TSIP.REG_1BCH.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
        ...
        else
        {
            ...
            RX671_func100(change_endian_long(0x4cc28be6u), change_endian_long(0x0470b270u), change_endian_long(0x483fa156u), change_endian_long(0xc6fe3dbdu));
            TSIP.REG_1CH.WORD = 0x00400000u;
            TSIP.REG_1D0H.WORD = 0x00000000u;
            if (1u == (TSIP.REG_1CH.BIT.B22))
            {
                ...
                TSIP.REG_1CH.WORD = 0x00001800u;
                RX671_func101(change_endian_long(0x70607799u), change_endian_long(0xb91b96bdu), change_endian_long(0xe1ddad2bu), change_endian_long(0x100fc395u));
            }
            else
            {
                ...
                TSIP.REG_1CH.WORD = 0x00001800u;
                RX671_func101(change_endian_long(0x250630f6u), change_endian_long(0xd400d9bbu), change_endian_long(0x4e649a67u), change_endian_long(0xcf12891du));
            }
            RX671_func100(change_endian_long(0x6551449cu), change_endian_long(0x10145e40u), change_endian_long(0x30848ee0u), change_endian_long(0xa77aab27u));
            RX671_func103();
            RX671_func100(change_endian_long(0xa571ddefu), change_endian_long(0x4900bb2fu), change_endian_long(0xe5225dfdu), change_endian_long(0xc2fddd0cu));
            ...
            RX671_func100(change_endian_long(0x9779ae58u), change_endian_long(0x35b411d7u), change_endian_long(0x4e248780u), change_endian_long(0xc60125f1u));
            TSIP.REG_104H.WORD = 0x00000052u;
            ...
            OutData_KeyIndex[iLoop + 2] = TSIP.REG_100H.WORD;
            OutData_KeyIndex[iLoop + 3] = TSIP.REG_100H.WORD;
            RX671_func100(change_endian_long(0x864f9d79u), change_endian_long(0xe0dc6f79u), change_endian_long(0x24c79217u), change_endian_long(0x21256b72u));
            TSIP.REG_E0H.WORD = 0x81040000u;
            ...
            RX671_func102(change_endian_long(0x50a1badfu), change_endian_long(0xe22f0679u), change_endian_long(0x97965b56u), change_endian_long(0x16a720c1u));
            TSIP.REG_1BCH.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX671/RX671_p5a_r1.prc
 *********************************************************************************************************************/
