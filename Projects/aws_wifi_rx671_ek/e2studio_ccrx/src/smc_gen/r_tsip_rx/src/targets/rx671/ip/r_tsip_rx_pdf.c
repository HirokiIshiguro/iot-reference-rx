...
*******************************************************************************************************************/ /**
* @details       RX671 TLS RSA Key Install
...
e_tsip_err_t R_TSIP_GenerateTlsRsaInstallDataSub(uint32_t *InData_SharedKeyIndex, uint32_t *InData_SessionKey, uint32_t *InData_IV, uint32_t *InData_InstData, uint32_t *OutData_InstData)
{
    ...
    RX671_func100(change_endian_long(0xbb6ef407u), change_endian_long(0xa04ed6c7u), change_endian_long(0x629a1ab0u), change_endian_long(0x8e820cebu));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX671_func102(change_endian_long(0xf2d28ec6u), change_endian_long(0x6d312820u), change_endian_long(0x5853b6c6u), change_endian_long(0xe896e497u));
    ...
    {
        RX671_func100(change_endian_long(0x93d23185u), change_endian_long(0x554cc0beu), change_endian_long(0x93ad0da7u), change_endian_long(0x0cf9a985u));
        ...
        RX671_func100(change_endian_long(0x6ad087b3u), change_endian_long(0xfc60ccffu), change_endian_long(0x9454a734u), change_endian_long(0xf5e19908u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX671_func100(change_endian_long(0x0f79a103u), change_endian_long(0xe168f832u), change_endian_long(0x6ef931bfu), change_endian_long(0xa6abd3a4u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX671_func100(change_endian_long(0xf630b1fcu), change_endian_long(0xb229ad89u), change_endian_long(0x5f55272du), change_endian_long(0xeb7e13cau));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX671_func103();
        RX671_func100(change_endian_long(0xa9679423u), change_endian_long(0x20d1bca8u), change_endian_long(0x14d05cceu), change_endian_long(0xb217a10fu));
        ...
        RX671_func100(change_endian_long(0x07d95864u), change_endian_long(0x5b827234u), change_endian_long(0x04be1bdfu), change_endian_long(0x5c9b1bafu));
        TSIP.REG_00H.WORD = 0x00012303u;
        ...
        RX671_func100(change_endian_long(0xa16524a2u), change_endian_long(0x01249a44u), change_endian_long(0x8ec249f3u), change_endian_long(0xb9e6dd00u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        OutData_InstData[4+jLoop + 2] = TSIP.REG_100H.WORD;
        OutData_InstData[4+jLoop + 3] = TSIP.REG_100H.WORD;
        RX671_func100(change_endian_long(0x663184afu), change_endian_long(0x9bedad5eu), change_endian_long(0x4ea89739u), change_endian_long(0xd3cb65fau));
        ...
        TSIP.REG_1CH.WORD = 0x00001800u;
        RX671_func100(change_endian_long(0x7b27f159u), change_endian_long(0x36b88a98u), change_endian_long(0x781c3e3au), change_endian_long(0x52173849u));
        TSIP.REG_1CH.WORD = 0x00400000u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            RX671_func102(change_endian_long(0xbba0b068u), change_endian_long(0xd4ba8529u), change_endian_long(0x29ee6198u), change_endian_long(0xe608a95bu));
            TSIP.REG_1BCH.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
        ...
        {
            RX671_func100(change_endian_long(0x05ef2e3au), change_endian_long(0xc3f47307u), change_endian_long(0xfb538c3eu), change_endian_long(0x12fb7c65u));
            TSIP.REG_104H.WORD = 0x00000052u;
            ...
            RX671_func102(change_endian_long(0x8fee497fu), change_endian_long(0x2ad38eb2u), change_endian_long(0xcdbac1b8u), change_endian_long(0x5512a541u));
            TSIP.REG_1BCH.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX671/RX671_pdf.prc
 *********************************************************************************************************************/
