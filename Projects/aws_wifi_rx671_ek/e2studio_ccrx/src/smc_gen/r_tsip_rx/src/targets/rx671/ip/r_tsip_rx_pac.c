...
*******************************************************************************************************************/ /**
* @details       RX671 RSA-3072 Public Key Update
* @param[in]     InData_IV
...
e_tsip_err_t R_TSIP_UpdateRsa3072PublicKeyIndexSub(uint32_t *InData_IV, uint32_t *InData_InstData, uint32_t *OutData_KeyIndex)
{
    ...
    RX671_func100(change_endian_long(0xb60cb14du), change_endian_long(0x289e771cu), change_endian_long(0x4a0231a4u), change_endian_long(0xda5d2411u));
    ...
    RX671_func100(change_endian_long(0x1f55e38cu), change_endian_long(0x059d830cu), change_endian_long(0x513d3ae8u), change_endian_long(0xd3b199fcu));
    TSIP.REG_104H.WORD = 0x00000361u;
    ...
    RX671_func100(change_endian_long(0xea108f7cu), change_endian_long(0xd475cff7u), change_endian_long(0x1623215cu), change_endian_long(0x521bfc83u));
    TSIP.REG_104H.WORD = 0x00000361u;
    ...
    RX671_func103();
    RX671_func100(change_endian_long(0x8ee65822u), change_endian_long(0xf65b36a7u), change_endian_long(0x2bca4b5du), change_endian_long(0xd2916065u));
    ...
    RX671_func100(change_endian_long(0xea1e1ce0u), change_endian_long(0xc3d0eba4u), change_endian_long(0xce79c386u), change_endian_long(0x707be70bu));
    ...
    RX671_func100(change_endian_long(0xe9c8f5f3u), change_endian_long(0x4085e55bu), change_endian_long(0x332390d9u), change_endian_long(0x02792dc9u));
    TSIP.REG_104H.WORD = 0x00000361u;
    ...
    RX671_func100(change_endian_long(0x915d32fbu), change_endian_long(0xde27d531u), change_endian_long(0xa6905001u), change_endian_long(0x622e45b5u));
    TSIP.REG_104H.WORD = 0x00000052u;
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX671_func100(change_endian_long(0xd24c92feu), change_endian_long(0x78fe21afu), change_endian_long(0xa2d24b72u), change_endian_long(0x7b50b016u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX671_func102(change_endian_long(0x371ae4a2u), change_endian_long(0x72d96176u), change_endian_long(0xe90c5822u), change_endian_long(0x5122b203u));
    ...
    {
        RX671_func100(change_endian_long(0x464412d4u), change_endian_long(0x3e8a4d8cu), change_endian_long(0x408ccb92u), change_endian_long(0xd280d6e5u));
        TSIP.REG_E0H.WORD = 0x81040000u;
        ...
        RX671_func102(change_endian_long(0xad375474u), change_endian_long(0x50cd4dd3u), change_endian_long(0xc9f5f178u), change_endian_long(0x8663a017u));
        TSIP.REG_1B4H.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX671/RX671_pac.prc
 *********************************************************************************************************************/
