...
*******************************************************************************************************************/ /**
* @details       RX671 RSA-4096 Public Key Update
* @param[in]     InData_IV
...
e_tsip_err_t R_TSIP_UpdateRsa4096PublicKeyIndexSub(uint32_t *InData_IV, uint32_t *InData_InstData, uint32_t *OutData_KeyIndex)
{
    ...
    RX671_func100(change_endian_long(0xa7a9aec2u), change_endian_long(0x4e76cd03u), change_endian_long(0xe465c863u), change_endian_long(0x5d35a714u));
    ...
    RX671_func100(change_endian_long(0xf3188ac7u), change_endian_long(0x96485779u), change_endian_long(0x2836baf3u), change_endian_long(0x219469a2u));
    TSIP.REG_104H.WORD = 0x00000361u;
    ...
    RX671_func100(change_endian_long(0xb5fe9d60u), change_endian_long(0x7cfacd59u), change_endian_long(0xa135b148u), change_endian_long(0xc119eb8au));
    TSIP.REG_104H.WORD = 0x00000361u;
    ...
    RX671_func103();
    RX671_func100(change_endian_long(0x78cfc17bu), change_endian_long(0xd547e1d3u), change_endian_long(0xa22b165eu), change_endian_long(0xddcb66d5u));
    ...
    RX671_func100(change_endian_long(0x7a9c0477u), change_endian_long(0x008d9556u), change_endian_long(0x1503128bu), change_endian_long(0x9dfbc22fu));
    TSIP.REG_00H.WORD = 0x00012103u;
    TSIP.REG_104H.WORD = 0x00000031u;
    TSIP.REG_B0H.WORD = 0x00000f00u;
    TSIP.REG_A4H.WORD = 0x00d0c9a7u;
    ...
    RX671_func100(change_endian_long(0x0c6c271au), change_endian_long(0x9ecec3d1u), change_endian_long(0x98e128ebu), change_endian_long(0x5f6c899bu));
    TSIP.REG_104H.WORD = 0x00000361u;
    ...
    RX671_func100(change_endian_long(0x6a19d269u), change_endian_long(0xa978b388u), change_endian_long(0x260c52bbu), change_endian_long(0xce8d1a16u));
    TSIP.REG_104H.WORD = 0x00000052u;
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX671_func100(change_endian_long(0x3f7bef7au), change_endian_long(0x66c3b95au), change_endian_long(0x52af3eb1u), change_endian_long(0xf9bfc4a6u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX671_func102(change_endian_long(0x10c4243cu), change_endian_long(0xbf077d1du), change_endian_long(0x955389acu), change_endian_long(0xd4faf7deu));
    ...
    {
        RX671_func100(change_endian_long(0x0b6ade6du), change_endian_long(0x3292b571u), change_endian_long(0x7093d087u), change_endian_long(0x4ba6e5f3u));
        TSIP.REG_E0H.WORD = 0x81040000u;
        ...
        RX671_func102(change_endian_long(0xb0956bc3u), change_endian_long(0x5dd65dffu), change_endian_long(0x87b81cb1u), change_endian_long(0xcddafa82u));
        TSIP.REG_1B4H.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX671/RX671_pad.prc
 *********************************************************************************************************************/
