...
*******************************************************************************************************************/ /**
* @details       RX671 AES-256 Encryption with GCM Mode Update
...
void R_TSIP_Aes256GcmEncryptUpdateSub(uint32_t *InData_Text, uint32_t *OutData_Text, uint32_t MAX_CNT)
{
    ...
    (void)KEY_ADR;
    (void)OFS_ADR;
    RX671_func100(change_endian_long(0x2b161120u), change_endian_long(0x7ff2983du), change_endian_long(0xa6b17b59u), change_endian_long(0x3bc8567au));
    ...
    RX671_func101(change_endian_long(0xd467e4f6u), change_endian_long(0xc4a466b3u), change_endian_long(0xf664f330u), change_endian_long(0xb4e2bdd9u));
}
/**********************************************************************************************************************
 End of function ./input_dir/RX671/RX671_p34u_r1.prc
 *********************************************************************************************************************/
