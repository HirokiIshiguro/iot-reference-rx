...
*******************************************************************************************************************/ /**
* @details       RX671 Install P-384 ECC Private Key
...
e_tsip_err_t R_TSIP_GenerateEccP384PrivateKeyIndexSub(uint32_t *InData_SharedKeyIndex, uint32_t *InData_SessionKey, uint32_t *InData_IV, uint32_t *InData_InstData, uint32_t *OutData_KeyIndex)
{
    ...
    RX671_func100(change_endian_long(0x15c704a7u), change_endian_long(0x3117cf4bu), change_endian_long(0xd4b576cfu), change_endian_long(0x56ed9833u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX671_func102(change_endian_long(0xca51a427u), change_endian_long(0x15e54222u), change_endian_long(0x319b7882u), change_endian_long(0x05707615u));
    ...
    {
        RX671_func100(change_endian_long(0x7a022a37u), change_endian_long(0x503c287du), change_endian_long(0xb4b88177u), change_endian_long(0xfae87cd3u));
        ...
        RX671_func100(change_endian_long(0xfb4b91d7u), change_endian_long(0xd9d9867du), change_endian_long(0x8fad1613u), change_endian_long(0xb793ee9cu));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX671_func100(change_endian_long(0xa5595ddcu), change_endian_long(0x06eec3a7u), change_endian_long(0x1179fcb2u), change_endian_long(0xb96ffda3u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX671_func100(change_endian_long(0x32e7b07fu), change_endian_long(0x0bddb8d1u), change_endian_long(0x8c77a8acu), change_endian_long(0x4dd5876au));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX671_func103();
        RX671_func100(change_endian_long(0x00072e60u), change_endian_long(0x1a15ffe8u), change_endian_long(0x608915ccu), change_endian_long(0x5908f2eau));
        ...
        RX671_func100(change_endian_long(0x504ec3d3u), change_endian_long(0x3808fc9eu), change_endian_long(0x714a9143u), change_endian_long(0xd56872abu));
        TSIP.REG_104H.WORD = 0x00000052u;
        ...
        TSIP.REG_1CH.WORD = 0x00001800u;
        RX671_func100(change_endian_long(0x26760019u), change_endian_long(0x55b8c738u), change_endian_long(0x6eb5e53au), change_endian_long(0xe7fa2957u));
        TSIP.REG_1CH.WORD = 0x00400000u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            RX671_func102(change_endian_long(0xac64e0afu), change_endian_long(0xac96f287u), change_endian_long(0xb55a06b0u), change_endian_long(0xc84ac69fu));
            TSIP.REG_1B4H.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
        ...
        {
            RX671_func100(change_endian_long(0x1682cc8fu), change_endian_long(0xc3df9024u), change_endian_long(0xcef62f78u), change_endian_long(0xb1b0d838u));
            TSIP.REG_E0H.WORD = 0x81040000u;
            ...
            RX671_func102(change_endian_long(0xa08f5cedu), change_endian_long(0xca2648adu), change_endian_long(0x9cf83a33u), change_endian_long(0x08a82e5bu));
            TSIP.REG_1B4H.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX671/RX671_pf8.prc
 *********************************************************************************************************************/
