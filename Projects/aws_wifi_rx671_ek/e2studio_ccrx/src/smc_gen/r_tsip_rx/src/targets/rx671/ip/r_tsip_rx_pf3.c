...
*******************************************************************************************************************/ /**
* @details       RX671 Install P-192/224/256 ECC Private Key
...
e_tsip_err_t R_TSIP_GenerateEccPrivateKeyIndexSub(uint32_t *InData_SharedKeyIndex, uint32_t *InData_SessionKey, uint32_t *InData_Cmd, uint32_t *InData_IV, uint32_t *InData_InstData, uint32_t *OutData_KeyIndex)
{
    ...
    RX671_func100(change_endian_long(0x641cb7e4u), change_endian_long(0x539fd748u), change_endian_long(0x762f68c3u), change_endian_long(0x670a628du));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX671_func102(change_endian_long(0xf94eff69u), change_endian_long(0x9198a982u), change_endian_long(0xcf568f9du), change_endian_long(0x4219d075u));
    ...
    {
        RX671_func100(change_endian_long(0x0b64cf47u), change_endian_long(0x8680cfeau), change_endian_long(0x26a7d285u), change_endian_long(0x95d092aeu));
        ...
        RX671_func100(change_endian_long(0x013d8b55u), change_endian_long(0x52b41410u), change_endian_long(0x2a45ab4au), change_endian_long(0x315937b5u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX671_func100(change_endian_long(0x11770fd9u), change_endian_long(0x6eac330cu), change_endian_long(0xef44247fu), change_endian_long(0xf1acb90cu));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX671_func100(change_endian_long(0x1d5ecf5bu), change_endian_long(0xd86f50d1u), change_endian_long(0xa30d54b7u), change_endian_long(0xda9b6f74u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX671_func103();
        RX671_func100(change_endian_long(0x42d8c4b2u), change_endian_long(0x5c32e204u), change_endian_long(0xbd064fb8u), change_endian_long(0x4cd1f828u));
        ...
        RX671_func100(change_endian_long(0x21d7228fu), change_endian_long(0x00970d4du), change_endian_long(0x71485605u), change_endian_long(0xc2c3c2fdu));
        TSIP.REG_104H.WORD = 0x00000052u;
        ...
        TSIP.REG_1CH.WORD = 0x00001800u;
        RX671_func100(change_endian_long(0xb2f96e8fu), change_endian_long(0xde10983fu), change_endian_long(0x5cc3330au), change_endian_long(0x9fff521du));
        TSIP.REG_1CH.WORD = 0x00400000u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            RX671_func102(change_endian_long(0x13c4a76du), change_endian_long(0x1de1b76cu), change_endian_long(0x059c8053u), change_endian_long(0x75544ad3u));
            TSIP.REG_1B4H.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
        ...
        {
            RX671_func100(change_endian_long(0xefc85df2u), change_endian_long(0x21920395u), change_endian_long(0x981e6265u), change_endian_long(0x619a84bfu));
            TSIP.REG_E0H.WORD = 0x81040000u;
            ...
            RX671_func102(change_endian_long(0x5be73387u), change_endian_long(0x65fc15acu), change_endian_long(0x2ec7acf7u), change_endian_long(0x785f2821u));
            TSIP.REG_1B4H.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX671/RX671_pf3_r1.prc
 *********************************************************************************************************************/
