...
*******************************************************************************************************************/ /**
* @details       RX671 Update 1024bit RSA Private Key
* @param[in]     InData_IV
...
e_tsip_err_t R_TSIP_UpdateRsa1024PrivateKeyIndexSub(uint32_t *InData_IV, uint32_t *InData_InstData, uint32_t *OutData_KeyIndex)
{
    ...
    RX671_func100(change_endian_long(0xfa05eb7du), change_endian_long(0x412c291du), change_endian_long(0x3ca6e593u), change_endian_long(0x98d816b9u));
    ...
    RX671_func100(change_endian_long(0xc1c43dc0u), change_endian_long(0x45e1eabfu), change_endian_long(0x20b836bfu), change_endian_long(0xcbefdca5u));
    ...
    RX671_func100(change_endian_long(0x12bc344cu), change_endian_long(0xc08f91fcu), change_endian_long(0x70ea4186u), change_endian_long(0x05d8a8c8u));
    TSIP.REG_104H.WORD = 0x00000361u;
    ...
    RX671_func103();
    RX671_func100(change_endian_long(0x52527287u), change_endian_long(0x27c9e9feu), change_endian_long(0x33da8854u), change_endian_long(0x951105d1u));
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX671_func100(change_endian_long(0x4abaee6du), change_endian_long(0x8f704874u), change_endian_long(0x176c43c8u), change_endian_long(0x69f586c1u));
    TSIP.REG_00H.WORD = 0x00003183u;
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX671_func100(change_endian_long(0x4418ad03u), change_endian_long(0x0360097eu), change_endian_long(0x29af5ddbu), change_endian_long(0x6dde3eb6u));
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX671_func100(change_endian_long(0x8e2072fau), change_endian_long(0xdc413bb4u), change_endian_long(0x5dc68b85u), change_endian_long(0x533c2c28u));
    TSIP.REG_104H.WORD = 0x00000052u;
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX671_func100(change_endian_long(0x482c2a4du), change_endian_long(0x224b50a5u), change_endian_long(0x1a3b4b6fu), change_endian_long(0xa45a39d6u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX671_func102(change_endian_long(0xe6b50394u), change_endian_long(0xf38f9aa8u), change_endian_long(0xade8f173u), change_endian_long(0x72609463u));
    ...
    else
    {
        ...
        RX671_func102(change_endian_long(0x6515cfbcu), change_endian_long(0xbe90a03bu), change_endian_long(0xcf6a8007u), change_endian_long(0x4b86ba03u));
        TSIP.REG_1BCH.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX671/RX671_p0c.prc
 *********************************************************************************************************************/
