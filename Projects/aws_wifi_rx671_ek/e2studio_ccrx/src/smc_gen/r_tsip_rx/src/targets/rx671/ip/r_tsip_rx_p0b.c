...
*******************************************************************************************************************/ /**
* @details       RX671 Update 1024bit RSA Public Key
* @param[in]     InData_IV
...
e_tsip_err_t R_TSIP_UpdateRsa1024PublicKeyIndexSub(uint32_t *InData_IV, uint32_t *InData_InstData, uint32_t *OutData_KeyIndex)
{
    ...
    RX671_func100(change_endian_long(0x482dc2e1u), change_endian_long(0xa510a58fu), change_endian_long(0xcb5a2a01u), change_endian_long(0xdacd6c2eu));
    ...
    RX671_func100(change_endian_long(0x185f054eu), change_endian_long(0x42827060u), change_endian_long(0x8eb032dbu), change_endian_long(0x23304a00u));
    ...
    RX671_func100(change_endian_long(0x43374cb3u), change_endian_long(0x2f098306u), change_endian_long(0x276687e4u), change_endian_long(0x1ea3ed6fu));
    TSIP.REG_104H.WORD = 0x00000361u;
    ...
    RX671_func103();
    RX671_func100(change_endian_long(0x53b6d490u), change_endian_long(0xe5f5457du), change_endian_long(0x2d74f7d8u), change_endian_long(0x883554cau));
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX671_func100(change_endian_long(0x907a1cd3u), change_endian_long(0x7853e843u), change_endian_long(0x1493ece8u), change_endian_long(0x090c8209u));
    TSIP.REG_104H.WORD = 0x00000361u;
    ...
    RX671_func100(change_endian_long(0x91552e75u), change_endian_long(0x8d2b8250u), change_endian_long(0x939ddfd5u), change_endian_long(0x04780aa4u));
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX671_func100(change_endian_long(0x8d8e7467u), change_endian_long(0xc5ca9b01u), change_endian_long(0xfc3a71f8u), change_endian_long(0x400357e4u));
    TSIP.REG_104H.WORD = 0x00000052u;
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX671_func100(change_endian_long(0xf3a17b37u), change_endian_long(0x212e1c74u), change_endian_long(0x074b545fu), change_endian_long(0xfc1f650eu));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX671_func102(change_endian_long(0x2f992a6fu), change_endian_long(0x65eb6e92u), change_endian_long(0x624c32f4u), change_endian_long(0x8bc13224u));
    ...
    {
        RX671_func100(change_endian_long(0xc0347dcau), change_endian_long(0x47a526ffu), change_endian_long(0x72b6f6bfu), change_endian_long(0x46522d91u));
        TSIP.REG_E0H.WORD = 0x81040000u;
        ...
        RX671_func102(change_endian_long(0xfadcec17u), change_endian_long(0x58e18f18u), change_endian_long(0x148ec0fbu), change_endian_long(0x540a12a5u));
        TSIP.REG_1BCH.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX671/RX671_p0b.prc
 *********************************************************************************************************************/
