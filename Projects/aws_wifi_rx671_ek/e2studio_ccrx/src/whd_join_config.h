...
#ifndef WHD_SDIO_SDHI_IRQ_DEFER_FIRST_ENABLE
#define WHD_SDIO_SDHI_IRQ_DEFER_FIRST_ENABLE (1)
#endif

#ifndef WHD_SDIO_SDHI_IRQ_REARM_DELAY_TICKS
#define WHD_SDIO_SDHI_IRQ_REARM_DELAY_TICKS  (0U)
#endif
